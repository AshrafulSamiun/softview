            ...
            <div class="row">
                ...
                <div class="col-md-8 col-12 fxt-bg-color" style="background-color: #fff;">
                    <div class="fxt-content">
                        <div class="fxt-form">
                            <form class="form-horizontal" method="POST" action="<?php echo e(route('register')); ?>" style="margin-top:30px;">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="company_name" name="company_name" class="form-control" placeholder="Type Company Name" required="required" value="<?php echo e(old('company_name')); ?>" autocomplete="off">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="email" name="email" class="form-control" placeholder="Type Email Address" required="required" value="<?php echo e(old('email')); ?>" autocomplete="off">
...
<?php /**PATH G:\WampServer\www\Development\SoftView\resources\views/auth/register.blade.php ENDPATH**/ ?>