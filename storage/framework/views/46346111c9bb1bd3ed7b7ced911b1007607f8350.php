            ...
            <div class="col-md-6 col-12 fxt-bg-color">
                <div class="fxt-content">
                        ...
                        <form  method="POST" action="<?php echo e(route('login')); ?>" >
                            ...
                            <div class="form-group<?php echo e($errors->has('pin_code') ? ' has-error' : ''); ?>">
                                ...
                                <input id="pin_code" type="pin_code" class="form-control" name="pin_code"
                                 autocomplete="off" value="<?php echo e(old('pin_code')); ?>" required autofocus>
                    ...
                    <div class="fxt-footer">
                        ...
                        <p><a href="<?php echo e(route('username.request')); ?>" class="switcher-text2 inline-text">Forget User Name </a></p>
                        <p><a href="<?php echo e(route('password.request')); ?>" class="switcher-text2 inline-text"> Forget Password</a></p>
                        <p><a href="<?php echo e(route('pincode.request')); ?>" class="switcher-text2 inline-text">Forget Pin Code</a></p>
                    </div>   
                </div>
            </div>
        </div>
