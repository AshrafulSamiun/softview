...
<head>
    ...
    <link href="<?php echo asset('images/logo.png'); ?>" rel="icon">
              ...
              <ul class="header-menu nav">
                  <li class="nav-item">
                      <a href="javascript:void(0);" class="nav-link">
                          ...
                          Weather-<?php echo e($weather['weather'][0]['main']); ?>
                  ...
                  <li class="dropdown nav-item">
                      <a href="javascript:void(0);" class="nav-link">
                          ...
                          <strong>Date / Day- <?php echo e(date("l, F, Y")); ?></strong>
                      </a>
                  </li>
                  <li class="btn-group nav-item">
                      <a href="javascript:void(0);" class="nav-link">
                          <i class="nav-link-icon fa fa-edit"></i>
                          <strong>Location-<?php echo e($weather['name']); ?></strong>
                      </a>
                  </li>
                  <li class="dropdown nav-item">
                      <a href="javascript:void(0);" class="nav-link">
                          <i class="nav-link-icon fa fa-cog"></i>
                          <strong>Local Time-<?php echo e(date("H:i:s")); ?></strong>
                      </a>
                  </li>
                  <li class="dropdown nav-item">
                      <a href="javascript:void(0);" class="nav-link">
                      ...
                      <div class="widget-content-wrapper">
                          ...
                          <div class="widget-content-left  ml-3 header-user-info">
                              ...
                              <div class="widget-subheading">
                                  <?php echo e($user_type_arr[$user->user_type]); ?>

                              </div>
                          </div>
                          <div class="widget-content-right header-user-info ml-3">
                              <img class="media-object img-circle" src="<?php echo e(asset('image/user_photo/'.$user_image)); ?>" width="38" height="38">
                          </div>
                      </div>
                  </div>
              </div>        
                  ...
                  <ul class="vertical-nav-menu" >
                      <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mid => $m_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($m_value->rootMenu==0 && $m_value->position==1): ?>
                              <li class="app-sidebar__heading" id="first_level_<?php echo e($mid); ?>" onClick="show_second_level(<?php echo e($mid); ?>)">
                                  <?php if(!empty($lavel_one_arr[$m_value->id])): ?>
                                    <a class="text-capitalize" href="#"><?php echo e($m_value->menuName); ?> 
                                     
                                         <i class="metismenu-state-icon fa fa-angle-down"></i>
                                     
                                    </a>
                                  <?php else: ?>
                                    <router-link :to="{ path: '/<?php echo e($m_value->menuRoute); ?>', params: { id: 20 }}"
                                      ...
                                      <ul class="second_level" >
                                        <?php $__currentLoopData = $lavel_one_arr[$m_value->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l1_id=>$la_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <li class="li_router_links">
                                                <?php if(!empty($lavel_two_arr[$l1_id])): ?>
                                                    ...
                                                    <ul>
                                                        <?php $__currentLoopData = $lavel_two_arr[$l1_id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l2_id=>$lb_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                            ...
                                                            <li>
                                                                <router-link :to="{ path: '/<?php echo e($lb_value['menuRoute']); ?>', params: { id: 20 }}"
                                                                    class="router-link text-capitalize" >
                                                ...
                                                <?php else: ?>
                                                    <router-link :to="{ path: '/<?php echo e($la_value['menuRoute']); ?>', params: { id: 20 }}"
                                                    class="router-link text-capitalize" >
              ...
              <div class="row">
                  <div class="col-md-12 " >
                      <?php $__currentLoopData = $menu; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $mid => $m_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <?php if($m_value->rootMenu==0 && $m_value->position==1): ?>
                              <?php if(!empty($lavel_one_arr[$m_value->id])): ?>
                                  <div class="main-card mb-3 card second_level_div" id="selcond_level_<?php echo e($mid); ?>" style="display: none"><!-- style="display: none" -->
                                      <div class="card-header">Second Lavel--<?php echo e($m_value->menuName); ?></div>
                                      <div class="table-responsive">
                                          <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                              ...
                                              <tbody>
                                                  ...
                                                  <?php $__currentLoopData = $lavel_one_arr[$m_value->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l1_id=>$la_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                       <?php if(!empty($lavel_two_arr[$l1_id]) ): ?>
                                                          <td class="text-center text-muted" onClick="show_third_level(<?php echo e($l1_id); ?>)" style="cursor:pointer" >
                                                               <?php echo e($la_value['menuName']); ?></td>
                                                      <?php else: ?>

                                                          <td class="text-center text-muted"  style="cursor:pointer" >
                                                               
                                                              <router-link :to="{ path: '/<?php echo e($la_value['menuRoute']); ?>', params: { id: 20 }}" class="router-link" >
                                  ...
                                  <?php $__currentLoopData = $lavel_one_arr[$m_value->id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l1_id=>$la_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                      <?php if(!empty($lavel_two_arr[$l1_id]) ): ?>
                                          ...
                                          <div class="main-card mb-3 card third_level" id="third_level_<?php echo e($l1_id); ?>" style="display: none"><!-- style="display: none" -->
                                              <div class="card-header">Third Lavel--<?php echo e($la_value['menuName']); ?> ---<?php echo e($l1_id); ?></div>
                                              <div class="table-responsive">
                                                  <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                                      ...
                                                      <tbody>
                                                          ...
                                                          <?php $__currentLoopData = $lavel_two_arr[$l1_id]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $l2_id=>$lb_value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                              <td class="text-center text-muted" >
                                                                  <router-link :to="{ path: '/<?php echo e($lb_value['menuRoute']); ?>', params: { id: 20 }}" class="router-link" >
