...
class CreateResidentialSuiteDetailsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('residential_suite_details', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('residential_suite_details');
    }
}
