...
class CreateSaleChargeBreakdownsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('sale_charge_breakdowns', function (Blueprint $table) {
            $table->increments('id');
    ...
    {
        Schema::dropIfExists('sale_charge_breakdowns');
    }
}
