...
class CreateStorageLotsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('storage_lots', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->double('storage_lot_size_qty',10,2)->default(0.00);
            $table->double('total_storage_level_size',10,2)->default(0.00);
            $table->double('total_storage_stall_size',10,2)->default(0.00);                  
    ...
    {
        Schema::dropIfExists('storage_lots');
    }
}
