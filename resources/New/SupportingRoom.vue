            ...
            <div class="form-card">
                ...
                <div v-if="!list_showable">
                    ...
                    <div class="text-center">
                        ...
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="editmode" @click.prevent="deleteSupportingRooms()">Delete</button>
        ...
        methods: {
            ...
            editSupportingRooms(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.customer_name                     =response.data.supporting_room_arr.customer_name;
