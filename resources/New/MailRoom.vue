	        ...
	        <div class="form-card">
                ...
                <div v-if="!list_showable">
                    ...
                    <div class="text-center" v-if="!list_showable">
                        ...
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="editmode" @click.prevent="deleteMailRoom()">Delete</button>
	    ...
	    methods: {
            ...
            editMailRoom(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.customer_name                     =response.data.mail_room_arr.customer_name;
