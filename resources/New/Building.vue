                    ...
                    <datatable :columns="columns" :data="rows" :filter-by="filter">
                        <template slot-scope="{row}">
                            <tr>
                                ...
                                <td>{{ row.dependency_class }}</td>
                                <td>{{ row.property_type }}</td>
                                <td width="120">
                                    <button class="btn btn-primary btn-sm"  @click.prevent="editBuildingInfo(row.id)">Edit</button>
                                    <button  class="btn btn-danger btn-sm" @click.prevent="BuildingDelete(row.id)">Delete</button>
                                </td>
                            </tr>
                        </template>
                    </datatable>
                ...
                <div v-if="!list_showable">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <label class="fieldlabels">UOM:</label>
                                                 <select v-model="form.building_uom"
                                                    name="building_uom"
                                                    class="custom-select" 
                                                    
                                                    :class="{ 'is-invalid': form.errors.has('building_uom') }" >
                                                    <option  value="">--Select UOM-- </option>
                                                    <option value="1">Square Feet</option>
                                                    <option value="2">Square Meter</option>
                                                    <option value="3">Square Yard</option>
                                                </select>
                                                <has-error :form="form" field="building_uom"></has-error>

                                                <label class="fieldlabels">Building Size:</label> 
                                                <input v-model="form.total_building_size" 
                                                    type="number" 
                                                    name="total_building_size" 
                                                    placeholder="Type Building Size" 
                                                    :class="{ 'is-invalid': form.errors.has('total_building_size') }"/>
                                                <has-error :form="form" field="total_building_size"></has-error>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="form-folder">
                        <h3><i class="fa fa-hand-point-right"></i> Property Management Type
                            <button type="button" class="btn btn-primary btn-sm" @click="show_hide_property_management()" v-show="!property_management_show">Show</button> <button type="button" class="btn btn-primary btn-sm" @click="show_hide_property_management()" v-show="property_management_show">Hide</button></h3>
                        </h3>
                    ...
                    <div class="form-folder">
                        <h3><i class="fa fa-hand-point-right"></i> License and Permits
                            <button type="button" class="btn btn-primary btn-sm" @click="show_hide_licence()" v-show="!licence_show">Show</button> <button type="button" class="btn btn-primary btn-sm" @click="show_hide_licence()" v-show="licence_show">Hide</button></h3>
                        </h3>
        ...
        data(){
            return{
                ...
                columns: [
                    ...
                    { label: 'Building No', field: 'building_no' },
                    { label: 'Building Name', field: 'building_name' },
                    { label: 'Number Of Floor', field: 'number_of_floor' },
                    { label: 'Dependency Class', field: 'dependency_class' },
	    ...
	    methods: {
            ...
            editBuildingInfo(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    //this.roof_top_arr                           =response.data.roof_top_arr;
                    //this.upper_building_arr                     =response.data.upper_building_arr;
                   // this.ground_building_arr                    =response.data.ground_building_arr;
                   // this.under_ground_building_arr              =response.data.under_ground_building_arr;
                    ...
                    this.form.customer_name                     =response.data.building_list_arr.customer_name;
            ...
            reset_list()
            {
                ...
                window.axios.get(uri).then((response) => {
                    this.rows = response.data.building_list;
                });
