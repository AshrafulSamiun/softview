<template>
    ...
    <fieldset>
        <form id="msform" @submit.prevent="editmode ? updateCustomerProfile() : createCompanyProfile()" @keydown="form.onKeydown($event)">
            <div class="form-card">
                <h1 class="page-head">Customer (Seller) Information</h1>
    ...
    export default {
        ...
        methods: {
            ...
            {            
                  ...
                  Swal.fire({
                    ...
                    confirmButtonText: 'Yes, delete it!'
                      ...
                      this.form.delete('/CustomerSellers/'+this.form.id).then(()=>{
            ...
            updateCustomerProfile()
            {
                ...
                this.form.put('/CustomerSellers/'+this.form.id).then(({ data })=>{
                    var response_data=data.split("**");
            ...
            save_stay(type){
                ...
                this.form.post('/CustomerSellers') .then(({ data }) => { 
                    var response_data=data.split("**");
                    if(response_data[0]==1)
                    {
                         toast({
            ...
            fetchCustomerProfileUpdate(id)
            {
                ...
                let uri = '/CustomerSellers/'+id+'/edit';
                window.axios.get(uri).then((response) => {
