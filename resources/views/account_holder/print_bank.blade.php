...
<body>
	<div style="width:1100px; margin-left: 100px;" align="center">
			...
			<table width="1100" align="center">
		        ...
		        <tr><td align="center" style="font-size:30px;" colspan="6"><u><strong>Bank Info Details</strong></u></td></tr> 
		        <tr>
		        ...
		        <tr  style="font-size:20px;">
		        	<td align="left" width="200">Bank Account No</td>
		        	<td align="left" width="300">: {{$account_holder['bank_acount_no']}}</td>
		        	<td align="left">Account Type</td>
		        	<td align="left">: {{$account_holder['account_type']}}</td>
		        </tr>

		        <tr  style="font-size:20px;">
		        	<td align="left" width="200">Bank Name</td>
		        	<td align="left" width="300">: {{$account_holder['bank_account_name']}}</td>
