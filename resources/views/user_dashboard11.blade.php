                ...
                <li class="nav-item has-treeview menu-open">
                  ...
                  <ul class="nav nav-treeview" >
                       ...
                       <fieldset style="width:550px; margin-left:250px;">
                        {!! Form::open(array('class' => 'contact-form','route' => 'PropertyManagementTypes.store','method'=>'POST')) !!}
                          ...
                          <table  class="table " style="font-size:13px; line-height:12px;">
                            ...
                            <tbody style="line-height:30px;">
                                ...
                                <tr>
                                  <td>
                                      <div  class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="0" name="landlord_rantal" id="landlord_rantal">
                                        <label for="landlord_rantal">Rental</label>
                                      </div>
                                  </td>
                                  <td>
                                       <div  class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="0" name="strata_rental" id="strata_rental">
                                ...
                                <tr>
                                  ...
                                  <td>
                                       <div  class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="0" name="strata_leasehold" id="strata_leasehold">
                                ...
                                <tr>
                                  <td>
                                    ...
                                    <div  class="icheck-primary d-inline ml-2">
                                      <input type="checkbox" value="0" name="landlord_both" id="landlord_both">
                                  ...
                                  <td>
                                       <div  class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="0" name="strata_both" id="strata_both">
