               ...
               role="menu" data-accordion="false" >
                ...
                <li class="nav-item has-treeview menu-open">
                  ...
                  <ul class="nav nav-treeview">
                    ...
                    <fieldset style="width:750px; margin-left:250px;">
                        {!! Form::open(array('enctype'=>'multipart/form-data','class' => 'contact-form','route' => 'BuildingInfos.store','method'=>'POST')) !!}
                          ...
                          <table  class="" style="font-size:13px; line-height:12px;">
                            ...
                            <tbody style="line-height:30px;">
                                ...
                                <tr>
                                  ...
                                  <td>
                                      <div  class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="0" name="residential" id="residential">
                                        <label for="residential">Residential</label>
                                      </div>
                                  </td>
                                  <td>
                                       <div  class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="0" name="commercial" id="commercial">
                                  ...
                                  <td>
                                      ...
                                      <div  class="icheck-primary d-inline ml-2">
                                        <input type="checkbox" value="0" name="industrial" id="industrial">
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <div class="form-group">
                                        <input  type="text" name="building_name" value=""  class="form-control" required>
                                        @if ($errors->has('building_name'))
           building_photo                                 <span class="help-block">
                                ...
                                <tr>
                                  ...
                                  <td colspan="2">
                                      ...
                                      <div class="input-group mb-3">
                                          ...
                                          <div class="custom-file">
                                            <input type="hidden" id="building_photo" name="building_photo" value="" > 
                                            <input type="file" class="custom-file-input" value="" name="building_photo_url" id="building_photo_url">
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <div class="form-group">
                                        <input  type="text" name="number_of_floor" value=""  class="form-control" required>
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <div class="form-group">
                                        <input  type="text" name="number_of_suits" value=""  class="form-control" required>
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <div class="form-group">
                                        <input  type="text" name="number_of_rental_office" value=""  class="form-control" required>
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <div class="form-group">
                                        <input  type="text" name="number_of_rental_store" value=""  class="form-control" required>
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <div class="form-group">
                                        <input  type="text" name="number_of_parking_stall" value=""  class="form-control" required>
                                ...
                                <tr>
                                  ...
                                  <td colspan="3">
                                    <div class="form-group">
                                        <input  type="text" name="number_of_storage_locker" value=""  class="form-control" required>
