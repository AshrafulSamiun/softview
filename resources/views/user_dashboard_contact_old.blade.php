              ...
              <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview"
               role="menu" data-accordion="false" >
                ...
                <li class="nav-item has-treeview ">
                  <a href="#" class="nav-link active" style="width:250px;background:#0070C0" >
                                ...
                                <tr>
                                  ...
                                  <td>
                                      ...
                                      <div class="form-group">
                                        ...
                                        <!--  <input type="text" id="company_photo_url" name="company_photo_url" value="" >   --> 
                                         <input type="file"  name="company_logo_url" id="company_logo_url" class="form-control form-control-lg"
                ...
                <li class="nav-item has-treeview ">
                  ...
                  <ul class="nav nav-treeview">
                     ...
                     <fieldset style="width:1100px; margin-left:250px;">
                        {!! Form::model($user_service_plan, ['method' => 'PATCH','route' => ['UserServicePlans.update', $user_service_plan->id]]) !!}
                        ...
                        id="service_plan_table">
                          <thead style="line-height:30px;">
                            ...
                            <tr align="center" >
                                <th  width="350" rowspan="3" style="vertical-align:center">
                                  <div class="form-group">
                                      <label for="servicePlanMonthly" id="servicePlanMonthly"
                                      @if($user_service_plan->service_plan_type) class="montly_enable"
                                        @else class="yearly_disable" @endif >Monthly</label>
                                      <label class="switch">

                                        <input type="checkbox" id="servicePlanMonthlyYearly"
                                        onclick="enable_monthly_yearly()"
                                        name="servicePlanMonthlyYearly"
                                        @if($user_service_plan->service_plan_type) value="1" checked
                                        @else value="0" @endif>

                                        <span class="btnonof round"></span>
                                      </label>
                                      <label for="servicePlanYearly" id="servicePlanYearly"
                                      @if($user_service_plan->service_plan_type) class="yearly_disable"
                                        @else class="montly_enable" @endif >Yearly</label>
                                        <input type="hidden" id="service_plan_type" name="service_plan_type"
                                        @if($user_service_plan->service_plan_type) value="1" checked
                                        @else value="0" @endif  >
                                  </div>
                                 </th>
                            ...
                            <tr align="center" >
                                <th @if($user_service_plan->single_owner) class="th_enable" @endif>
                                   <div  class="icheck-primary d-inline ml-2">
                                      <input type="checkbox"
                                      @if($user_service_plan->single_owner) value="1" checked
                                        @else value="0" @endif
                                      name="plan_a" id="plan_a"
                                      onclick="plan_checked('plan_a')">
                                      <label for="plan_a"> Plan A</label>
                                      <input type="hidden" id="single_owner" name="single_owner"
                                       @if($user_service_plan->single_owner) value="1" checked
                                        @else value="0" @endif >
                                    </div>
                                 </th>
                                <th @if($user_service_plan->multiple_owner) class="th_enable" @endif>
                                  <div  class="icheck-primary d-inline ml-2">
                                      <input type="checkbox"  name="plan_b" id="plan_b"
                                      onclick="plan_checked('plan_b')" @if($user_service_plan->multiple_owner) value="1" checked
                                        @else value="0" @endif>
                                      <label for="plan_b">Plan B</label>
                                      <input type="hidden" id="multiple_owner" name="multiple_owner" 
                                      @if($user_service_plan->multiple_owner) value="1" checked
                                        @else value="0" @endif >
                                  </div>
                                </th>
                                <th @if($user_service_plan->single_owner_multiproperty) class="th_enable" @endif>
                                  <div  class="icheck-primary d-inline ml-2">
                                      <input type="checkbox"  name="plan_c" id="plan_c"
                                      onclick="plan_checked('plan_c')" @if($user_service_plan->single_owner_multiproperty) value="1" checked
                                        @else value="0" @endif>
                                      <label for="plan_c">Plan C</label>
                                      <input type="hidden" id="single_owner_multiproperty" name="single_owner_multiproperty"  
                                      @if($user_service_plan->single_owner_multiproperty) value="1" checked
                                        @else value="0" @endif>
                                  </div> 
                                </th>
                                <th @if($user_service_plan->multiple_owner_multiproperty) class="th_enable" @endif>
                                  <div  class="icheck-primary d-inline ml-2">
                                      <input type="checkbox"  name="plan_d" id="plan_d"
                                      onclick="plan_checked('plan_d')" @if($user_service_plan->multiple_owner_multiproperty) value="1" checked
                                        @else value="0" @endif>
                                      <label for="plan_d">Plan D</label>
                                      <input type="hidden" id="multiple_owner_multiproperty" name="multiple_owner_multiproperty"
                                      @if($user_service_plan->multiple_owner_multiproperty) value="1" checked
                                        @else value="0" @endif >
                                  </div>
                                </th>
                          ...
                          <tbody>
                            ...
                            @if(!empty($lavel_one_plan_arr[$mid]))
                              ...
                              @endif
                                  ...
                                  <input type="hidden" id="plan_update_id_{{$mid}}" name="plan_update_id[]"
                                   value="{{$user_service_plan_dtls_arr[$mid]['id']}}">

                                  <input type="hidden" id="plan_value_{{$mid}}" name="plan_value[]" 
                                  value="{{$user_service_plan_dtls_arr[$mid]['plan_value']}}">
                                  @else
                                    <div class="form-check">
                                        <input class="form-check-input" name="plan_name_{{$mid}}" type="checkbox" 
                                        value="{{$user_service_plan_dtls_arr[$mid]['plan_value']}}" id="plan_name_{{$mid}}"
                                        onclick="check_master_row({{$mid}})"
                                         <?php if($mid==1) echo "checked disabled"; else if($user_service_plan_dtls_arr[$mid]['plan_value']) echo "checked"; ?>>
                                         <input type="hidden" id="plan_id_{{$mid}}" name="plan_id[]" value="{{$mid}}">
                                         <input type="hidden" id="plan_update_id_{{$mid}}" name="plan_update_id[]"
                                            value="{{$user_service_plan_dtls_arr[$mid]['id']}}">
                                         <input type="hidden" id="plan_value_{{$mid}}" name="plan_value[]" 
                                         value="<?php if($mid==1) echo "1"; else echo $user_service_plan_dtls_arr[$mid]['plan_value']; ?>">
                                ...
                                @if($mvalue['amount_applicable']==1)
                                  <td @if($user_service_plan->single_owner && $user_service_plan_dtls_arr[$mid]['plan_value']) class="td_enable" @endif> {{$mvalue['plan_a']}}</td>
                                  <td @if($user_service_plan->multiple_owner && $user_service_plan_dtls_arr[$mid]['plan_value']) class="td_enable" @endif>{{$mvalue['plan_b']}}</td>
                                  <td @if($user_service_plan->single_owner_multiproperty && $user_service_plan_dtls_arr[$mid]['plan_value']) class="td_enable" @endif>{{$mvalue['plan_c']}}</td>
                                  <td @if($user_service_plan->multiple_owner_multiproperty && $user_service_plan_dtls_arr[$mid]['plan_value']) class="td_enable" @endif> {{$mvalue['plan_d']}}</td>
                                @else
                                  <td></td>
                                  <td> </td>
                                  <td></td>
                                ...
                                @foreach($lavel_one_plan_arr[$mid] as $loneid=>$lonevalue)
                                  ...
                                  id="tr_{{$mid}}_{{$sl}}">
                                    <td align="left" style="margin-left:30px;">
                                      ...
                                      <input type="hidden" id="plan_update_id_{{$loneid}}" name="plan_update_id[]"
                                   value="{{$user_service_plan_dtls_arr[$loneid]['id']}}">
                                      <input type="hidden" id="plan_value_{{$loneid}}" name="plan_value[]" 
                                      value="{{$user_service_plan_dtls_arr[$loneid]['plan_value']}}">
                                      @else
                                         <div class="form-check">
                                          <input class="form-check-input" type="checkbox" name="plan_name_{{$loneid}}"
                                           value="{{$user_service_plan_dtls_arr[$loneid]['plan_value']}}" id="plan_name_{{$loneid}}" 
                                    ...
                                    @if($lonevalue['amount_applicable']==1)
                                      <td @if($user_service_plan->single_owner && $user_service_plan_dtls_arr[$loneid]['plan_value']) class="td_enable" @endif>{{$lonevalue['plan_a']}}</td>
                                      <td @if($user_service_plan->multiple_owner && $user_service_plan_dtls_arr[$loneid]['plan_value']) class="td_enable" @endif>{{$lonevalue['plan_b']}}</td>
                                      <td @if($user_service_plan->single_owner_multiproperty && $user_service_plan_dtls_arr[$loneid]['plan_value']) class="td_enable" @endif>{{$lonevalue['plan_c']}}</td>
                                      <td @if($user_service_plan->multiple_owner_multiproperty && $user_service_plan_dtls_arr[$loneid]['plan_value']) class="td_enable" @endif>{{$lonevalue['plan_d']}}</td>
                                    @else
                                      <td></td>
                                      <td></td>
                                      <td></td>
                          ...
                          <tfoot align="center">
                            <tr id="monthly_total">
                              <th > Monthly Total
                                <input type="hidden" id="monthly_total_single_owner" name="monthly_total_single_owner" value="{{$user_service_plan->monthly_total_single_owner}}" />
                                <input type="hidden" id="monthly_total_multiple_owner" name="monthly_total_multiple_owner" value="{{$user_service_plan->monthly_total_multiple_owner}}" />
                                <input type="hidden" id="monthly_total_multi_building_single_owner" name="monthly_total_multi_building_single_owner" value="{{$user_service_plan->monthly_total_multi_building_single_owner}}" />
                                <input type="hidden" id="monthly_total_multi_building_multi_owner" name="monthly_total_multi_building_multi_owner" value="{{$user_service_plan->monthly_total_multi_building_multi_owner}}" />
                              
                              </th>
                              <th>{{$user_service_plan->monthly_total_single_owner}}</th>
                              <th>{{$user_service_plan->monthly_total_multiple_owner}}</th>
                              <th>{{$user_service_plan->monthly_total_multi_building_single_owner}}</th>
                               <th>{{$user_service_plan->monthly_total_multi_building_multi_owner}}</th>
                            </tr>
                            <tr id="yearly_total_gess">
                              <th> <del>Yearly Total</del></th>
                              <th><del>{{$user_service_plan->yearly_total_single_owner/.8}}</del></th>
                              <th><del>{{$user_service_plan->yearly_total_multiple_owner/.8}}</del></th>
                              <th><del>{{$user_service_plan->yearly_total_multi_building_single_owner/.8}}</del></th>
                              <th><del>{{$user_service_plan->yearly_total_multi_building_multi_owner/.8}}</del></th>
                            </tr>
                            <tr id="yearly_total">
                              <th>Yearly Total (20% off)
                                <input type="hidden" id="yearly_total_single_owner" name="yearly_total_single_owner" 
                                value="{{$user_service_plan->yearly_total_single_owner}}" />
                                <input type="hidden" id="yearly_total_multiple_owner" name="yearly_total_multiple_owner" 
                                value="{{$user_service_plan->yearly_total_multiple_owner}}" />
                                <input type="hidden" id="yearly_total_multi_building_single_owner" 
                                name="yearly_total_multi_building_single_owner" value="{{$user_service_plan->yearly_total_multi_building_single_owner}}" />
                                <input type="hidden" id="yearly_total_multi_building_multi_owner" name="yearly_total_multi_building_multi_owner" 
                                value="{{$user_service_plan->yearly_total_multi_building_multi_owner}}" />
                              </th>
                              <th>{{$user_service_plan->yearly_total_single_owner}}</th>
                              <th>{{$user_service_plan->yearly_total_multiple_owner}}</th>
                              <th>{{$user_service_plan->yearly_total_multi_building_single_owner}}</th>
                              <th>{{$user_service_plan->yearly_total_multi_building_multi_owner}}</th>
                            </tr>
                          </tfoot>
                        </table>
                        <table  class="text-center " style="font-size:13px; line-height:12px;" align="center">
                ...
                <li class="nav-item has-treeview menu-open">
                  ...
                  <ul class="nav nav-treeview" >
                    <div class="card" style="" sytle="display:none;" align="center">
                      <div class="card-heading">
                      </div>
                        <div class="card-body">
                          {!! Form::open(array('class' => 'contact-form','route' => 'UserCompanies.store','method'=>'POST')) !!}
                            <div class="form-section">
                                ...
                                <legend style="width:100%;">Addresses and Contacts </legend>
                                  ...
                                  <tbody>
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="director_legal_name" class="form-control" id="director_legal_name" required>
                                            @if ($errors->has('director_legal_name'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_legal_name') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="president_legal_name" class="form-control" id="president_legal_name" required>
                                            @if ($errors->has('president_legal_name'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_legal_name') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="property_manager" class="form-control" id="property_manager" required>
                                            @if ($errors->has('property_manager'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('property_manager') }}</strong>
                                                </span>
                                            @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="accounting_manager_legal_name" class="form-control" id="accounting_manager_legal_name" required>
                                            @if ($errors->has('accounting_manager_legal_name'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('accounting_manager_legal_name') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                       ...
                                       <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            ...
                                            {!! Form::select('director_department',[null=>"Select Department"]+ $country_arr,null, array('required','id' =>'director_department','onchange' => 'change_country_dropdown(this.id,"company_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('director_department'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('director_department') }}</strong>
                                                  </span>
                                              @endif
                                        ...
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('president_department',[null=>"Select Department"]+ $country_arr,null, array('required','id' =>'president_department','onchange' => 'change_country_dropdown(this.id,"head_office_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('president_department'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('president_department') }}</strong>
                                                  </span>
                                              @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('property_manager_department',[null=>"Select Department"]+ $country_arr,null, array('required','id' =>'property_manager_department','onchange' => 'change_country_dropdown(this.id,"property_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('property_manager_department'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_department') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('system_admin_department',[null=>"Select Department"]+ $country_arr,null, array('required','id' =>'system_admin_department','onchange' => 'change_country_dropdown(this.id,"head_office_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('system_admin_department'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('system_admin_department') }}</strong>
                                                  </span>
                                              @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('account_manager_department',[null=>"Select Department"]+ $country_arr,null, array('required','id' =>'account_manager_department','onchange' => 'change_country_dropdown(this.id,"property_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('account_manager_department'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_department') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('account_payable_department',[null=>"Select Department"]+ $country_arr,null, array('required','id' =>'account_payable_department','onchange' => 'change_country_dropdown(this.id,"head_office_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('account_payable_department'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_payable_department') }}</strong>
                                                  </span>
                                              @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('authorize_person_department',[null=>"Select Department"]+ $country_arr,null, array('required','id' =>'authorize_person_department','onchange' => 'change_country_dropdown(this.id,"property_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('authorize_person_department'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('authorize_person_department') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            ...
                                            {!! Form::select('director_country',[null=>"Select Country name"]+ $country_arr,null, array('required','id' =>'director_country','onchange' => 'change_country_dropdown(this.id,"company_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('director_country'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('director_country') }}</strong>
                                                  </span>
                                              @endif
                                        ...
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('president_country',[null=>"Select Country name"]+ $country_arr,null, array('required','id' =>'president_country','onchange' => 'change_country_dropdown(this.id,"head_office_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('president_country'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('president_country') }}</strong>
                                                  </span>
                                              @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('property_manager_country',[null=>"Select Country name"]+ $country_arr,null, array('required','id' =>'property_manager_country','onchange' => 'change_country_dropdown(this.id,"property_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('property_manager_country'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_country') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('system_admin_country',[null=>"Select Country name"]+ $country_arr,null, array('required','id' =>'system_admin_country','onchange' => 'change_country_dropdown(this.id,"head_office_provience_id")','class' => 'form-control')) !!}
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('account_manager_country',[null=>"Select Country name"]+ $country_arr,null, array('required','id' =>'account_manager_country','onchange' => 'change_country_dropdown(this.id,"property_provience_id")','class' => 'form-control')) !!}

                                              @if ($errors->has('account_manager_country'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_country') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('account_payable_country',[null=>"Select Country name"]+ $country_arr,null, array('required','id' =>'account_payable_country','onchange' => 'change_country_dropdown(this.id,"head_office_provience_id")','class' => 'form-control')) !!}
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('authorize_person_country',[null=>"Select Country name"]+ $country_arr,null, array('required','id' =>'authorize_person_country','onchange' => 'change_country_dropdown(this.id,"property_provience_id")','class' => 'form-control')) !!}
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('director_provience',[null=>"Select Provience"],null, array('required','id' =>'director_provience','class' => 'form-control')) !!}

                                            @if ($errors->has('director_provience'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_provience') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            {!! Form::select('president_provience',[null=>"Select Provience"],null, array('required','id' =>'president_provience','class' => 'form-control')) !!}

                                            @if ($errors->has('president_provience'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_provience') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('property_manager_provience',[null=>"Select Provience"],null, array('required','id' =>'property_manager_provience','class' => 'form-control')) !!}

                                              @if ($errors->has('property_manager_provience'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_provience') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              {!! Form::select('account_manager_provience',[null=>"Select Provience"],null, array('required','id' =>'account_manager_provience','class' => 'form-control')) !!}

                                              @if ($errors->has('account_manager_provience'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_provience') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="director_city" class="form-control" id="director_city" required>
                                            @if ($errors->has('director_city'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_city') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="president_city" class="form-control" id="president_city" required>
                                            @if ($errors->has('president_city'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_city') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="property_manager_city" class="form-control" id="property_manager_city" required>
                                            @if ($errors->has('property_manager_city'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('property_manager_city') }}</strong>
                                                </span>
                                            @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="account_manager_city" class="form-control" id="account_manager_city" required>
                                            @if ($errors->has('account_manager_city'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('account_manager_city') }}</strong>
                                                </span>
                                            @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="director_street_no" class="form-control" id="director_street_no" required>
                                            @if ($errors->has('director_street_no'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_street_no') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="president_street_no" class="form-control" id="president_street_no" required>
                                            @if ($errors->has('president_street_no'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_street_no') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="property_manager_street_no" class="form-control" id="property_manager_street_no" required>
                                              @if ($errors->has('property_manager_street_no'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_street_no') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="account_manager_street_no" class="form-control" id="account_manager_street_no" required>
                                              @if ($errors->has('account_manager_street_no'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_street_no') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="director_postal_code" class="form-control" id="director_postal_code" required>
                                            @if ($errors->has('director_postal_code'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_postal_code') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="president_postal_code" class="form-control" id="president_postal_code" required>
                                            @if ($errors->has('president_postal_code'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_postal_code') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="property_manager_postal_code" class="form-control" id="property_manager_postal_code" required>
                                              @if ($errors->has('property_manager_postal_code'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_postal_code') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="account_manager_postal_code" class="form-control" id="account_manager_postal_code" required>
                                              @if ($errors->has('account_manager_postal_code'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_postal_code') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="director_office_phone" class="form-control" id="director_office_phone" required>
                                            @if ($errors->has('director_office_phone'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_office_phone') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="president_office_phone" class="form-control" id="president_office_phone" required>
                                            @if ($errors->has('president_office_phone'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_office_phone') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="property_manager_office_phone" class="form-control" id="property_manager_office_phone" required>
                                              @if ($errors->has('property_manager_office_phone'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_office_phone') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="account_manager_office_phone" class="form-control" id="account_manager_office_phone" required>
                                              @if ($errors->has('account_manager_office_phone'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_office_phone') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="director_cell_phone" class="form-control" id="director_cell_phone" required>
                                            @if ($errors->has('director_cell_phone'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_cell_phone') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="president_cell_phone" class="form-control" id="president_cell_phone" required>
                                            @if ($errors->has('president_cell_phone'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_cell_phone') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="property_manager_cell_phone" class="form-control" id="property_manager_cell_phone" required>
                                              @if ($errors->has('property_manager_cell_phone'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_cell_phone') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="account_manager_cell_phone" class="form-control" id="account_manager_cell_phone" required>
                                              @if ($errors->has('account_manager_cell_phone'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_cell_phone') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="director_fax_no" class="form-control" id="director_fax_no" required>
                                            @if ($errors->has('director_fax_no'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_fax_no') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="text" name="president_fax_no" class="form-control" id="president_fax_no" required>
                                            @if ($errors->has('president_fax_no'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_fax_no') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="property_manager_fax_no" class="form-control" id="property_manager_fax_no" required>
                                              @if ($errors->has('property_manager_fax_no'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_fax_no') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="text" name="account_manager_fax_no" class="form-control" id="account_manager_fax_no" required>
                                              @if ($errors->has('account_manager_fax_no'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_fax_no') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                      ...
                                      <tr>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="email" name="director_email" class="form-control" id="director_email" required>
                                            @if ($errors->has('director_email'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('director_email') }}</strong>
                                                </span>
                                            @endif
                                          </div>    
                                        </td>
                                        ...
                                        <td>
                                          <div class="form-group">
                                            <input  type="email" name="president_email" class="form-control" id="president_email" required>
                                            @if ($errors->has('president_email'))
                                                <span class="help-block">
                                                    <strong>{{ $errors->first('president_email') }}</strong>
                                                </span>
                                            @endif
                                          </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="email" name="property_manager_email" class="form-control" id="property_manager_email" required>
                                              @if ($errors->has('property_manager_email'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('property_manager_email') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
                                        ...
                                        <td>
                                            <div class="form-group">
                                              <input  type="email" name="account_manager_email" class="form-control" id="account_manager_email" required>
                                              @if ($errors->has('account_manager_email'))
                                                  <span class="help-block">
                                                      <strong>{{ $errors->first('account_manager_email') }}</strong>
                                                  </span>
                                              @endif
                                            </div>
                                        </td>
