...
<style type="text/css">
    ...
    .li_router_link .router-link-active{
...
<div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
  ...
  <section class="app-header header-shadow">
      <div class="app-header__logo">
          <div class="logo-src">
              <img src="images/logo-png(2).png" alt="" height="" width="40"/>
              <b>{{$project_name}}</b>
          </div>
          <strong></strong>
      </div>
                                              ...
                                              @if(!empty($lavel_two_arr[$l1_id]))
                                                  ...
                                                  <ul>
                                                      @foreach($lavel_two_arr[$l1_id] as $l2_id=>$lb_value)
                                                          ...
                                                          <li>
                                                              <router-link :to="{ path: '/{{$lb_value['menuRoute']}}', params: { id: 20 }}"
