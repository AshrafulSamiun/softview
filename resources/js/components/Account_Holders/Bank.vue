...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            print_data()
            {
                let uri = '/AccountHoldersBankPrintAll/'+this.report_type+'/1';
                window.axios.get(uri).then((response) => {
            ...
            print_pdf()
            {
                let uri = '/AccountHoldersBankPrintPdf/'+this.form.id;
                window.axios.get(uri).then((response) => {
            ...
            posting_status_show()
            {
                ...
                {
                    let uri = '/AccountHolderBankPostingStatus';
                    window.axios.get(uri).then((response) => {
            ...
            posting_status_details(type)
            {
                ...
                this.form.reset();
                this.editmode=false;
                let uri = '/AccountHolderBankPostingType/'+type;
                window.axios.get(uri).then((response) => {
                ...
                let uri1 = '/AccountHoldersBankPrintAll/'+this.report_type+'/2';
