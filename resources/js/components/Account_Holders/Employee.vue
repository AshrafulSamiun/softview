                ...
                <div id="content">
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Employee  Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Employee  Name:</label>
                                            <input 
                                            ...
                                            <label class="fieldlabels">Employee   Photo:</label> 
                                            <input 
                                                v-model="form.employee_photo" 
                                                type="text" 
                                                name="employee_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('employee_photo') }"/>
                                            <has-error :form="form" field="employee_photo"></has-error> 
                                           
                                                        <h4>Employee  Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.employee_office_phone" 
                                                                type="text" 
                                                                name="employee_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_office_phone') }"/>
                                                                 <has-error :form="form" field="employee_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.employee_cell_phone" 
                                                                type="text" 
                                                                name="employee_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_cell_phone') }"/>
                                                                 <has-error :form="form" field="employee_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.employee_email" 
                                                                type="employee_email" 
                                                                name="employee_email" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_email') }"/>
                                                                 <has-error :form="form" field="employee_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.employee_fax_no" 
                                                                type="text" 
                                                                name="employee_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_fax_no') }"/>
                                                                 <has-error :form="form" field="employee_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.employee_website" 
                                                                type="url" 
                                                                name="employee_website" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_website') }"/>
                                                                 <has-error :form="form" field="employee_website"></has-error>
                                             


                                                        <h4>Employee  Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.employee_house_number" 
                                                                type="phone" 
                                                                name="employee_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_house_number') }"/>
                                                                 <has-error :form="form" field="employee_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.employee_street_number" 
                                                                type="text" 
                                                                name="employee_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_street_number') }"/>
                                                                 <has-error :form="form" field="employee_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.employee_city" 
                                                                type="text" 
                                                                name="employee_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_city') }"/>
                                                                 <has-error :form="form" field="employee_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.employee_state" 
                                                                type="text" 
                                                                name="employee_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_state') }"/>
                                                                 <has-error :form="form" field="employee_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.employee_country"
                                                                    name="employee_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('employee_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.employee_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('employee_zip_code') }"/>
                                                                 <has-error :form="form" field="employee_zip_code"></has-error> 
...
data(){
    return{
        ...
        columns: [
            ...
            { label: 'Mobile No', field: 'employee_cell_phone' },
            { label: 'Country', field: 'employee_country' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderEmployee/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderEmployeeLists';
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderEmployee/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderEmployee') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderEmployee/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderEmployee/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.employee_name=response.data.account_holder.employee_name;
                    this.form.employee_photo=response.data.account_holder.employee_photo;


                    this.form.employee_office_phone=response.data.account_holder.employee_office_phone;
                    this.form.employee_cell_phone=response.data.account_holder.employee_cell_phone;
                    this.form.employee_state=response.data.account_holder.employee_state;
                    this.form.employee_email=response.data.account_holder.employee_email;
                    this.form.employee_fax_no=response.data.account_holder.employee_fax_no;
                    this.form.employee_website=response.data.account_holder.employee_website;

                   

                    this.form.employee_house_number=response.data.account_holder.employee_house_number;
                    this.form.employee_street_number=response.data.account_holder.employee_street_number;
                    this.form.employee_city=response.data.account_holder.employee_city;
                    this.form.employee_state=response.data.account_holder.employee_state;
                    this.form.employee_country=response.data.account_holder.employee_country;
                    this.form.employee_zip_code=response.data.account_holder.employee_zip_code;
