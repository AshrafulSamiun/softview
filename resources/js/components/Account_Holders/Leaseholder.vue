    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Leaseholder Profile</h1> 
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>  
                                    ...
                                    <td>{{ row.lease_holder_name }}</td>
                                    <td>{{ row.company_name }}</td>
                                    <td>{{ row.lease_holder_email }}</td>
                                    <td>{{ row.lease_holder_cell_phone }}</td>
                                    <td>{{ row.lease_holder_country }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Leaseholder Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Leaseholder Name:</label>
                                            <input 
                                                v-model="form.lease_holder_name" 
                                                type="text" 
                                                name="lease_holder_name" 
                                                placeholder="Type Leaseholder Name" 
                                                :class="{ 'is-invalid': form.errors.has('lease_holder_name') }"/>
                                            <has-error :form="form" field="lease_holder_name"></has-error> 
                                            <label class="fieldlabels">Leaseholder  Photo:</label> 
                                            <input 
                                                v-model="form.lease_holder_photo" 
                                                type="text" 
                                                name="lease_holder_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('lease_holder_photo') }"/>
                                            <has-error :form="form" field="lease_holder_photo"></has-error> 
                                           
                                                        <h4>Leaseholder Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.lease_holder_office_phone" 
                                                                type="text" 
                                                                name="lease_holder_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_office_phone') }"/>
                                                                 <has-error :form="form" field="lease_holder_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.lease_holder_cell_phone" 
                                                                type="text" 
                                                                name="lease_holder_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_cell_phone') }"/>
                                                                 <has-error :form="form" field="lease_holder_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.lease_holder_email" 
                                                                type="lease_holder_email" 
                                                                name="lease_holder_email" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_email') }"/>
                                                                 <has-error :form="form" field="lease_holder_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.lease_holder_fax_no" 
                                                                type="text" 
                                                                name="lease_holder_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_fax_no') }"/>
                                                                 <has-error :form="form" field="lease_holder_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.lease_holder_website" 
                                                                type="url" 
                                                                name="lease_holder_website" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_website') }"/>
                                                                 <has-error :form="form" field="lease_holder_website"></has-error>
                                             


                                                        <h4>Leaseholder Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.lease_holder_house_number" 
                                                                type="phone" 
                                                                name="lease_holder_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_house_number') }"/>
                                                                 <has-error :form="form" field="lease_holder_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.lease_holder_street_number" 
                                                                type="text" 
                                                                name="lease_holder_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_street_number') }"/>
                                                                 <has-error :form="form" field="lease_holder_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.lease_holder_city" 
                                                                type="text" 
                                                                name="lease_holder_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_city') }"/>
                                                                 <has-error :form="form" field="lease_holder_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.lease_holder_state" 
                                                                type="text" 
                                                                name="lease_holder_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_state') }"/>
                                                                 <has-error :form="form" field="lease_holder_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.lease_holder_country"
                                                                    name="lease_holder_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('lease_holder_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.lease_holder_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('lease_holder_zip_code') }"/>
                                                                 <has-error :form="form" field="lease_holder_zip_code"></has-error> 
...
data(){
    return{
        ...
        form:new Form({
            ...
            lease_holder_name:'',
            lease_holder_photo:'', 
            lease_holder_office_phone:'',
            lease_holder_cell_phone:'',
            lease_holder_email:'',
            lease_holder_fax_no:'',
            lease_holder_website:'', 
            lease_holder_house_number:'',
            lease_holder_street_number:'',
            lease_holder_city:'',
            lease_holder_state:'',
            lease_holder_country:'',
            lease_holder_zip_code:'',
            company_name:'',
            company_logo:'',
            industry_sector:'',
        ...
        columns: [
            ...
            { label: 'lease_holder Name', field: 'lease_holder_name' },
            { label: 'Company Name', field: 'company_name' },
            { label: 'Email', field: 'lease_holder_email' },
            { label: 'Mobile No', field: 'lease_holder_cell_phone' },
            { label: 'Country', field: 'lease_holder_country' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderLeaseholder/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderLeaseholderLists';
    ...
    fetchAccountHolder()
    {
        let uri = '/AccountHolderLeaseholder';
        window.axios.get(uri).then((response) => {
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderLeaseholder/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderLeaseholder') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderLeaseholder/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderLeaseholder/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.lease_holder_name=response.data.account_holder.lease_holder_name;
                    this.form.lease_holder_photo=response.data.account_holder.lease_holder_photo;


                    this.form.lease_holder_office_phone=response.data.account_holder.lease_holder_office_phone;
                    this.form.lease_holder_cell_phone=response.data.account_holder.lease_holder_cell_phone;
                    this.form.lease_holder_state=response.data.account_holder.lease_holder_state;
                    this.form.lease_holder_email=response.data.account_holder.lease_holder_email;
                    this.form.lease_holder_fax_no=response.data.account_holder.lease_holder_fax_no;
                    this.form.lease_holder_website=response.data.account_holder.lease_holder_website;

                   

                    this.form.lease_holder_house_number=response.data.account_holder.lease_holder_house_number;
                    this.form.lease_holder_street_number=response.data.account_holder.lease_holder_street_number;
                    this.form.lease_holder_city=response.data.account_holder.lease_holder_city;
                    this.form.lease_holder_state=response.data.account_holder.lease_holder_state;
                    this.form.lease_holder_country=response.data.account_holder.lease_holder_country;
                    this.form.lease_holder_zip_code=response.data.account_holder.lease_holder_zip_code;
