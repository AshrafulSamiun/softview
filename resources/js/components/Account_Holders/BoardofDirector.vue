    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Board of Director Profile</h1> 
                            ...
                            <template slot-scope="{row}">
                                <tr>
                                    <td>{{ row.sl }}</td>
                                            ...
                                            <td>{{ row.board_of_director_name }}</td>
                                            <td>{{ row.board_of_director_position }}</td> 
                                            <td>{{ row.email }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Board of Director Profile  Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <input 
                                                v-model="form.board_of_director_name_title" 
                                                type="text" 
                                                name="board_of_director_name_title" 
                                                placeholder="Type Title" 
                                                :class="{ 'is-invalid': form.errors.has('board_of_director_name_title') }"/>
                                            <has-error :form="form" field="board_of_director_name_title"></has-error>
                                                
                                            <label class="fieldlabels">Board of Director Name:</label>
                                            <input 
                                                v-model="form.board_of_director_name" 
                                                type="text" 
                                                name="board_of_director_name" 
                                                placeholder="Type Board of Director Name" 
                                                :class="{ 'is-invalid': form.errors.has('board_of_director_name') }"/>
                                            <has-error :form="form" field="board_of_director_name"></has-error> 

                                            <label class="fieldlabels">Photo:</label>
                                            <input 
                                                v-model="form.board_of_director_photo" 
                                                type="text" 
                                                name="board_of_director_photo" 
                                                placeholder="Type  Photo" 
                                                :class="{ 'is-invalid': form.errors.has('board_of_director_photo') }"/>
                                            <has-error :form="form" field="board_of_director_photo"></has-error> 
                                            ...
                                            <input v-model="form.board_of_director_position" 
                                              ...
                                              <has-error :form="form" field="board_of_director_position"></has-error> 

                                              <label class="fieldlabels">Education:</label> 
                                                        <div class="position-relative form-group">
                                                            <select v-model="form.board_of_director_education"
                                                                name="board_of_director_education"
                                                                class="custom-select" 
                                                                :class="{ 'is-invalid': form.errors.has('board_of_director_education') }">
                                                                ...
                                                                <option value="7">No board_of_director_education </option> 
                                                            </select>
    ...
    return{
        ...
        form:new Form({
            system_no:'',
                    ...
                    board_of_director_name_title:'',
                    board_of_director_photo:'',
                    board_of_director_education:'',
        ...
        columns: [
                ...
                { label: 'Board of Director Name', field: 'board_of_director_name' },
                { label: 'Position', field: 'board_of_director_position' }, 
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderBoardOfDirector/' + this.recordId, this.form)
        .then(response => {
    ...
    editAccountHolder(id)
    {
        ...
        window.axios.get(uri).then((response) => {
            ...
            this.form.id=response.data.account_holder.id;
                    ...
                    this.form.board_of_director_name_title=response.data.account_holder.board_of_director_name_title; 
                     this.form.board_of_director_photo=response.data.account_holder.board_of_director_photo; 
                     this.form.board_of_director_education=response.data.account_holder.board_of_director_education; 
