    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Service Provider Profile</h1> 
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>  
                                    ...
                                    <td>{{ row.service_provider_cell_phone }}</td>
                                    <td>{{ row.service_provider_country }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Service Provider Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Service Provider Name:</label>
                                            <input 
                                                v-model="form.service_provider_name" 
                                                type="text" 
                                                name="service_provider_name" 
                                                placeholder="Type Service Provider Name" 
                                                :class="{ 'is-invalid': form.errors.has('service_provider_name') }"/>
                                            <has-error :form="form" field="service_provider_name"></has-error> 
                                            <label class="fieldlabels">Service Provider  Photo:</label> 
                                            <input 
                                                v-model="form.service_provider_photo" 
                                                type="text" 
                                                name="service_provider_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('service_provider_photo') }"/>
                                            <has-error :form="form" field="service_provider_photo"></has-error> 
                                           
                                                        <h4>Service Provider Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.service_provider_office_phone" 
                                                                type="text" 
                                                                name="service_provider_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_office_phone') }"/>
                                                                 <has-error :form="form" field="service_provider_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.service_provider_cell_phone" 
                                                                type="text" 
                                                                name="service_provider_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_cell_phone') }"/>
                                                                 <has-error :form="form" field="service_provider_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.service_provider_email" 
                                                                type="service_provider_email" 
                                                                name="service_provider_email" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_email') }"/>
                                                                 <has-error :form="form" field="service_provider_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.service_provider_fax_no" 
                                                                type="text" 
                                                                name="service_provider_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_fax_no') }"/>
                                                                 <has-error :form="form" field="service_provider_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.service_provider_website" 
                                                                type="url" 
                                                                name="service_provider_website" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_website') }"/>
                                                                 <has-error :form="form" field="service_provider_website"></has-error>
                                             


                                                        <h4>Service Provider Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.service_provider_house_number" 
                                                                type="phone" 
                                                                name="service_provider_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_house_number') }"/>
                                                                 <has-error :form="form" field="service_provider_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.service_provider_street_number" 
                                                                type="text" 
                                                                name="service_provider_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_street_number') }"/>
                                                                 <has-error :form="form" field="service_provider_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.service_provider_city" 
                                                                type="text" 
                                                                name="service_provider_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_city') }"/>
                                                                 <has-error :form="form" field="service_provider_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.service_provider_state" 
                                                                type="text" 
                                                                name="service_provider_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_state') }"/>
                                                                 <has-error :form="form" field="service_provider_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.service_provider_country"
                                                                    name="service_provider_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('service_provider_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.service_provider_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('service_provider_zip_code') }"/>
                                                                 <has-error :form="form" field="service_provider_zip_code"></has-error> 
                            ...
                            <div class="form-folder">
                                    <h3><i class="fa fa-hand-point-right"></i>Profile Association Membership:
                                        ...
                                        <div class="row align-self-stretch">  
                                            <div class="col-md-4 col-sm-4 col-xs-12">
                                                <div class="form-box-outer">  
                                                    <div class="form-holder">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Association name:</label> 
                                                            <input v-model="form.professional_license_associate_name" 
                                                               type="text" 
                                                               name="professional_license_associate_name" 
                                                               placeholder="Type Association Name"
                                                               :class="{ 'is-invalid': form.errors.has('professional_license_associate_name') }"/>
                                                            <has-error :form="form" field="professional_license_associate_name"></has-error> 
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Licence No. :</label> 
                                                            <input v-model="form.professional_license_no" 
                                                                type="text" 
                                                                placeholder="TypeLicence No"
                                                                name="professional_license_no" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_no') }"/>
                                                                <has-error :form="form" field="professional_license_no"></has-error>
                                                        </div> 
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Licence Title :</label> 
                                                            <input v-model="form.professional_license_title" 
                                                                type="text" 
                                                                placeholder="TypeLicence Title"
                                                                name="professional_license_title" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_title') }"/>
                                                                <has-error :form="form" field="professional_license_title"></has-error>
                                                        </div> 
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">License renewal date :</label> 
                                                            <date-picker 
                                                                 style="width:100%"
                                                                v-model="form.professional_license_renewal_date"
                                                                name="professional_license_renewal_date"
                                                                lang="en"
                                                                type="professional_license_renewal_date"
                                                                format="DD MMM, YYYY"
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_renewal_date') }">
                                                            </date-picker>
                                                            <has-error :form="form" field="professional_license_renewal_date"></has-error> 
                                                        </div> 
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <date-picker 
                                                                ...
                                                                name="professional_license_expire_date"
                                                                lang="en"
                                                                type="professional_license_expire_date"
                                                                format="DD MMM, YYYY"
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_expire_date') }">
                                                            </date-picker>
                                                            <has-error :form="form" field="professional_license_expire_date"></has-error> 
                                                        </div> 
                                                         <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels" >Validation Status:</label>       
                                                            <div class="position-relative form-group">
                                                                <select v-model="form.professional_license_validation_status"
                                                                    name="professional_license_validation_status"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('professional_license_validation_status') }">
                                                                    <option disabled value="">--Select-- </option>
                                                    ...
                                                    <div class="row"> 
                                                        <h4>Address</h4>
                                                         <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <input v-model="form.professional_license_house_number" 
                                                                type="phone" 
                                                                name="professional_license_house_number" 
                                                                placeholder="Type House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_house_number') }"/>
                                                                 <has-error :form="form" field="professional_license_house_number"></has-error> 
                                                        </div>
                                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                                            <label class="fieldlabels">Street Number:</label> 
                                                            <input v-model="form.professional_license_street_number" 
                                                                type="text" 
                                                                name="professional_license_street_number" 
                                                                placeholder="Type Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_street_number') }"/>
                                                                 <has-error :form="form" field="professional_license_street_number"></has-error> 
                                                        </div>
                                                        
                                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                                            <label class="fieldlabels">City:</label> 
                                                            <input v-model="form.professional_license_city" 
                                                                type="text" 
                                                                name="professional_license_city" 
                                                                placeholder="Type City" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_city') }"/>
                                                                 <has-error :form="form" field="professional_license_city"></has-error> 
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">State:</label> 
                                                            <input v-model="form.professional_license_state" 
                                                                type="text" 
                                                                name="professional_license_state" 
                                                                placeholder="Type State" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_state') }"/>
                                                                 <has-error :form="form" field="professional_license_state"></has-error>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.professional_license_country"
                                                                    name="professional_license_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('professional_license_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                                    <option v-for="(country,index) in countries" :value="index">{{country}}</option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Zip Code/ Postal Code:</label> 
                                                            <input v-model="form.professional_license_zip_code" 
                                                                type="phone" 
                                                                name="professional_license_zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_zip_code') }"/>
                                                                 <has-error :form="form" field="professional_license_zip_code"></has-error> 
                                                        </div>  
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                <div class="form-box-outer">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.professional_license_email" 
                                                                type="email" 
                                                                name="professional_license_email" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_email') }"/>
                                                                 <has-error :form="form" field="professional_license_email"></has-error>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.professional_license_fax_no" 
                                                                type="text" 
                                                                name="professional_license_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_fax_no') }"/>
                                                                 <has-error :form="form" field="professional_license_fax_no"></has-error> 
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.professional_license_cell_phone" 
                                                                type="text" 
                                                                name="professional_license_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_cell_phone') }"/>
                                                                 <has-error :form="form" field="professional_license_cell_phone"></has-error>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.professional_office_phone" 
                                                                type="text" 
                                                                name="professional_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_office_phone') }"/>
                                                                 <has-error :form="form" field="professional_office_phone"></has-error>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.professional_license_website" 
                                                                type="url" 
                                                                name="professional_license_website" 
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_website') }"/>
                                                                 <has-error :form="form" field="professional_license_website"></has-error>
                                                        </div>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <input 
                                                                ...
                                                                :class="{ 'is-invalid': form.errors.has('emergency_photo') }"/>
                                                                 <has-error :form="form" field="emergency_photo"></has-error> 
                                                        </div> 
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
...
data(){
    return{
        ...
        form:new Form({
            ...
            service_provider_office_phone:'',
            service_provider_cell_phone:'',
            service_provider_email:'',
            service_provider_fax_no:'',
            service_provider_website:'', 
            service_provider_house_number:'',
            service_provider_street_number:'',
            service_provider_city:'',
            service_provider_state:'',
            service_provider_country:'',
            service_provider_zip_code:'',
            company_name:'',
            company_logo:'',
            industry_sector:'',
            ...
            professional_license_title:'',
            professional_license_no:'', 
            professional_license_expire_date:'',
            professional_license_renewal_date:'', 
        ...
        columns: [
            ...
            { label: 'service_provider Name', field: 'service_provider_name' },
            { label: 'Company Name', field: 'company_name' },
            { label: 'Email', field: 'service_provider_email' },
            { label: 'Mobile No', field: 'service_provider_cell_phone' },
            { label: 'Country', field: 'service_provider_country' },
...
methods: {
    submitForm() 
    {
        axios.put('/AccountHolderServiceProvider/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderServiceProviderLists';
    ...
    fetchAccountHolder()
    {
        let uri = '/AccountHolderServiceProvider';
        window.axios.get(uri).then((response) => {
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderServiceProvider/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderServiceProvider') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderServiceProvider/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderServiceProvider/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.service_provider_name=response.data.account_holder.service_provider_name;
                    this.form.service_provider_photo=response.data.account_holder.service_provider_photo;


                    this.form.service_provider_office_phone=response.data.account_holder.service_provider_office_phone;
                    this.form.service_provider_cell_phone=response.data.account_holder.service_provider_cell_phone;
                    this.form.service_provider_state=response.data.account_holder.service_provider_state;
                    this.form.service_provider_email=response.data.account_holder.service_provider_email;
                    this.form.service_provider_fax_no=response.data.account_holder.service_provider_fax_no;
                    this.form.service_provider_website=response.data.account_holder.service_provider_website;

                   

                    this.form.service_provider_house_number=response.data.account_holder.service_provider_house_number;
                    this.form.service_provider_street_number=response.data.account_holder.service_provider_street_number;
                    this.form.service_provider_city=response.data.account_holder.service_provider_city;
                    this.form.service_provider_state=response.data.account_holder.service_provider_state;
                    this.form.service_provider_country=response.data.account_holder.service_provider_country;
                    this.form.service_provider_zip_code=response.data.account_holder.service_provider_zip_code;
                    ...
                    this.form.professional_license_title=response.data.account_holder.professional_license_title;
                    ...
                    this.form.professional_license_renewal_date=response.data.account_holder.professional_license_renewal_date;  
                    ...
                    this.form.professional_office_phone=response.data.account_holder.professional_office_phone;
                    ...
                    this.form.service_type=response.data.account_holder.service_type; 
