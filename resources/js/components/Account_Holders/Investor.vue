    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Investor Profile</h1> 
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>  
                                    ...
                                    <td>{{ row.investor_email }}</td>
                                    <td>{{ row.investor_cell_phone }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Investor Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Investor Name:</label>
                                            <input 
                                                v-model="form.investor_name" 
                                                type="text" 
                                                name="investor_name" 
                                                placeholder="Type Investor Name" 
                                                :class="{ 'is-invalid': form.errors.has('investor_name') }"/>
                                            <has-error :form="form" field="investor_name"></has-error> 
                                            <label class="fieldlabels">Investor  Photo:</label> 
                                            <input 
                                                v-model="form.investor_photo" 
                                                type="text" 
                                                name="investor_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('investor_photo') }"/>
                                            <has-error :form="form" field="investor_photo"></has-error> 
                                           
                                                        <h4>Investor Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.investor_office_phone" 
                                                                type="text" 
                                                                name="investor_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_office_phone') }"/>
                                                                 <has-error :form="form" field="investor_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.investor_cell_phone" 
                                                                type="text" 
                                                                name="investor_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_cell_phone') }"/>
                                                                 <has-error :form="form" field="investor_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.investor_email" 
                                                                type="investor_email" 
                                                                name="investor_email" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_email') }"/>
                                                                 <has-error :form="form" field="investor_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.investor_fax_no" 
                                                                type="text" 
                                                                name="investor_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_fax_no') }"/>
                                                                 <has-error :form="form" field="investor_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.investor_website" 
                                                                type="url" 
                                                                name="investor_website" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_website') }"/>
                                                                 <has-error :form="form" field="investor_website"></has-error>
                                             


                                                        <h4>Investor Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.investor_house_number" 
                                                                type="phone" 
                                                                name="investor_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_house_number') }"/>
                                                                 <has-error :form="form" field="investor_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.investor_street_number" 
                                                                type="text" 
                                                                name="investor_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_street_number') }"/>
                                                                 <has-error :form="form" field="investor_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.investor_city" 
                                                                type="text" 
                                                                name="investor_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_city') }"/>
                                                                 <has-error :form="form" field="investor_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.investor_state" 
                                                                type="text" 
                                                                name="investor_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_state') }"/>
                                                                 <has-error :form="form" field="investor_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.investor_country"
                                                                    name="investor_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('investor_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.investor_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('investor_zip_code') }"/>
                                                                 <has-error :form="form" field="investor_zip_code"></has-error> 
...
data(){
    return{
        ...
        form:new Form({
            ...
            investor_name:'',
            investor_photo:'', 
            investor_office_phone:'',
            investor_cell_phone:'',
            investor_email:'',
            investor_fax_no:'',
            investor_website:'', 
            investor_house_number:'',
            investor_street_number:'',
            investor_city:'',
            investor_state:'',
            investor_country:'',
            investor_zip_code:'',
        ...
        columns: [
            ...
            { label: 'Email', field: 'investor_email' },
            { label: 'Mobile No', field: 'investor_cell_phone' },
            { label: 'Country', field: 'investor_country' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderInvestor/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderInvestorLists';
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderInvestor/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderInvestor') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderInvestor/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderInvestor/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.investor_name=response.data.account_holder.investor_name;
                    this.form.investor_photo=response.data.account_holder.investor_photo;


                    this.form.investor_office_phone=response.data.account_holder.investor_office_phone;
                    this.form.investor_cell_phone=response.data.account_holder.investor_cell_phone;
                    this.form.investor_state=response.data.account_holder.investor_state;
                    this.form.investor_email=response.data.account_holder.investor_email;
                    this.form.investor_fax_no=response.data.account_holder.investor_fax_no;
                    this.form.investor_website=response.data.account_holder.investor_website;

                   

                    this.form.investor_house_number=response.data.account_holder.investor_house_number;
                    this.form.investor_street_number=response.data.account_holder.investor_street_number;
                    this.form.investor_city=response.data.account_holder.investor_city;
                    this.form.investor_state=response.data.account_holder.investor_state;
                    this.form.investor_country=response.data.account_holder.investor_country;
                    this.form.investor_zip_code=response.data.account_holder.investor_zip_code;
