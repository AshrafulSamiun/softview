    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Credit Card Company Profile</h1> 
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">  
                            <template slot-scope="{row}">
                                <tr>
                                    ...
                                    <td>{{ row.credit_card_company_name }}</td>
                                    <td>{{ row.card_type }}</td>
                                    <td>{{ row.email }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Credit Card Company Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <label class="fieldlabels">Credit Card Company Name:</label>
                                            <input 
                                                v-model="form.credit_card_company_name" 
                                                type="text" 
                                                name="credit_card_company_name" 
                                                placeholder="Type Company Name" 
                                                :class="{ 'is-invalid': form.errors.has('credit_card_company_name') }"/>
                                            <has-error :form="form" field="credit_card_company_name"></has-error> 
                                            <label class="fieldlabels">Card Type:</label> 
                                            <div class="position-relative form-group">
                                                 <select v-model="form.card_type"
                                                    name="card_type" 
                                                    class="custom-select" 
                                                    :class="{ 'is-invalid': form.errors.has('card_type') }">
                                                    <option disabled value="">--Select-- </option>
                                                    <option v-for="(card_type, index) in payment_name" :value="index">{{card_type}}</option> 
                                                </select>
                                            </div> 
                                            
                                            <label class="fieldlabels" >Account Alerts:</label>  
                                            <input v-model="form.account_alert" 
                                                type="text" 
                                                placeholder="Type Account Alerts"
                                                name="account_alert" 
                                                :class="{ 'is-invalid': form.errors.has('account_alert') }"/>
                                              <has-error :form="form" field="account_alert"></has-error>


                                              <label class="fieldlabels" >Payment Due Reminder:</label>  
                                            <input v-model="form.payment_due_remainders" 
                                                type="text" 
                                                placeholder="Type Payment Due Reminder"
                                                name="payment_due_remainders" 
                                                :class="{ 'is-invalid': form.errors.has('payment_due_remainders') }"/>
                                              <has-error :form="form" field="payment_due_remainders"></has-error> 
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <input v-model="form.email" 
                                                                ...
                                                                :class="{ 'is-invalid': form.errors.has('email') }"/>
                                                                 ...
                                                                 <span v-if="form.errors.has('email')" class="text-danger">
...
data(){
    return{
        ...
        columns: [
            ...
            { label: 'Company Name', field: 'credit_card_company_name' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderCreditCardCompany/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderCreditCardCompanyLists';
    ...
    fetchAccountHolder()
    {
        let uri = '/AccountHolderCreditCardCompany';
        window.axios.get(uri).then((response) => {
    ...
    updateAccountHolder()
    {
               ...
               this.form.put('/AccountHolderCreditCardCompany/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderCreditCardCompany') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderCreditCardCompany/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderCreditCardCompany/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.credit_card_company_name=response.data.account_holder.credit_card_company_name;
                    this.form.account_alert=response.data.account_holder.account_alert;
                    this.form.card_type=response.data.account_holder.card_type;
                    this.form.payment_due_remainders=response.data.account_holder.payment_due_remainders;
