    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Donor Profile</h1> 
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Donor Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Donor Name:</label>
                                            <input 
                                                v-model="form.donor_name" 
                                                type="text" 
                                                name="donor_name" 
                                                placeholder="Type Donor Name" 
                                                :class="{ 'is-invalid': form.errors.has('donor_name') }"/>
                                            <has-error :form="form" field="donor_name"></has-error> 
                                            <label class="fieldlabels">Donor  Photo:</label> 
                                            <input 
                                                v-model="form.donor_photo" 
                                                type="text" 
                                                name="donor_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('donor_photo') }"/>
                                            <has-error :form="form" field="donor_photo"></has-error> 
                                           
                                                        <h4>Donor Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.donor_office_phone" 
                                                                type="text" 
                                                                name="donor_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_office_phone') }"/>
                                                                 <has-error :form="form" field="donor_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.donor_cell_phone" 
                                                                type="text" 
                                                                name="donor_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_cell_phone') }"/>
                                                                 <has-error :form="form" field="donor_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.donor_email" 
                                                                type="donor_email" 
                                                                name="donor_email" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_email') }"/>
                                                                 <has-error :form="form" field="donor_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.donor_fax_no" 
                                                                type="text" 
                                                                name="donor_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_fax_no') }"/>
                                                                 <has-error :form="form" field="donor_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.donor_website" 
                                                                type="url" 
                                                                name="donor_website" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_website') }"/>
                                                                 <has-error :form="form" field="donor_website"></has-error>
                                             


                                                        <h4>Donor Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.donor_house_number" 
                                                                type="phone" 
                                                                name="donor_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_house_number') }"/>
                                                                 <has-error :form="form" field="donor_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.donor_street_number" 
                                                                type="text" 
                                                                name="donor_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_street_number') }"/>
                                                                 <has-error :form="form" field="donor_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.donor_city" 
                                                                type="text" 
                                                                name="donor_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_city') }"/>
                                                                 <has-error :form="form" field="donor_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.donor_state" 
                                                                type="text" 
                                                                name="donor_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_state') }"/>
                                                                 <has-error :form="form" field="donor_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels"> Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.donor_country"
                                                                    name="donor_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('donor_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.donor_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('donor_zip_code') }"/>
                                                                 <has-error :form="form" field="donor_zip_code"></has-error> 
...
data(){
    return{
        ...
        columns: [
            ...
            { label: 'Email', field: 'donor_email' },
            { label: 'Mobile No', field: 'donor_cell_phone' },
            { label: 'Country', field: 'donor_country' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderDonor/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderDonorLists';
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderDonor/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderDonor') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderDonor/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderDonor/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.donor_name=response.data.account_holder.donor_name;
                    this.form.donor_photo=response.data.account_holder.donor_photo;


                    this.form.donor_office_phone=response.data.account_holder.donor_office_phone;
                    this.form.donor_cell_phone=response.data.account_holder.donor_cell_phone;
                    this.form.donor_state=response.data.account_holder.donor_state;
                    this.form.donor_email=response.data.account_holder.donor_email;
                    this.form.donor_fax_no=response.data.account_holder.donor_fax_no;
                    this.form.donor_website=response.data.account_holder.donor_website;

                   

                    this.form.donor_house_number=response.data.account_holder.donor_house_number;
                    this.form.donor_street_number=response.data.account_holder.donor_street_number;
                    this.form.donor_city=response.data.account_holder.donor_city;
                    this.form.donor_state=response.data.account_holder.donor_state;
                    this.form.donor_country=response.data.account_holder.donor_country;
                    this.form.donor_zip_code=response.data.account_holder.donor_zip_code;
