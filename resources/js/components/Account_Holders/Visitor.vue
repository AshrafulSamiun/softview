    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Visitor Profile</h1> 
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Visitor Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Visitor  Name:</label>
                                            <input 
                                                v-model="form.visitor_name" 
                                                type="text" 
                                                name="visitor_name" 
                                                placeholder="Type visitor Name" 
                                                :class="{ 'is-invalid': form.errors.has('visitor_name') }"/>
                                            <has-error :form="form" field="visitor_name"></has-error> 
                                            <label class="fieldlabels">Visitor  Photo:</label> 
                                            <input 
                                                v-model="form.visitor_photo" 
                                                type="text" 
                                                name="visitor_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('visitor_photo') }"/>
                                            <has-error :form="form" field="visitor_photo"></has-error> 
                                           
                                                        <h4>Visitor Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.visitor_office_phone" 
                                                                type="text" 
                                                                name="visitor_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_office_phone') }"/>
                                                                 <has-error :form="form" field="visitor_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.visitor_cell_phone" 
                                                                type="text" 
                                                                name="visitor_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_cell_phone') }"/>
                                                                 <has-error :form="form" field="visitor_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.visitor_email" 
                                                                type="visitor_email" 
                                                                name="visitor_email" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_email') }"/>
                                                                 <has-error :form="form" field="visitor_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.visitor_fax_no" 
                                                                type="text" 
                                                                name="visitor_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_fax_no') }"/>
                                                                 <has-error :form="form" field="visitor_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.visitor_website" 
                                                                type="url" 
                                                                name="visitor_website" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_website') }"/>
                                                                 <has-error :form="form" field="visitor_website"></has-error>
                                             


                                                        <h4>Visitor Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.visitor_house_number" 
                                                                type="phone" 
                                                                name="visitor_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_house_number') }"/>
                                                                 <has-error :form="form" field="visitor_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.visitor_street_number" 
                                                                type="text" 
                                                                name="visitor_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_street_number') }"/>
                                                                 <has-error :form="form" field="visitor_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.visitor_city" 
                                                                type="text" 
                                                                name="visitor_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_city') }"/>
                                                                 <has-error :form="form" field="visitor_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.visitor_state" 
                                                                type="text" 
                                                                name="visitor_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_state') }"/>
                                                                 <has-error :form="form" field="visitor_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.visitor_country"
                                                                    name="visitor_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('visitor_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.visitor_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('visitor_zip_code') }"/>
                                                                 <has-error :form="form" field="visitor_zip_code"></has-error> 
...
data(){
    return{
        ...
        form:new Form({
            ...
            visitor_name:'',
            visitor_photo:'', 
            visitor_office_phone:'',
            visitor_cell_phone:'',
            visitor_email:'',
            visitor_fax_no:'',
            visitor_website:'', 
            visitor_house_number:'',
            visitor_street_number:'',
            visitor_city:'',
            visitor_state:'',
            visitor_country:'',
            visitor_zip_code:'',
        ...
        columns: [
            ...
            { label: 'Visitor Name', field: 'visitor_name' },
            { label: 'Company Name', field: 'company_name' },
            { label: 'Email', field: 'visitor_email' },
            { label: 'Mobile No', field: 'visitor_cell_phone' },
            { label: 'Country', field: 'visitor_country' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderVisitor/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderVisitorLists';
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderVisitor/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderVisitor') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderVisitor/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderVisitor/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.visitor_name=response.data.account_holder.visitor_name;
                    this.form.visitor_photo=response.data.account_holder.visitor_photo;


                    this.form.visitor_office_phone=response.data.account_holder.visitor_office_phone;
                    this.form.visitor_cell_phone=response.data.account_holder.visitor_cell_phone;
                    this.form.visitor_state=response.data.account_holder.visitor_state;
                    this.form.visitor_email=response.data.account_holder.visitor_email;
                    this.form.visitor_fax_no=response.data.account_holder.visitor_fax_no;
                    this.form.visitor_website=response.data.account_holder.visitor_website;

                   

                    this.form.visitor_house_number=response.data.account_holder.visitor_house_number;
                    this.form.visitor_street_number=response.data.account_holder.visitor_street_number;
                    this.form.visitor_city=response.data.account_holder.visitor_city;
                    this.form.visitor_state=response.data.account_holder.visitor_state;
                    this.form.visitor_country=response.data.account_holder.visitor_country;
                    this.form.visitor_zip_code=response.data.account_holder.visitor_zip_code;
