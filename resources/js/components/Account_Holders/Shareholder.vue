    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Shareholder Profile</h1> 
                            ...
                            <template slot-scope="{row}">
                                <tr>
                                    <td>{{ row.sl }}</td>
                                            ...
                                            <td>{{ row.share_holder_name }}</td>
                                            <td>{{ row.share_holder_position }}</td> 
                                            <td>{{ row.email }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Shareholder Profile  Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <label class="fieldlabels">Shareholder Name:</label>
                                            <input 
                                                v-model="form.share_holder_name" 
                                                type="text" 
                                                name="share_holder_name" 
                                                placeholder="Type Shareholder Name" 
                                                :class="{ 'is-invalid': form.errors.has('share_holder_name') }"/>
                                            <has-error :form="form" field="share_holder_name"></has-error> 

                                            <label class="fieldlabels" >Position:</label>  
                                            <input v-model="form.share_holder_position" 
                                                type="text" 
                                                placeholder="Type Position"
                                                name="share_holder_position" 
                                                :class="{ 'is-invalid': form.errors.has('share_holder_position') }"/>
                                              <has-error :form="form" field="share_holder_position"></has-error> 
...
data(){
    return{
        ...
        columns: [
                ...
                { label: 'Board of Director Name', field: 'share_holder_name' },
                { label: 'Position', field: 'share_holder_position' }, 
...
methods: {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderShareholderLists';
    ...
    fetchAccountHolder()
    {
        let uri = '/AccountHolderShareholder';
        window.axios.get(uri).then((response) => {
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderShareholder/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderShareholder') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderShareholder/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderShareholder/'+id+'/edit';
        window.axios.get(uri).then((response) => {
            ...
            this.form.id=response.data.account_holder.id;
                    ...
                    this.form.share_holder_name=response.data.account_holder.share_holder_name;
                    this.form.share_holder_position=response.data.account_holder.share_holder_position;
