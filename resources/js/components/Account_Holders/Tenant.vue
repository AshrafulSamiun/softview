    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Tenant Profile</h1> 
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Tenant Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form"  
                                            <label class="fieldlabels">Tenant Name:</label>
                                            <input 
                                                v-model="form.tenant_name" 
                                                type="text" 
                                                name="tenant_name" 
                                                placeholder="Type tenant Name" 
                                                :class="{ 'is-invalid': form.errors.has('tenant_name') }"/>
                                            <has-error :form="form" field="tenant_name"></has-error> 
                                            <label class="fieldlabels">Tenant  Photo:</label> 
                                            <input 
                                                v-model="form.tenant_photo" 
                                                type="text" 
                                                name="tenant_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('tenant_photo') }"/>
                                            <has-error :form="form" field="tenant_photo"></has-error> 
                                           
                                                        <h4>Tenant Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.tenant_office_phone" 
                                                                type="text" 
                                                                name="tenant_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_office_phone') }"/>
                                                                 <has-error :form="form" field="tenant_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.tenant_cell_phone" 
                                                                type="text" 
                                                                name="tenant_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_cell_phone') }"/>
                                                                 <has-error :form="form" field="tenant_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.tenant_email" 
                                                                type="tenant_email" 
                                                                name="tenant_email" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_email') }"/>
                                                                 <has-error :form="form" field="tenant_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.tenant_fax_no" 
                                                                type="text" 
                                                                name="tenant_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_fax_no') }"/>
                                                                 <has-error :form="form" field="tenant_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.tenant_website" 
                                                                type="url" 
                                                                name="tenant_website" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_website') }"/>
                                                                 <has-error :form="form" field="tenant_website"></has-error>
                                             


                                                        <h4>Tenant Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.tenant_house_number" 
                                                                type="phone" 
                                                                name="tenant_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_house_number') }"/>
                                                                 <has-error :form="form" field="tenant_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.tenant_street_number" 
                                                                type="text" 
                                                                name="tenant_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_street_number') }"/>
                                                                 <has-error :form="form" field="tenant_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.tenant_city" 
                                                                type="text" 
                                                                name="tenant_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_city') }"/>
                                                                 <has-error :form="form" field="tenant_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.tenant_state" 
                                                                type="text" 
                                                                name="tenant_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_state') }"/>
                                                                 <has-error :form="form" field="tenant_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.tenant_country"
                                                                    name="tenant_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('tenant_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.tenant_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('tenant_zip_code') }"/>
                                                                 <has-error :form="form" field="tenant_zip_code"></has-error> 
...
data(){
    return{
        ...
        columns: [
            ...
            { label: 'Tenant Name', field: 'tenant_name' },
            { label: 'Company Name', field: 'company_name' },
            { label: 'Email', field: 'tenant_email' },
            { label: 'Mobile No', field: 'tenant_cell_phone' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderTenant/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderTenantLists';
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderTenant/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderTenant') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderTenant/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderTenant/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.tenant_name=response.data.account_holder.tenant_name;
                    this.form.tenant_photo=response.data.account_holder.tenant_photo;


                    this.form.tenant_office_phone=response.data.account_holder.tenant_office_phone;
                    this.form.tenant_cell_phone=response.data.account_holder.tenant_cell_phone;
                    this.form.tenant_state=response.data.account_holder.tenant_state;
                    this.form.tenant_email=response.data.account_holder.tenant_email;
                    this.form.tenant_fax_no=response.data.account_holder.tenant_fax_no;
                    this.form.tenant_website=response.data.account_holder.tenant_website;

                   

                    this.form.tenant_house_number=response.data.account_holder.tenant_house_number;
                    this.form.tenant_street_number=response.data.account_holder.tenant_street_number;
                    this.form.tenant_city=response.data.account_holder.tenant_city;
                    this.form.tenant_state=response.data.account_holder.tenant_state;
                    this.form.tenant_country=response.data.account_holder.tenant_country;
                    this.form.tenant_zip_code=response.data.account_holder.tenant_zip_code;
