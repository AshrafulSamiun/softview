    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Volunteer Profile</h1> 
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>  
                                    ...
                                    <td>{{ row.volunteer_cell_phone }}</td>
                                    <td>{{ row.volunteer_country }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Volunteer Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Volunteer  Name:</label>
                                            <input 
                                                v-model="form.volunteer_name" 
                                                type="text" 
                                                name="volunteer_name" 
                                                placeholder="Type volunteer Name" 
                                                :class="{ 'is-invalid': form.errors.has('volunteer_name') }"/>
                                            <has-error :form="form" field="volunteer_name"></has-error> 
                                            <label class="fieldlabels">Volunteer  Photo:</label> 
                                            <input 
                                                v-model="form.volunteer_photo" 
                                                type="text" 
                                                name="volunteer_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('volunteer_photo') }"/>
                                            <has-error :form="form" field="volunteer_photo"></has-error> 
                                           
                                                        <h4>Volunteer Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.volunteer_office_phone" 
                                                                type="text" 
                                                                name="volunteer_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_office_phone') }"/>
                                                                 <has-error :form="form" field="volunteer_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.volunteer_cell_phone" 
                                                                type="text" 
                                                                name="volunteer_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_cell_phone') }"/>
                                                                 <has-error :form="form" field="volunteer_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.volunteer_email" 
                                                                type="volunteer_email" 
                                                                name="volunteer_email" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_email') }"/>
                                                                 <has-error :form="form" field="volunteer_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.volunteer_fax_no" 
                                                                type="text" 
                                                                name="volunteer_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_fax_no') }"/>
                                                                 <has-error :form="form" field="volunteer_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.volunteer_website" 
                                                                type="url" 
                                                                name="volunteer_website" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_website') }"/>
                                                                 <has-error :form="form" field="volunteer_website"></has-error>
                                             


                                                        <h4>Volunteer Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.volunteer_house_number" 
                                                                type="phone" 
                                                                name="volunteer_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_house_number') }"/>
                                                                 <has-error :form="form" field="volunteer_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.volunteer_street_number" 
                                                                type="text" 
                                                                name="volunteer_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_street_number') }"/>
                                                                 <has-error :form="form" field="volunteer_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.volunteer_city" 
                                                                type="text" 
                                                                name="volunteer_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_city') }"/>
                                                                 <has-error :form="form" field="volunteer_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.volunteer_state" 
                                                                type="text" 
                                                                name="volunteer_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_state') }"/>
                                                                 <has-error :form="form" field="volunteer_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.volunteer_country"
                                                                    name="volunteer_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('volunteer_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.volunteer_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('volunteer_zip_code') }"/>
                                                                 <has-error :form="form" field="volunteer_zip_code"></has-error> 
                                    ...
                                    <div class="col-md-4 col-sm-6 col-xs-12">
                                        <div class="form-box-outer">  
                                            <div class="row"> 
                                                ...
                                                <div class="col-md-12 col-sm-6 col-xs-12">
                                                    <label class="fieldlabels">Weekly Hours:</label> 
                                                    <input v-model="form.weekly_hours" 
                                                        type="number" 
                                                        name="weekly_hours" 
                                                        placeholder="Type Weekly Hours" 
                                                        :class="{ 'is-invalid': form.errors.has('weekly_hours') }"/>
                                                         <has-error :form="form" field="weekly_hours"></has-error> 
                                                </div> 
...
data(){
    return{
        ...
        form:new Form({
            ...
            volunteer_name:'',
            volunteer_photo:'', 
            volunteer_office_phone:'',
            volunteer_cell_phone:'',
            volunteer_email:'',
            volunteer_fax_no:'',
            volunteer_website:'', 
            volunteer_house_number:'',
            volunteer_street_number:'',
            volunteer_city:'',
            volunteer_state:'',
            volunteer_country:'',
            volunteer_zip_code:'',
        ...
        columns: [
            ...
            { label: 'Volunteer Name', field: 'volunteer_name' },
            { label: 'Company Name', field: 'company_name' },
            { label: 'Email', field: 'volunteer_email' },
            { label: 'Mobile No', field: 'volunteer_cell_phone' },
            { label: 'Country', field: 'volunteer_country' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderVolunteer/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderVolunteerLists';
    ...
    fetchAccountHolder()
    {
        let uri = '/AccountHolderVolunteer';
        window.axios.get(uri).then((response) => {
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderVolunteer/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderVolunteer') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHolderVolunteer/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderVolunteer/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.volunteer_name=response.data.account_holder.volunteer_name;
                    this.form.volunteer_photo=response.data.account_holder.volunteer_photo;


                    this.form.volunteer_office_phone=response.data.account_holder.volunteer_office_phone;
                    this.form.volunteer_cell_phone=response.data.account_holder.volunteer_cell_phone;
                    this.form.volunteer_state=response.data.account_holder.volunteer_state;
                    this.form.volunteer_email=response.data.account_holder.volunteer_email;
                    this.form.volunteer_fax_no=response.data.account_holder.volunteer_fax_no;
                    this.form.volunteer_website=response.data.account_holder.volunteer_website;

                   

                    this.form.volunteer_house_number=response.data.account_holder.volunteer_house_number;
                    this.form.volunteer_street_number=response.data.account_holder.volunteer_street_number;
                    this.form.volunteer_city=response.data.account_holder.volunteer_city;
                    this.form.volunteer_state=response.data.account_holder.volunteer_state;
                    this.form.volunteer_country=response.data.account_holder.volunteer_country;
                    this.form.volunteer_zip_code=response.data.account_holder.volunteer_zip_code;
                    ...
                    this.form.department=response.data.account_holder.department;
                    this.form.section=response.data.account_holder.section;
                    this.form.weekly_hours=response.data.account_holder.weekly_hours;
