<template>
    ...
    <fieldset>
                    ...
                    <div class="form-holder" >
                        <div class="card" id="msform">
                            ...
                            <ul id="progressbar">
                                ...
                                <li  :class="{ active: sales_page>=1 }"> <strong>1/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(1)" class="router-link ">
                                        <p>Offer({{total_sales_offer_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                                <li :class="{ active: sales_page>=2 }">
                                    <strong>2/10<br>
                                        <span>                                    
                                        <a href="javascript:void(0)" @click="change_page(2)" class="router-link ">
                                            <p>Sales Acceptance({{total_sales_offer_acceptance_qty}})</p>
                                        </a>
                                       </span> 
                                   </strong>
                                </li>
                                <!--- router-link-active -->
                                <li :class="{ active: sales_page>=3 }"> <strong>3/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(3)" class="router-link ">
                                        <p>Sales Order({{total_sales_order_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                                <li :class="{ active: sales_page>=4 }"> <strong>4/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(4)" class="router-link ">
                                        <p>Packaing Slip({{total_sales_packaing_slip_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                               
                                
                                <li :class="{ active: sales_page>=5 }"> <strong>5/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(5)" class="router-link ">
                                        <p>(Return)({{total_sales_return_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                                 <li :class="{ active: sales_page>=6 }"> <strong>6/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(6)" class="router-link ">
                                        <p>(Debit Note)({{total_debit_note_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                                 <li :class="{ active: sales_page>=7 }"> <strong>7/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(7)" class="router-link ">
                                        <p>Credit Note({{total_credit_note_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                                <li :class="{ active: sales_page>=8 }"> <strong>8/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(8)" class="router-link ">
                                        <p>Sales Invice({{total_sales_invoice_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                                <li :class="{ active: sales_page>=9 }"> <strong>9/10<br><span>                                    
                                    <a href="javascript:void(0)" @click="change_page(9)" class="router-link ">
                                        <p>Direct Receive({{total_direct_payment_qty}})</p>
                                    </a>
                                   </span> </strong>
                                </li>
                                <li :class="{ active: sales_page>=10 }"> <strong>10/10<br><span>                                    
        ...
        <div >
            <form id="msform" @submit.prevent="editmode ? updateSalesOffers() : createCompanyProfile()" @keydown="form.onKeydown($event)">
                <div class="form-card" style="padding:0"> 
                    <div class="text-center">

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_form()">New</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="form.unique_no && sales_page==8" @click="sales_summery(form.unique_no)">Sales Summery</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==1" @click="convert_to_sales_offer(form.id)">Convert To Offer Acceptance</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==2" @click="convert_from_offer_acceptance(form.id)">Convert To Order</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==3" @click="convert_from_order(form.id)">Convert To Packing Slip</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_return==0 && sales_page==4" @click="convert_to_return(form.id)">Convert To Return</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_debit==0 && sales_page==4" @click="convert_to_debit_note(form.id)">Convert To Debit Note</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step_credit==0 && sales_page==4" @click="convert_to_credit_note(form.id)">Convert To Credit Note</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==4" @click="convert_to_invoice(form.id)">Convert To Sales Invoice</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step!=1 && sales_page==8" @click="convert_to_direct_payment(form.id)">Convert To Direct Receipt</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step!=1 && sales_page==9" @click="account_statement(form.id)">Account Statement</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_list()" v-if="sales_page==1">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_offer_acceptance_list()"  v-else-if="sales_page==2">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_order_list()" v-else-if="sales_page==3">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_packaing_list()" v-else-if="sales_page==4">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_return_list()"   v-else-if="sales_page==5">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_debit_list()" v-else-if="sales_page==6">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_credit_list()" v-else-if="sales_page==7">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_invoice_list()" v-else-if="sales_page==8">List</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_payment_list()" v-else-if="sales_page==9">List</button>
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>
                                    ...
                                    <td width="120">
                                        <button class="btn btn-primary btn-sm"  @click.prevent="AllEditSales(row.id)">Edit</button>
                                        <button  class="btn btn-danger btn-sm" @click.prevent="SalesOffersDelete(row.id)">Delete</button>
                                    </td>
                                </tr>
                            </template>
                        </datatable>
                    ...
                    <div class="form-folder" v-if="summery_showable && sales_page==8">
                        <h3><i class="fa fa-hand-point-right"></i> Sales Summery:
                            <button type="button" class="btn btn-primary btn-sm" @click="show_hide_purchase_summery()" v-show="!purchase_summery_show">Show</button> 
                            <button type="button" class="btn btn-primary btn-sm" @click="show_hide_purchase_summery()" v-show="purchase_summery_show">Hide</button>
                        </h3>

                        <div class="form-holder" v-if="purchase_summery_show">
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12"  style="margin-bottom:20px"> 
                                    <div class="form-box-outer" style=" width:100%">
                                        <table class="table table_narrow">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th scope="col" width="10%" > Documents Summary</th>

                                                    <template v-if="form.sales_type==1">
                                                        <th scope="col" width="5%">Product Code</th>
                                                        <th scope="col" width="8%">Product Name</th>
                                            ...
                                            <tbody >
                                                <template v-for="(summery_purchase_order,index) in sales_summery_details[3]" v-if="index!='total'">
                                                    <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                        <td>Sales Order</td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                    ...
                                                    <tr v-for="(single_product,index1) in summery_purchase_order">
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td>{{single_product.item_description}}</td>
                                                        <td></td>
                                                        <td align="right">{{single_product.qty}}</td>
                                                        <td align="right">{{single_product.rate}}</td>
                                                        <td align="right">{{single_product.addition}}</td>
                                                        <td align="right">{{single_product.deduction}}</td>
                                                        
                                                        <td align="right">{{single_product.sub_total}}</td>
                                                        <td align="right">{{single_product.tax_rate}}</td>
                                                        <td align="right">{{single_product.tax}}</td>
                                                        <td align="right">{{single_product.total}}</td>
                                                    </tr>
                                                    <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                        <td>{{index}}</td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td align="right">{{sales_summery_details[3]['total']['qty']}}</td>
                                                        <td align="right"></td>
                                                        <td align="right">{{sales_summery_details[3]['total']['addition']}}</td>
                                                        <td align="right">{{sales_summery_details[3]['total']['deduction']}}</td>
                                                        <td align="right">{{sales_summery_details[3]['total']['sub_total']}}</td>
                                                        <td align="right"></td>
                                                        <td align="right">{{sales_summery_details[3]['total']['tax']}}</td>
                                                        <td align="right">{{sales_summery_details[3]['total']['total']}}</td>
                                                    </tr>
                                                                                                       
                                                </template>

                                                <template v-if="sales_summery_details[4]">

                                                    <template v-for="(summery_purchase_order,index) in sales_summery_details[4]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Packing Slips</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{sales_summery_details[4]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[4]['total']['addition']}}</td>
                                                            <td align="right">{{sales_summery_details[4]['total']['deduction']}}</td>
                                                            <td align="right">{{sales_summery_details[4]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[4]['total']['tax']}}</td>
                                                            <td align="right">{{sales_summery_details[4]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="sales_summery_details[5]">

                                                    <template v-for="(summery_purchase_order,index) in sales_summery_details[5]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Sales Return</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{sales_summery_details[5]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[5]['total']['addition']}}</td>
                                                            <td align="right">{{sales_summery_details[5]['total']['deduction']}}</td>
                                                            <td align="right">{{sales_summery_details[5]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[5]['total']['tax']}}</td>
                                                            <td align="right">{{sales_summery_details[5]['total']['total']}}</td>
                                                        </tr>
                                                                                                           
                                                    </template>

                                                </template>
                                                <template v-if="sales_summery_details[6]">

                                                    <template v-for="(summery_purchase_order,index) in sales_summery_details[6]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Debit Note</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{sales_summery_details[6]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[6]['total']['addition']}}</td>
                                                            <td align="right">{{sales_summery_details[6]['total']['deduction']}}</td>
                                                            <td align="right">{{sales_summery_details[6]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[6]['total']['tax']}}</td>
                                                            <td align="right">{{sales_summery_details[6]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="sales_summery_details[7]">

                                                    <template v-for="(summery_purchase_order,index) in sales_summery_details[7]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Credit Note</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{sales_summery_details[7]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[7]['total']['addition']}}</td>
                                                            <td align="right">{{sales_summery_details[7]['total']['deduction']}}</td>
                                                            <td align="right">{{sales_summery_details[7]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[7]['total']['tax']}}</td>
                                                            <td align="right">{{sales_summery_details[7]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="sales_summery_details[8]">

                                                    <template v-for="(summery_purchase_order,index) in sales_summery_details[8]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Sales Invoice</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{sales_summery_details[8]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[8]['total']['addition']}}</td>
                                                            <td align="right">{{sales_summery_details[8]['total']['deduction']}}</td>
                                                            <td align="right">{{sales_summery_details[8]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{sales_summery_details[8]['total']['tax']}}</td>
                                                            <td align="right">{{sales_summery_details[8]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="po_balance_list">
                                                    <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                        <td colspan="2">Sales Order Balance</td>
                                                    ...
                                                    <tr v-for="(single_product,index) in po_balance_list" v-if="index!='total'">
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td>{{single_product.item_description}}</td>
                                                    ...
                                                    <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold" v-for="(single_product,index) in po_balance_list" v-if="index=='total'">
                                                        <td></td>
                                                        <td></td>
                                                        <td></td>
                                                        <td>{{single_product.item_description}}</td>
                    ...
                    <div class="form-folder">
                        <h3><i class="fa fa-hand-point-right"></i>&nbsp;<span v-if="sales_page==1">Sales Offer:</span>
                        <span v-else-if="sales_page==2">Sales Acceptance:</span><span v-else-if="sales_page==3">Sales Order:</span><span v-else-if="sales_page==4">Packing Slip:</span><span v-else-if="sales_page==5">Sales Return:</span><span v-else-if="sales_page==6">Sales Debit Note:</span><span v-else-if="sales_page==7">Sales Credit Note:</span><span v-else-if="sales_page==8">Sales Invoice:</span><span v-else-if="sales_page==9">Direct Receive:</span><span v-else-if="sales_page==10">Account Statement:</span>
                            ...
                            <div class="row align-self-stretch">
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-box-outer">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <label class="fieldlabels">Sales Type :</label> 
                                                <select v-model="form.sales_type"
                                                    name="sales_type"
                                                    class="custom-select"
                                                    @change="change_sales_type" 
                                                    :class="{ 'is-invalid': form.errors.has('sales_type') }">
                                                    <option  value="">--Select Sales Type-- </option>
                                                    <option  value="1">Goods </option>
                                                    <option  value="2">Service </option>
                                                </select>
                                                <has-error :form="form" field="sales_type"></has-error>
                                            </div>
                                        </div>
                            ...
                            <div class="row align-self-stretch">
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-box-outer">
                                        ...
                                        <div class="form-holder">
                                            <label class="fieldlabels">Sales Offer Acceptance Notified by:</label>
                                            <div class="form-check-inline">
                                                ...
                                                <has-error :form="form" field="notification_by"></has-error> 
                                            </div>
                                            ...
                                            <div class="form-check-inline">
                                                ...
                                                <has-error :form="form" field="backorder_allowed"></has-error> 
                                            </div>
                                            ...
                                            <div class="form-check-inline">
                                                ...
                                                <has-error :form="form" field="approval_status"></has-error> 
                                            </div>
                                            ...
                                            <date-picker 
                                                ...
                                                :class="{ 'is-invalid': form.errors.has('approval_date') }"></date-picker>
                                            <has-error :form="form" field="approval_date"></has-error>
                                            <label class="fieldlabels">Approval Time:</label>
                                            <vue-timepicker format="hh:mm A" v-model="form.approval_time"></vue-timepicker>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                        ...
                                        <div class="row">
                                            <table class="table  table-striped">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{form.sales_offer_date}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        Sales Offer Acceptance No
                                                    </td>
                                                    <td>
                                                        {{form.sales_offer_acceptance_no}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        Sales Offer Acceptance Date
                                                    </td>
                                                    <td>
                                                        {{form.sales_offer_acceptance_date}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        {{form.sales_debit_note_no}}
                                                    </td>
                                                </tr>

                                                <tr>
                                                    <td>
                                                        Sales Debit Note Date
                                                    </td>
                                                    <td>
                                                        {{form.sales_debit_note_date}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                    ...
                                                    <td>
                                                        {{form.sales_credit_note_no}}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td>
                                                        Sales Credit Note Date
                                                    </td>
                                                    <td>
                                                        {{form.sales_credit_note_date}}
                                                    </td>
                                                </tr>
                                            </table>
                                ...
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-box-outer">
                                        ...
                                        <date-picker 
                                            ...
                                            lang="en"
                                            type="schedule_delivery_date"
                                            format="ddd, MMM D, YYYY"
                                            :class="{ 'is-invalid': form.errors.has('schedule_delivery_date') }"></date-picker>
                                        <has-error :form="form" field="schedule_delivery_date"></has-error>
                                            
                                        <label class="fieldlabels">Scheduled Delivery Time:</label> 
                                        <br/>
                                        <vue-timepicker format="hh:mm A" v-model="form.schdule_delivery_time"></vue-timepicker>
                                        ...
                                        <has-error :form="form" field="delivery_location"></has-error> 
                                        ...
                                        <has-error :form="form" field="delivery_instruction"></has-error> 
                                        ...
                                        <has-error :form="form" field="delivery_contact_person_name"></has-error> 
                                        ...
                                        <has-error :form="form" field="delivery_contact_person_email"></has-error> 
                                        ...
                                        <has-error :form="form" field="delivery_contact_person_phone"></has-error> 
                                        ...
                                        <has-error :form="form" field="delivery_receive_by"></has-error> 
                                    ...
                                    <div class="form-box-outer">
                                        ...
                                        <div class="form-holder">
                                            ...
                                            <date-picker 
                                                ...
                                                format="ddd, MMM D, YYYY"
                                                :class="{ 'is-invalid': form.errors.has('payment_due_date') }"></date-picker>
                                            <has-error :form="form" field="payment_due_date"></has-error>
                                            ...
                                            <has-error :form="form" field="days_left_to_pay"></has-error>
                                            ...
                                            <div class="form-check-inline">
                                                ...
                                                <has-error :form="form" field="early_payment_discount"></has-error> 
                                            </div>
                                            ...
                                            <div class="form-check-inline">
                                                ...
                                                <has-error :form="form" field="posted_check_available"></has-error> 
                                            </div>
                                            ...
                                            <has-error :form="form" field="late_payment_pelanty"></has-error>
                                            ...
                                            <has-error :form="form" field="hidden_cost"></has-error>
                                            ...
                                            <div class="form-check-inline">
                                                ...
                                                <has-error :form="form" field="shipping_cost_pay_by"></has-error> 
                                            </div>
                    ...
                    <div class="form-folder">
                        <h3><i class="fa fa-hand-point-right"></i> Product Details:
                    ...
                    <div class="text-center" v-if="!list_showable">
                        ...
                        <button :disabled="form.busy || editmode"  type="button" class="btn  btn-primary" style="min-width:110px" @click="save_stay(1)">Save-Stay</button>
                        <button :disabled="form.busy ||editmode"  type="button" class="btn  btn-primary" style="min-width:110px"  @click="save_stay(2)">Save-Out</button>
                        <button :disabled="form.busy || editmode"  type="button" class="btn  btn-primary" style="min-width:110px" @click="save_stay(3)">Save-New</button>
                        ...
                        <button :disabled="form.busy || editmode==false || form.posting_status!=0"  type="button" class="btn  btn-primary" style="min-width:110px"  @click.prevent="deleteSalesOffers()">Delete</button>
                        
                        <button :disabled="form.busy || editmode==false || form.posting_status!=0"  type="button" class="btn  btn-primary" style="min-width:110px"  @click="post()">Post</button>

                        <button :disabled="form.busy || form.posting_status==0"  type="button" class="btn  btn-primary" style="min-width:110px"  @click="adjust()">Adjust</button>

                        <button :disabled="form.busy || form.posting_status!=2"  type="button" class="btn  btn-primary" style="min-width:110px" @click="repost()">RePost{{form.posting_status}}</button>
        ...
        <!--  Model  -->
            <div class="modal fade model-middle" id="ServiceItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" z-index="1000" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content" style="width:1000px;overflow-y: initial !important">
                    <div class="modal-header">
                        <h4 ><strong>Service item List</strong></h4>
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>  
                    </div>
                    <div class="modal-body" style="height: 50vh; overflow-y: auto;">
                    <div class="form-holder">
                        <datatable :columns="service_columns" :data="service_item_arr" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr @click="close_service_items(row)" style="cursor:pointer">
                                    <td>{{ row.sl }}</td>
                                    <td>{{ row.system_no }}</td>
        ...
        <!--  Model  -->
            <div class="modal fade model-middle" id="InventoryItem" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" z-index="1000" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content" style="width:1000px;overflow-y: initial !important">
                    <div class="modal-header">
                        <h4 ><strong>Inventory item List</strong></h4>
                         <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>  
                    </div>
                    <div class="modal-body" style="height: 50vh; overflow-y: auto;">
                    <div class="form-holder">
                        <datatable :columns="inventory_columns" :data="inventory_item_arr" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr @click="close_inventory_items(row)" style="cursor:pointer">
                                    <td>{{ row.sl }}</td>
                                    <td>{{ row.system_no }}</td>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ...
                form:new Form({
                    ...
                    sales_offer_no:'',
                    sales_offer_date:'',
                    sales_offer_acceptance_no:'',
                    sales_offer_acceptance_date:'',
                    sales_order_no:'',
                    sales_order_date:'',
                    packing_slip_no:'',
                    packing_slip_date:'',
                    ...
                    sales_return_date:'',
                    sales_debit_note_no:'',
                    sales_debit_note_date:'',
                    sales_credit_note_no:'',
                    sales_credit_note_date:'',
                    schdule_delivery_time:'',
                    
                }),

                total_sales_offer_qty:0,
                total_sales_offer_acceptance_qty:0,
                total_sales_order_qty:0,
                total_sales_packaing_slip_qty:0,
                total_debit_note_qty:0,
                total_credit_note_qty:0,
                total_sales_invoice_qty:0,
                total_sales_return_qty:0,
                total_direct_payment_qty:0,
                sales_summery_details:[],
                po_balance_list:[],
                ...
                columns: [
                    ...
                    { label: 'Sales Type', field: 'sales_type_string' },
        ...
        methods: {
            sales_summery(unique_no)
            {
                this.summery_showable=true;
                this.purchase_summery_show=true;
                let uri = '/SalesSummery/'+unique_no;
               
                window.axios.get(uri).then((response) => {

                    
                    this.sales_summery_details   = response.data.charge_details_arr;
            ...
            convert_from_order(offer_id)
            {
                ...
                this.sales_page=4;
                this.fetchSalesPackaingSlip(offer_id);
            },
            ...
            convert_from_packing_slip(offer_id)
            {
                ...
                this.sales_page=5;
                this.fetchSalesInvoice(offer_id);
            },

            fetchSalesPackaingSlip(offer_id)
            {

                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesOrders/'+offer_id+'/edit';
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.unique_no                         =response.data.sales_offer_list.unique_no;
                    ...
                    this.form.sales_type                        =response.data.sales_offer_list.sales_type;
                   ...
                   // this.form.approval_status                  =response.data.sales_offer_list.approval_status;
                    ...
                    for(let i=0; i<response.data.sales_charge_details_arr.length; i++){
                        if(response.data.sales_charge_details_arr[i].charge_type==1)
                        {
                            this.form.additional_charge_arr.push({
                                'id':response.data.sales_charge_details_arr[i].id,
                                'reference_id':response.data.sales_charge_details_arr[i].charge_id,
                                'reference_name':response.data.sales_charge_details_arr[i].charge_name,
                                'amount':response.data.sales_charge_details_arr[i].amount,
                            });
            ...
            fetchSalesReturn(offer_id){
                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesPackingSlips/'+offer_id+'/edit';
                window.axios.get(uri).then((response) => {
                    this.editmode=false;
                    this.company_arr                            =response.data.company_arr;
                    this.customer_arr                           =response.data.customer_arr;
                    ...
                    this.form.unique_no                         =response.data.sales_offer_list.unique_no;
                    //this.form.transaction_no                  =response.data.sales_offer_list.transaction_no;
            ...
            convert_from_offer_acceptance(offer_id)
            {
                ...
                this.sales_page=3;
                this.fetchSalesOrder(offer_id);
            },
            fetchSalesOrder(offer_id)
            {

                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesOfferAcceptances/'+offer_id+'/edit';
                window.axios.get(uri).then((response) => {
            ...
            convert_to_sales_offer(offer_id)
            {
                
                this.setProgressBar(2,10);
                this.sales_page=2;
                //this.form.reset ();
                this.fetchSalesOfferAcceptance(offer_id);
            },
            convert_to_return(offer_id)
            {
                ...
                this.setProgressBar(5,10);
                this.sales_page=5;
                this.fetchSalesReturn(offer_id);
            },
            ...
            convert_to_direct_payment(offer_id)
            {
                ...
                this.sales_page=9;
                this.fetchSalesPayment(offer_id);
            },
            fetchSalesPayment(offer_id){

                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesInvoices/'+offer_id+'/edit';
                window.axios.get(uri).then((response) => {
                    this.editmode=false;
                    this.company_arr                            =response.data.company_arr;
                    this.customer_arr                           =response.data.customer_arr;
            ...
            fetchSalesOfferAcceptance(offer_id)
            {

                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesOffers/'+offer_id+'/edit';
                window.axios.get(uri).then((response) => {
            ...
            close_service_items(product)
            {
                ...
                this.form.product_details_arr[this.temp_product].tax_rate           =product.sales_tax;
                ...
                this.form.product_details_arr[this.temp_product].tax                =product.tax;
            ...
            fetchSalesOffers()
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.total_sales_offer_qty               =response.data.total_sales_offer_qty;
                    this.total_sales_offer_acceptance_qty    =response.data.total_sales_offer_acceptance_qty;
                    this.total_sales_order_qty               =response.data.total_sales_order_qty;
                    this.total_sales_packaing_slip_qty       =response.data.total_sales_packaing_slip_qty;
                    this.total_sales_return_qty              =response.data.total_sales_return_qty;
                    ...
                    this.total_sales_invoice_qty             =response.data.total_sales_invoice_qty;
            ...
            AllEditSales(id)
            {
                if(this.sales_page==1)
                {
                    this.editSalesOffers(id);
                }
                else if(this.sales_page==2)
                {
                    this.editSalesOfferAcceptances(id);
                }
                else if(this.sales_page==3)
                {
                    this.editSalesOrders(id);
                }
                else if(this.sales_page==4)
                {
                    this.editSalesPackingSlips(id);
                }
                else if(this.sales_page==5)
                {
                    this.editSalesReturns(id);
                }
                else if(this.sales_page==6)
                {
                    this.editSalesDebitNotes(id);
                }
                else if(this.sales_page==7)
                {
                    this.editSalesCreditNotes(id);
                }
                else if(this.sales_page==8)
                {
                    this.editSalesInvoices(id);
                }
                else if(this.sales_page==9)
                {
            ...
            editSalesOffers(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.approval_status                  =response.data.sales_offer_list.approval_status;
                    this.form.vehicle_identification_number    =response.data.sales_offer_list.vehicle_identification_number;
                    this.form.approval_date                     =response.data.sales_offer_list.approval_date;
                    this.form.approval_time                     =response.data.sales_offer_list.approval_time;
                    this.form.approve_by                        =response.data.sales_offer_list.approve_by;
                    ...
                    this.form.posting_status                    =response.data.sales_offer_list.posting_status;
                     //alert(response.data.sales_offer_list.posting_status)
    
                }); 

                this.tempeditmode=false;
               // alert(this.form.posting_status)
                
            },
            editSalesOfferAcceptances(id)
            {
                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesOfferAcceptances/'+id+'/edit';
                window.axios.get(uri).then((response) => {
            ...
            editSalesPackingSlips(id)
            {
                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesPackingSlips/'+id+'/edit';
                window.axios.get(uri).then((response) => {
                    this.editmode=true;
                    this.company_arr                            =response.data.company_arr;
                    this.customer_arr                           =response.data.customer_arr;
                    ...
                    this.form.sales_type                     =response.data.sales_offer_list.sales_type;
                    this.form.next_step                         =response.data.sales_offer_list.next_step;
                    this.form.next_step_return                  =response.data.sales_offer_list.next_step_return;
                    this.form.next_step_debit                   =response.data.sales_offer_list.next_step_debit;
                    this.form.next_step_credit                  =response.data.sales_offer_list.next_step_credit;
                    this.form.seller_name                       =response.data.sales_offer_list.seller_name;
                    this.form.seller_id                         =response.data.sales_offer_list.seller_id;
                    this.form.seller_account_no                 =response.data.sales_offer_list.seller_account_no;
                    this.form.seller_photo                      =response.data.sales_offer_list.seller_photo;
            ...
            editSalesDebitNotes(id)
            {
                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesDebitNotes/'+id+'/edit';
                window.axios.get(uri).then((response) => {
                    this.editmode=true;
                    this.company_arr                            =response.data.company_arr;
                    this.customer_arr                           =response.data.customer_arr;
            ...
            editSalesCreditNotes(id)
            {
                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesCreditNotes/'+id+'/edit';
                window.axios.get(uri).then((response) => {
                    this.editmode=true;
                    this.company_arr                            =response.data.company_arr;
                    this.customer_arr                           =response.data.customer_arr;
            ...
            editSalesInvoices(id)
            {
                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesInvoices/'+id+'/edit';
                window.axios.get(uri).then((response) => {
                    this.editmode=true;
                    this.company_arr                            =response.data.company_arr;
                    this.customer_arr                           =response.data.customer_arr;
            ...
            editDirectPayments(id)
            {
                ...
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SalesDirectReceipts/'+id+'/edit';
                window.axios.get(uri).then((response) => {
                    this.editmode=true;
                    this.company_arr                            =response.data.company_arr;
                    this.customer_arr                           =response.data.customer_arr;
            ...
            reset_list()
            {
                this.form.reset();
                this.editmode=false;
                let uri = '/SalesOfferList';
                window.axios.get(uri).then((response) => {
                    this.rows = response.data.sales_offer_list;
                });
            ...
            reset_offer_acceptance_list()
            {
                this.form.reset();
                this.editmode=false;
                let uri = '/SalesOfferAcceptanceList';
                window.axios.get(uri).then((response) => {
                    this.rows = response.data.sales_offer_list;
                });
                this.list_showable=true;
            ...
            SalesOffersDelete(id)
            {
                Swal.fire({
                    ...
                    this.form.delete('/SalesOffers/'+id).then(()=>{
            ...
            {  
                Swal.fire({
                    ...
                    this.form.post('/SalesOfferPost/'+this.form.id).then((response)=>{
                        ...
                        { 
                            ...
                            if(this.sales_page==1)
                            {
                                this.editSalesOffers(response_data[1]);
                            }
                            else if(this.sales_page==2)
                            {
                                this.editSalesOfferAcceptances(response_data[1]);
                            }
                            else if(this.sales_page==3)
                            {
                                this.editSalesOrders(response_data[1]);
                            }
                            else if(this.sales_page==4)
                            {
                                this.editSalesPackingSlips(response_data[1]);
                            }
                            else if(this.sales_page==5)
                            {
                                this.editSalesReturns(response_data[1]);
                            }
                            else if(this.sales_page==8)
                            {
                                this.editSalesInvoices(response_data[1]);
                            }
                            else if(this.sales_page==9)
                            {
            ...
            {            
                Swal.fire({
                    ...
                    this.form.post('/SalesOfferRepost/'+this.form.id).then((response)=>{
                        ...
                        { 
                            ...
                            {
                                this.editSalesDebitNotes(response_data[1]);
                            }
                            else if(this.sales_page==7)
                            {
                                this.editSalesCreditNotes(response_data[1]);
                            }
                            else if(this.sales_page==8)
                            {
                                this.editSalesInvoices(response_data[1]);
            ...
            {            
                ...
                Swal.fire({
                    ...
                    this.form.delete('/SalesOffers/'+this.form.id).then(()=>{
            ...
            { 
                let uri="";
                if(this.sales_page==1)       uri="/SalesOffers/"+this.form.id;
                else if(this.sales_page==2)  uri="/SalesOfferAcceptances/"+this.form.id;
                else if(this.sales_page==3)  uri="/SalesOrders/"+this.form.id;
                else if(this.sales_page==4)  uri="/SalesPackingSlips/"+this.form.id;
                else if(this.sales_page==5)  uri="/SalesReturns/"+this.form.id;
                else if(this.sales_page==6)  uri="/SalesDebitNotes/"+this.form.id;
                else if(this.sales_page==7)  uri="/SalesCreditNotes/"+this.form.id;
                else if(this.sales_page==8)  uri="/SalesInvoices/"+this.form.id;
                else if(this.sales_page==9)  uri="/SalesDirectReceipts/"+this.form.id;
            ...
            { 
                 ...
                 this.form.post('/adjustSalesOffer/'+this.form.id).then((response)=>{
                    var response_data=response.data.split("**");
                    if(response_data[0]==1)
                    {
                         toast({
                ...
                else if(this.sales_page==2)
                {
                    ...
                    this.form.post(uri) .then(({ data }) => { 
                        ...
                        if(response_data[0]==1)
                        {
                            ...
                            {
                                this.form.reset();
                                this.fetchOfferAcceptancesProfile();
                            }
                        }
                        else{
                ...
                else if(this.sales_page==6)
                {
                    ...
                    this.form.post(uri) .then(({ data }) => { 
                        ...
                        if(response_data[0]==1)
                        {
                            ...
                            {
                                this.form.reset();
                                this.fetchSalesDebitNoteProfile();
                            }
                        }
                        else{
                ...
                else if(this.sales_page==7)
                {
                    ...
                    this.form.post(uri) .then(({ data }) => { 
                        ...
                        if(response_data[0]==1)
                        {
                            ...
                            {
                                this.form.reset();
                                this.fetchSalesCreditNoteProfile();
                            }
                        }
                        else{
                ...
                else if(this.sales_page==9)
                {
                    ...
                    this.form.post(uri) .then(({ data }) => { 
                        ...
                        if(response_data[0]==1)
                        {
                            ...
                            {
                                this.form.reset();
                                this.fetchDirectPaymentProfile();
                            }
                        }
                        else{
