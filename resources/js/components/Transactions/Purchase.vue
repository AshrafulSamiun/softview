<template>
    <fieldset>
        <div class="form-card" style="padding:0">
            <h1 class="page-head">Purchase</h1>
                ...
                <div class="form-holder" >
                    <div class="card" id="msform">
                        ...
                        <ul id="progressbar">
                            ...
                            <li  :class="{ active: purchase_page>=1 }"> <strong>1/10<br><span>                                    
                           ...
                           <!--- router-link-active -->
                            <li :class="{ active: purchase_page>=3 }"> <strong>3/10<br><span>                                    
                                <a href="javascript:void(0)" @click="change_page(3)" class="router-link ">
                                    <p>PO({{total_purchase_order_qty}})</p>
                                </a>
                               </span> </strong>
                            </li>
                            <li :class="{ active: purchase_page>=4 }"> <strong>4/10<br><span>                                    
            ...
            <form id="msform" @submit.prevent="editmode ? updatePurchase(1) : createPurchase()" @keydown="form.onKeydown($event)">
                <div class="form-card" style="padding:0"> 
                    <div class="text-center">
                        ...
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_form()">Refresh {{ form.posting_status}} || {{form.posting_status}} ) && {{form.next_step}} && {{purchase_page}}</button>
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>
                                    ...
                                    <td>{{ row.purchase_type_string }}</td>
                    ...
                    <div class="form-folder" v-if="summery_showable && purchase_page==8">
                        <h3><i class="fa fa-hand-point-right"></i> Purchase Summery:
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12"  style="margin-bottom:20px"> 
                                    <div class="form-box-outer" style=" width:100%">
                                        <table class="table table_narrow">
                                            ...
                                            <tbody >
                                                <template v-for="(summery_purchase_order,index) in purchase_summery_details[3]" v-if="index!='total'">
                                                    ...
                                                    <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                        ...
                                                        <td></td>
                                                        <td></td>
                                                        <td align="right">{{purchase_summery_details[3]['total']['qty']}}</td>
                                                        <td align="right"></td>
                                                        <td align="right">{{purchase_summery_details[3]['total']['addition']}}</td>
                                                        <td align="right">{{purchase_summery_details[3]['total']['deduction']}}</td>
                                                        <td align="right">{{purchase_summery_details[3]['total']['sub_total']}}</td>
                                                        <td align="right"></td>
                                                        <td align="right">{{purchase_summery_details[3]['total']['tax']}}</td>
                                                        <td align="right">{{purchase_summery_details[3]['total']['total']}}</td>
                                                    </tr>
                                                                                                       
                                                </template>

                                                <template v-if="purchase_summery_details[4]">

                                                    <template v-for="(summery_purchase_order,index) in purchase_summery_details[4]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Packing Slips</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{purchase_summery_details[4]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[4]['total']['addition']}}</td>
                                                            <td align="right">{{purchase_summery_details[4]['total']['deduction']}}</td>
                                                            <td align="right">{{purchase_summery_details[4]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[4]['total']['tax']}}</td>
                                                            <td align="right">{{purchase_summery_details[4]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="purchase_summery_details[5]">

                                                    <template v-for="(summery_purchase_order,index) in purchase_summery_details[5]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{purchase_summery_details[5]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[5]['total']['addition']}}</td>
                                                            <td align="right">{{purchase_summery_details[5]['total']['deduction']}}</td>
                                                            <td align="right">{{purchase_summery_details[5]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[5]['total']['tax']}}</td>
                                                            <td align="right">{{purchase_summery_details[5]['total']['total']}}</td>
                                                        </tr>
                                                                                                           
                                                    </template>

                                                </template>
                                                <template v-if="purchase_summery_details[6]">

                                                    <template v-for="(summery_purchase_order,index) in purchase_summery_details[6]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Debit Note</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{purchase_summery_details[6]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[6]['total']['addition']}}</td>
                                                            <td align="right">{{purchase_summery_details[6]['total']['deduction']}}</td>
                                                            <td align="right">{{purchase_summery_details[6]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[6]['total']['tax']}}</td>
                                                            <td align="right">{{purchase_summery_details[6]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="purchase_summery_details[7]">

                                                    <template v-for="(summery_purchase_order,index) in purchase_summery_details[7]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                            <td>Credit Note</td>
                                                            <td></td>
                                                            <td></td>
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{purchase_summery_details[7]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[7]['total']['addition']}}</td>
                                                            <td align="right">{{purchase_summery_details[7]['total']['deduction']}}</td>
                                                            <td align="right">{{purchase_summery_details[7]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[7]['total']['tax']}}</td>
                                                            <td align="right">{{purchase_summery_details[7]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="purchase_summery_details[8]">

                                                    <template v-for="(summery_purchase_order,index) in purchase_summery_details[8]" v-if="index!='total'">
                                                        <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                        ...
                                                        <tr style="background-color:rgb(216, 222, 221);color:#000; font-weight:bold">
                                                            ...
                                                            <td></td>
                                                            <td></td>
                                                            <td align="right">{{purchase_summery_details[8]['total']['qty']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[8]['total']['addition']}}</td>
                                                            <td align="right">{{purchase_summery_details[8]['total']['deduction']}}</td>
                                                            <td align="right">{{purchase_summery_details[8]['total']['sub_total']}}</td>
                                                            <td align="right"></td>
                                                            <td align="right">{{purchase_summery_details[8]['total']['tax']}}</td>
                                                            <td align="right">{{purchase_summery_details[8]['total']['total']}}</td>
                                                        </tr>
                                                ...
                                                <template v-if="po_balance_list">
                                                    <tr style="background-color:rgb(147, 175, 144);color:#fff; font-weight:bold">
                                                        <td colspan="2">Purchase Order Balance</td>
                    ...
                    <div class="form-folder">
                        <h3>
                            <i class="fa fa-hand-point-right"></i>&nbsp;
                                <span v-if="purchase_page==1">Purchase Offer:</span>
                                <span v-else-if="purchase_page==2">Purchase Acceptance:</span>
                                <span v-else-if="purchase_page==3">Purchase Order:</span>
                                <span v-else-if="purchase_page==4">Packing Slip:</span>
                                <span v-else-if="purchase_page==5">Purchase Return:</span>
                                <span v-else-if="purchase_page==6">Purchase Debit Note:</span>
                                <span v-else-if="purchase_page==7">Purchase Credit Note:</span>
                                <span v-else-if="purchase_page==8">Purchase Invoice:</span>
                                <span v-else-if="purchase_page==9">Direct Payment:</span>
                                <span v-else-if="purchase_page==10">Account Statement:</span>
                                    ...
                                    <div class="form-box-outer">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <has-error :form="form" field="purchase_type"></has-error>
                                            </div>
                                        </div>
        ...
        data(){
            return{
                ...
                columns: [
                    ...
                    { label: 'Purchase Type', field: 'purchase_type_string' },
