<template>
    ...
    <fieldset>
        <form id="msform" @submit.prevent="editmode ? updatePurchaseOffers() : createCompanyProfile()" @keydown="form.onKeydown($event)">
            <div class="form-card">
                        ...
                        <div class="form-holder" >
                            <div class="card" id="msform">
                                ...
                                <ul id="progressbar">
                                    ...
                                    <li > <strong>1/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Offer</p>
                                        </router-link>
                                       </span> </strong>
                                    </li>
                                    <li class="active"> <strong>2/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Offer Acceptance</p>
                                        </router-link>
                                       </span> </strong>
                                    </li>
                                    <li class=""> <strong>3/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Order</p>
                                        </router-link>
                                       </span> </strong>
                                    </li>
                                    <li class=""> <strong>4/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Packaing Ship</p>
                                        </router-link>
                                       </span> </strong>
                                    </li>
                                    <li class=""> <strong>5/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Invoice</p>
                                        </router-link>
                                       </span> </strong>
                                    ...
                                    <li class=""> <strong>6/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Return</p>
                                        </router-link>
                                       </span> </strong>
                                    </li>
                                     <li class=""> <strong>7/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Debit Note</p>
                                        </router-link>
                                       </span> </strong>
                                    </li>
                                     <li class=""> <strong>8/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Credit Note</p>
                                        </router-link>
                                       </span> </strong>
                                    </li>
                                     <li class=""> <strong>9/9<br><span>                                    
                                        <router-link :to="{ path: '/', params: { id: 20 }}" class="router-link" >
                                            <p>Direct Payment</p>
                                        </router-link>
                                       </span> </strong>
                ...
                <div >
                    ...
                    <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="form.posting_status==1 || form.posting_status==3" @click="convert_to_purchase_offer()">Convert To Offer Acceptance</button>
                ...
                <div v-if="list_showable" class="card-body">
                    ...
                    <datatable :columns="columns" :data="rows" :filter-by="filter">
                        <template slot-scope="{row}">
                            <tr>
                                ...
                                <td width="120">
                                    <button class="btn btn-primary btn-sm"  @click.prevent="editPurchaseOffers(row.id)">Edit</button>
                    ...
                    <div class="form-folder">
                        <h3><i class="fa fa-hand-point-right"></i> Purchase Offer:
                                        ...
                                        <div class="form-holder">
                                            ...
                                            <div class="form-check-inline">
                                                ...
                                                <select v-model="form.notification_by"
                                                    ...
                                                    <option value="8">Voicemail</option>
                    ...
                    <div class="text-center" v-if="!list_showable">
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" @click="reset_form()">New</button>
                        <button :disabled="form.busy"  type="submit" class="btn  btn-primary" style="min-width:110px" v-show="editmode && form.posting_status==0">Edit</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="editmode && form.posting_status==0" @click.prevent="deletePurchaseOffers()">Delete</button>
                        ...
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="!editmode" @click="save_stay(2)">Save-Out</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="!editmode" @click="save_stay(3)">Save-New</button>
                        
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="editmode && form.posting_status==0" @click="post()">Post</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="form.posting_status==1 || form.posting_status==2" @click="adjust()">Adjust</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="form.posting_status==2" @click="repost()">RePost</button>
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="form.posting_status==1 || form.posting_status==3" @click="convert_to_purchase_offer()">Convert To Offer Acceptance</button>
        ...
        methods: {
            ...
            editPurchaseOffers(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.purchase_offer_no                 =response.data.purchase_offer_list.transaction_no;
            ...
            {            
                ...
                Swal.fire({
                    ...
                    this.form.post('/PurchaseOfferPost/'+this.form.id).then((data)=>{
            ...
            {            
                ...
                Swal.fire({
                    ...
                    this.form.post('/PurchaseOfferRepost/'+this.form.id).then((data)=>{
            ...
            { 
                 ...
                 this.form.post('/adjustPurchaseOffer/'+this.form.id).then(({ data })=>{
                    var response_data=data.split("**");
                    if(response_data[0]==1)
                    {
                         toast({
            ...
            save_stay(type){
                ...
                this.form.post('/PurchaseOffers') .then(({ data }) => { 
                    var response_data=data.split("**");
                    if(response_data[0]==1)
                    {
                         toast({
