	    ...
	    methods: {
            ...
            editCommercialUnit(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.posting_status                    =response.data.commercial_unit_arr.posting_status;
                    this.form.strata_lot_no                     =response.data.commercial_unit_arr.strata_lot_no;
            ...
            { 
                ...
                Swal.fire({
                    ...
                    this.form.post('/CommercialUnitPost/'+this.form.id).then((response)=>{
            ...
            {            
                Swal.fire({
                    ...
                    this.form.post('/CommercialUnitRepost/'+this.form.id).then((response)=>{
