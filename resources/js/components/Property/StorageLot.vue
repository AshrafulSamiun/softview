	        ...
	        <div class="form-card">
                ...
                <div v-if="!list_showable">
                    ...
                    <div class="text-center" v-if="!list_showable">
                        ...
                        <button :disabled="form.busy || editmode==false || form.posting_status!=0"  type="button" class="btn  btn-primary" style="min-width:110px"  @click.prevent="deleteStorageLot()">Delete</button>
	    ...
	    methods: {
            ...
            editStorageLot(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.posting_status                    =response.data.storage_lot_arr.posting_status; 
                    this.form.strata_lot_no                     =response.data.storage_lot_arr.strata_lot_no;                  this.form.building_name                     =response.data.storage_lot_arr.building_name;
            ...
            { 
                ...
                Swal.fire({
                    ...
                    this.form.post('/StorageLotPost/'+this.form.id).then((response)=>{
            ...
            {            
                Swal.fire({
                    ...
                    this.form.post('/StorageLotRepost/'+this.form.id).then((response)=>{
            ...
            { 
                ...
                this.form.post('/adjustStorageLot/'+this.form.id).then((response)=>{
                    var response_data=response.data.split("**");
                    if(response_data[0]==1)
                    {
