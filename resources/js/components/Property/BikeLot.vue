<template>
	...
	<fieldset>
		<form id="msform" @submit.prevent="editmode ? updateBikelot() : createCompanyProfile()" @keydown="form.onKeydown($event)">
	        <div class="form-card">
                <h1 class="page-head">Bike Lot</h1>
                    ...
                    <datatable :columns="columns" :data="rows" :filter-by="filter">
                        <template slot-scope="{row}">
                            <tr>
                                ...
                                <td>{{ row.bike_lot_size_qty }}</td>
                                <td width="120">
                                    <button class="btn btn-primary btn-sm"  @click.prevent="editBikeLot(row.id)">Edit</button>
                                    <button  class="btn btn-danger btn-sm" @click.prevent="BikeLotDelete(row.id)">Delete</button>
                                </td>
                            </tr>
                        </template>
                    </datatable>
                ...
                <div v-if="!list_showable">
                                ...
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                    <div class="form-box-outer">
                                        <label class="fieldlabels">UOM:</label> 
                                            ...
                                            <input v-model="form.bike_lot_size_qty" 
                                                type="number" 
                                                name="bike_lot_size_qty" 
                                                placeholder="Type Lot Size" 
                                                :class="{ 'is-invalid': form.errors.has('bike_lot_size_qty') }"/>
                                            <has-error :form="form" field="bike_lot_size_qty"></has-error>
                                    ...
                                    <div class="form-box-outer">
                                        ...
                                        <div class="form-holder">
                                            <div class="form-check-inline">
                                                ...
                                                <input type="radio" 
                                                    id="bike_level" 
                                                    name="bike_level" disabled checked>
                                                <label for="bike_level">Total Bike Level:{{form.bike_level}}</label><br>

                                                <input type="radio" 
                                                    id="bike_stall" 
                                                    name="bike_stall" disabled checked>
                                                <label for="bike_stall">Total Bike Stall:{{form.bike_stall}}</label><br>

                                                <input type="radio" 
                                                    id="bike_lot_size_qty" 
                                                    name="bike_lot_size_qty"  disabled checked>
                                                <label for="bike_lot_size_qty">Bike Lot Size:{{form.bike_lot_size_qty}}  {{uom_arr[form.lot_uom]}}</label><br>
                                                <input type="radio" 
                                                    id="bike_level_qty" 
                                                    name="bike_level_qty" disabled checked>
                                                <label for="bike_level_qty">Total Bike Level Size: {{form.total_bike_level_size}} {{uom_arr[form.lot_uom]}}</label><br>
                                                <input type="radio" 
                                                    id="bike_stall_qty" 
                                                    name="bike_stall_qty" disabled checked>
                                                <label for="bike_stall_qty">Total Bike Stall Size: {{form.total_bike_stall_size}} {{uom_arr[form.lot_uom]}}</label><br>
                                            </div>
                                        </div>
                    ...
                    <div class="form-folder" >
                        <h3><i class="fa fa-hand-point-right"></i>Bike Lot Details <button type="button" class="btn btn-primary btn-sm" @click="show_hide_property()" v-show="!property_show">Show</button> <button type="button" class="btn btn-primary btn-sm" @click="show_hide_property()" v-show="property_show">Hide</button></h3>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12"  style="margin-bottom:20px"> 
                                    <div class="form-box-outer" style=" width:100%">
                                        ...
                                        <table class="table table_narrow">
                                            ...
                                            <thead>
                                                <tr>
                                                    <th scope="col" width="12%" rowspan="2">Bike Level/ Stall</th>
                                                    <th scope="col" width="12%" rowspan="2">Property ID</th>
                                                    <th scope="col" width="12%" rowspan="2">Property Name</th>
                                                    <th scope="col" width="12%" rowspan="2">Size (  {{uom_arr[form.lot_uom]}} )</th> 
                                                    <th scope="col" :colspan="stall_type_arr_length+1" align="center" width="47%">Stall Type
                                                    </th>
                                            ...
                                            <tbody >
                                                <template v-if="form.total_bike_lot>0">
                                                    <template v-for="(single_level,level) in form.subrooms_list_arr" >

                                                        <tr style="background-color: #6090bc;color: #fff;">
                                                            <td width="" scope="row" style=""><strong>Bike Level {{level.toString().padStart(2,"0")}}</strong></td>
                                                            <td width="">
                                                        ...
                                                        <template v-for="(single_stall,stl) in form.subrooms_list_arr[level]">
                                                            <tr v-if="stl>=0">
                                                                <td width="" scope="row" style="padding-left:1% !important"><strong>{{single_stall.item_name}}</strong></td>
                                                                <td width="">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td>Total</td>
                                                    <td class="text-center">{{form.total_bike_stall_size}}</td>
                                                    <td v-for="(stall_type,index) in stall_type_arr">
                                                        <strong>{{form.bike_lot_total_arr[index]}}</strong>
                                                    </td>
                                                    <td >
                                                        <strong>{{form.bike_lot_total_arr['total']}}</strong>
                                                    </td> 
                                                     <td></td>
                                                </tr>
                                              </tfoot>
            ...
            <!-- model end -->
             ...
             <!--  MOdel  -->
                <div class="modal fade model-middle" id="BikeStallModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" z-index="1000" aria-hidden="true">
                  <div class="modal-dialog" role="document">
                      ...
                      <div class="modal-body" style="height: 50vh; overflow-y: auto;">
                        <div class="form-holder">
                            <div class="row align-self-stretch">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="form-box-outer">
                                         <h6 ><strong>Bike Level {{details_level.padStart(2,"0")}}; Bike Stall-{{details_stall.padStart(4,"0")}}</strong></h6><br/>
                                        <table class="table table_narrow">
        ...
        data(){
            return{
                ...
                columns: [
                    ...
                    { label: 'Lot Size', field: 'bike_lot_size_qty' },
	    ...
	    methods: {
            ...
            editBikeLot(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.id                                =response.data.bike_lot_arr.id;
                    this.form.company_name                      =response.data.bike_lot_arr.company_name;
                    this.form.strata_lot_no                     =response.data.bike_lot_arr.strata_lot_no;
                    this.form.posting_status                    =response.data.bike_lot_arr.posting_status
                    this.form.building_name                     =response.data.bike_lot_arr.building_name;
                    
                    this.form.floor_no                          =response.data.bike_lot_arr.floor_no;
                    this.form.system_no                         =response.data.bike_lot_arr.system_no;
                    this.form.system_prefix                     =response.data.bike_lot_arr.system_prefix;
                    this.form.property_name                     =response.data.bike_lot_arr.property_name;
                    this.form.lot_number                        =response.data.bike_lot_arr.lot_number;
                    this.form.lot_uom                           =response.data.bike_lot_arr.lot_uom;
                    this.form.bike_lot_size_qty                 =response.data.bike_lot_arr.bike_lot_size_qty;
                    this.form.total_bike_level_size             =response.data.bike_lot_arr.total_bike_level_size;
                    this.form.total_bike_stall_size             =response.data.bike_lot_arr.total_bike_stall_size;
                    ...
                    this.form.bike_lot_total_arr                =response.data.bike_lot_total_arr;
                    this.form.bike_level                        =response.data.bike_level;
                    this.form.bike_stall                        =response.data.bike_stall;
                    ...
                    this.form.total_bike_lot                    =response.data.total_bike_lot;
            ...
            change_level_size()
            {
                ...
                this.form.total_bike_level_size=total_level_size;
            ...
            change_stall_size()
            {
                ...
                this.form.total_bike_stall_size=total_subroom_size;
            ...
            { 
                ...
                Swal.fire({
                    ...
                    this.form.post('/BikeLotPost/'+this.form.id).then((response)=>{
                        ...
                        { 
                            ...
                            this.editBikeLot(response_data[1]);
            ...
            {            
                Swal.fire({
                    ...
                    this.form.post('/BikeLotRepost/'+this.form.id).then((response)=>{
            ...
            { 
                ...
                this.form.post('/adjustBikeLot/'+this.form.id).then((response)=>{
                    var response_data=response.data.split("**");
                    if(response_data[0]==1)
                    {
            ...
            reset_list()
            {
                this.form.reset();
                this.editmode=false;
                let uri = '/BikeLotsList';
                window.axios.get(uri).then((response) => {
                    this.rows = response.data.bike_lot_list;
                });
            ...
            {     
                ...
                let uri = '/BikeFloorDataByBuilding/'+this.form.building_name;
                window.axios.get(uri).then((response) => {
            ...
            check_stall_type_total(e,m_name,index,stall,lavel){
                if(e.target.checked)
                {
                    ...
                    this.form.bike_lot_total_arr[index]++;
                    this.form.bike_lot_total_arr['total']++;
                ...
                for(var i=1;i<=this.stall_type_arr_length; i++) 
                {
                    if(index!=i)
                    {
                        ...
                        if(this.form.subrooms_list_arr[lavel][stall][r_name]==true)
                        {
                            ...
                            this.form.stall_type_total_arr[lavel]['total']--; 
                            this.form.bike_lot_total_arr[i]--;
                            this.form.bike_lot_total_arr['total']--;
                        }
                    }
                }             
            ...
            change_floor()
            {
                ...
                this.form.total_bike_stall_size=0;
                let uri = '/loadBikeLotByFloor/'+this.form.floor_no;
                window.axios.get(uri).then((response) => {
            ...
            { 
		        ...
		        this.form.put('/BikeLots/'+this.form.id).then(({ data })=>{
					var response_data=data.split("**");
                    if(response_data[0]==1)
                    {
                         showToast('Data Update Successfully', 'success');
            ...
            save_stay(type){
                ...
                this.form.post('/BikeLots') .then(({ data }) => { 
                    var response_data=data.split("**");
                    if(response_data[0]==1)
                    {
                         showToast('Data Update Successfully', 'success');
