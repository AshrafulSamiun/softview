            ...
            <div class="form-card">
                ...
                <div v-if="!list_showable">
                                        ...
                                        <table class="table table_narrow" >
                                            ...
                                            <thead>
                                                <tr >
                                                    ...
                                                    <th scope="col" colspan="5" width="40%">Asign To</th>
                                                </tr>
                                                <tr >
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td  scope="row" class="form-check-inline text-center">
                                                                <input type="checkbox" 
                                                                    ...
                                                                    v-model="single_subroom.company" >
                                                            </td>
                    ...
                    <div class="text-center" v-if="!list_showable">
                        ...
                        <button :disabled="form.busy || editmode==false || form.posting_status!=0"  type="button" class="btn  btn-primary" style="min-width:110px"  @click.prevent="deleteCommonArea()">Delete</button>
        ...
        methods: {
            ...
            check_assign_to(e,single_subroom,type){
                if(e.target.checked)
                {
                    if(type==1)
                    {
                        ...
                        single_subroom.company=true;
                        return;
                    }
                    
                    else if(type==4)
                    {
                        single_subroom.company=false;
                        single_subroom.leasholder=false;
                        single_subroom.other_1=false;
                        single_subroom.other_2=false;
            ...
            editCommonArea(id)
            {
                ...
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.strata_lot_no                     =response.data.common_area_arr.strata_lot_no;
                    this.form.posting_status                    =response.data.common_area_arr.posting_status;
            ...
            { 
                ...
                Swal.fire({
                    ...
                    this.form.post('/CommonAreaPost/'+this.form.id).then((response)=>{
            ...
            {            
                Swal.fire({
                    ...
                    this.form.post('/CommonAreaRepost/'+this.form.id).then((response)=>{
            ...
            { 
                ...
                this.form.post('/adjustCommonArea/'+this.form.id).then((response)=>{
                    var response_data=response.data.split("**");
                    if(response_data[0]==1)
                    {
