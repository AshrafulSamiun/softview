            ...
            <div class="card">
                ...
                <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
                    <fieldset>
                        <div id="content">
                            <div class="form-card">
                                <h1 class="page-head"> Account Holder Profile</h1> 
                            ...
                            <div class="form-card" v-if="!list_showable">
                                        ...
                                        <div class="row align-self-stretch"> 
                                            <div class="col-md-4 col-sm-6 col-xs-12"> 
                                                <div class="form-box-outer">
                                                    ...
                                                    <label class="fieldlabels">Entity:</label> 
                                                    <div class="position-relative form-group">
                                                        <select v-model="form.entity_type"
                                                            name="entity_type"
                                                            class="custom-select" 
                                                            :class="{ 'is-invalid': form.errors.has('entity_type') }">
                                                            <option disabled value="">--Select-- </option>
                                                            <option value="1">Individual</option>
                                                            <option value="" disabled style="background-color:#3C67D4;color:#fff">Registered Corporation</option>
                                                            <option value="2">&nbsp;&nbsp;&nbsp;&nbsp;Domestic Corporation</option>
                                                            <option value="3">&nbsp;&nbsp;&nbsp;&nbsp;Foreign Corporation</option>
                                                        </select>
                                                        <has-error :form="form" field="entity_type"></has-error> 
                                                    </div>
                                                    ...
                                                    <input 
                                                        v-if="industry_sector_display"
                                                        v-model="form.industry_sector_text" 
                                                        type="text" 
                                                        placeholder="Type Industry Sector"
                                                        name="industry_sector_text" 
                                                        :class="{ 'is-invalid': form.errors.has('industry_sector_text') }"/>
                                            ...
                                            <div class="col-md-4 col-sm-6 col-xs-12">
                                                <div class="form-box-outer">
                                                    <h4>Registered Corporation Legal Name</h4>
                                                    
                                                    <label class="fieldlabels">Director Info.:</label>
                                                    <input 
                                                        v-model="form.reg_cor_dir_info" 
                                                        type="text" 
                                                        name="reg_cor_dir_info" 
                                                        placeholder="Type Number" 
                                                        :class="{ 'is-invalid': form.errors.has('reg_cor_dir_info') }"/>
                                                    <has-error :form="form" field="reg_cor_dir_info"></has-error> 

                                                    
                                                    <label class="fieldlabels" >First Name:</label>  
                                                    <input v-model="form.register_corp_first_name" 
                                                        type="text" 
                                                        placeholder="Type First Name"
                                                        name="register_corp_first_name" 
                                                        :class="{ 'is-invalid': form.errors.has('register_corp_first_name') }"/>
                                                      <has-error :form="form" field="register_corp_first_name"></has-error>

                                                    <label class="fieldlabels" >Middle Name:</label>  
                                                    <input v-model="form.register_corp_middle_name" 
                                                        type="text" 
                                                        placeholder="Type Middle Name"
                                                        name="register_corp_middle_name" 
                                                        :class="{ 'is-invalid': form.errors.has('register_corp_middle_name') }"/>
                                                      <has-error :form="form" field="register_corp_middle_name"></has-error>

                                                    <label class="fieldlabels" >Last Name:</label>  
                                                    <input v-model="form.register_corp_last_name" 
                                                        type="text" 
                                                        placeholder="Type Last Name"
                                                        name="register_corp_last_name" 
                                                        :class="{ 'is-invalid': form.errors.has('register_corp_last_name') }"/>
                                                      <has-error :form="form" field="register_corp_last_name"></has-error>

                                                    <label class="fieldlabels">Phone Number:</label>
                                                    <input v-model="form.register_corp_phone_no" 
                                                        type="text" 
                                                        placeholder="Type Phone Number"
                                                        name="register_corp_phone_no" 
                                                        :class="{ 'is-invalid': form.errors.has('register_corp_phone_no') }"/>
                                                      <has-error :form="form" field="register_corp_phone_no"></has-error>

                                                    <label class="fieldlabels">Email:</label> 
                                                    <input v-model="form.register_corp_email" 
                                                        type="email" 
                                                        name="register_corp_email" 
                                                        placeholder="Type Eamil" 
                                                        :class="{ 'is-invalid': form.errors.has('register_corp_email') }"/>
                                                    <has-error :form="form" field="register_corp_email"></has-error> 

                                                    <label class="fieldlabels">Emergency Contact:</label> 
                                                    <input v-model="form.register_emergency_contact" 
                                                        type="phone" 
                                                        name="register_emergency_contact" 
                                                        placeholder="Type Emergency Contact" 
                                                        :class="{ 'is-invalid': form.errors.has('register_emergency_contact') }"/>
                                                    <has-error :form="form" field="register_emergency_contact"></has-error>
                                ...
                                <div class="form-folder">
                                    <h3><i class="fa fa-hand-point-right"></i>Business Licence:
                                                ...
                                                <div class="form-box-outer">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <input v-model="form.business_license_issued_by" 
                                                               type="text" 
                                                               name="business_license_issued_by" 
                                                               placeholder="Type Issue Name"
                                                               :class="{ 'is-invalid': form.errors.has('business_license_issued_by') }"/>
                                                            <has-error :form="form" field="business_license_issued_by"></has-error> 
                                                        </div>
                                                        <h4>Address</h4>
                                                         <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Number:</label> 
                                                            <input v-model="form.business_license_house_number" 
                                                                type="phone" 
                                                                name="business_license_house_number" 
                                                                placeholder="Type House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_house_number') }"/>
                                                                 <has-error :form="form" field="business_license_house_number"></has-error> 
                                                        </div>
                                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                                            <label class="fieldlabels">Street Number:</label> 
                                                            <input v-model="form.business_license_street_number" 
                                                                type="text" 
                                                                name="business_license_street_number" 
                                                                placeholder="Type Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_street_number') }"/>
                                                                 <has-error :form="form" field="business_license_street_number"></has-error> 
                                                        </div>
                                                        
                                                        <div class="col-md-12 col-sm-6 col-xs-12">
                                                            <label class="fieldlabels">City:</label> 
                                                            <input v-model="form.business_license_city" 
                                                                type="text" 
                                                                name="business_license_city" 
                                                                placeholder="Type City" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_city') }"/>
                                                                 <has-error :form="form" field="business_license_city"></has-error> 
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">State:</label> 
                                                            <input v-model="form.business_license_state" 
                                                                type="text" 
                                                                name="business_license_state" 
                                                                placeholder="Type State" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_state') }"/>
                                                                 <has-error :form="form" field="business_license_state"></has-error>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.business_license_country"
                                                                    name="business_license_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('business_license_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                                    <option v-for="(country,index) in countries" :value="index">{{country}}</option>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Zip Code/ Postal Code:</label> 
                                                            <input v-model="form.business_license_zip_code" 
                                                                type="phone" 
                                                                name="business_license_zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_zip_code') }"/>
                                                                 <has-error :form="form" field="business_license_zip_code"></has-error> 
                                                        </div>  
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-4 col-sm-12 col-xs-12">
                                                <div class="form-box-outer">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.business_license_email" 
                                                                type="email" 
                                                                name="business_license_email" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_email') }"/>
                                                                 <has-error :form="form" field="business_license_email"></has-error>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.business_license_fax_no" 
                                                                type="text" 
                                                                name="business_license_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_fax_no') }"/>
                                                                 <has-error :form="form" field="business_license_fax_no"></has-error> 
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Phone:</label> 
                                                           <input v-model="form.business_license_cell_phone" 
                                                                type="text" 
                                                                name="business_license_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_cell_phone') }"/>
                                                                 <has-error :form="form" field="business_license_cell_phone"></has-error>
                                                        </div>
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.business_license_website" 
                                                                type="url" 
                                                                name="business_license_website" 
                                                                :class="{ 'is-invalid': form.errors.has('business_license_website') }"/>
                                                                 <has-error :form="form" field="business_license_website"></has-error>
                                                        </div>
                                                ...
                                                <div class="form-box-outer">
                                                    ...
                                                    <div class="form-holder">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <date-picker 
                                                                style="width:100%"
                                                                v-model="form.business_license_issue_date"
                                                                name="business_license_issue_date"
                                                                lang="en"
                                                                type="business_license_issue_date"
                                                                format="DD MMM, YYYY"
                                                                :class="{ 'is-invalid': form.errors.has('business_license_issue_date') }">
                                                            </date-picker>
                                                            <has-error :form="form" field="business_license_issue_date"></has-error> 
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12" >
                                                            ...
                                                            <div class="row"> 
                                                                <div class="col-md-7 col-sm-12 col-xs-12" style="padding:0">
                                                                    <date-picker 
                                                                        style="width:100%"
                                                                        v-model="form.business_license_expire_date"
                                                                        name="business_license_expire_date"
                                                                        lang="en"
                                                                        type="business_license_expire_date"
                                                                        format="DD MMM, YYYY"
                                                                        :class="{ 'is-invalid': form.errors.has('business_license_expire_date') }">
                                                                    </date-picker>
                                                                    <has-error :form="form" field="business_license_expire_date"></has-error> 
                                                                </div>
                                                                <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0">
                                                                    <div class="form-check-inline">
                                                                         ...
                                                                         <button 
                                                                            ...
                                                                            @click="business_license_add_calender(2,index)" 
                                                                            v-if="form.business_license_is_callender">Remove From Calender</button>

                                                                        <button 
                                                                            style="padding: .375rem"
                                                                            type="button" 
                                                                            class="btn  btn-primary" 
                                                                            @click="business_license_add_calender(1,index)" 
                                                            ...
                                                            <div class="position-relative form-group">
                                                                <select v-model="form.business_license_validation_status"
                                                                    name="business_license_validation_status"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('business_license_validation_status') }">
                                                                    <option disabled value="">--Select-- </option>
                                ...
                                <div class="form-folder">
                                    <h3><i class="fa fa-hand-point-right"></i>Professional Licence:
                                                ...
                                                <div class="form-box-outer">
                                                    ...
                                                    <div class="form-holder">
                                                        ...
                                                        <div class="col-md-12 col-sm-12 col-xs-12">
                                                            ...
                                                            <date-picker 
                                                                style="width:100%"
                                                                v-model="form.professional_license_issue_date"
                                                                name="professional_license_issue_date"
                                                                lang="en"
                                                                type="professional_license_issue_date"
                                                                format="DD MMM, YYYY"
                                                                :class="{ 'is-invalid': form.errors.has('professional_license_issue_date') }">
                                                            </date-picker>
                                                            <has-error :form="form" field="professional_license_issue_date"></has-error> 
                                                                ...
                                                                <div class="col-md-5 col-sm-12 col-xs-12" style="padding:0">
                                                                    <div class="form-check-inline">
                                                                         ...
                                                                         <button 
                                                                            ...
                                                                            type="button" 
                                                                            class="btn  btn-warning"
                                                                            @click="professional_license_add_calender(2,index)" 
                                                                            v-if="form.professional_license_is_callender">Remove From Calender</button>

                                                                        <button 
                                                                            style="padding: .375rem"
                                                                            type="button" 
                                                                            class="btn  btn-primary" 
                                                                            @click="professional_license_add_calender(1,index)" 
                                                                            v-else>Add To Calender</button>
                                                                    </div>
