                    ...
                    <datatable :columns="columns" :data="rows" :filter-by="filter">
                        <template slot-scope="{row}">
                            <tr>
                                ...
                                <td width="120">
                                    <button class="btn btn-primary btn-sm"  @click.prevent="editSupportingRooms(row.id)">Edit</button>
                                    <button  class="btn btn-danger btn-sm" @click.prevent="SupportingRoomDelete(row.id)">Delete</button>
                                </td>
                            </tr>
                        </template>
                    </datatable>
                                ...
                                <div class="col-md-12 col-sm-12 col-xs-12"  style="margin-bottom:20px"> 
                                    <div class="form-box-outer">
                                        ...
                                        <table class="table table_narrow" >
                                            ...
                                            <thead>
                                                <tr style="background-color:rgb(0, 112, 192) !important">
                                                    <th scope="col" width="30%">UOM</th>
                                                    <th scope="col" width="15%" colspan="2">
                                            ...
                                            <tbody>
                                                ...
                                                <template v-if="form.total_mechanical_room>0">
                                                    <tr style="background-color:rgb(0, 112, 192) !important;color:#fff">
                                                        <td scope="col" width="30%">Mechanical  Room</td>
                                                        <td scope="col" width="15%">Property ID</td>
                                                        <td scope="col" width="20%">Property Name</td>
                                                        <td scope="col" width="15%">UOM</td>
                                                        <td scope="col" width="20%">Size</td>                                         
                                                    </tr>
                                                    <template v-for="(single_subroom,index) in form.subrooms_list_arr" v-if="single_subroom.item_type==7">
                                                                                                          
                                                        <tr >
                                                            <td width="30%" scope="row" style="padding-left:5% !important"><strong>{{single_subroom.item_name}}</strong></td>
                                                            <td width="15%">
                                                ...
                                                <template v-if="form.total_administrative_room>0">
                                                    <tr style="background-color: rgba(0,112,192);color:#fff">
                                                        <td scope="col" width="30%">Administrative Room</td>
                                                        <td scope="col" width="15%">Property ID</td>
                                                        <td scope="col" width="20%">Property Name</td>
                                                        <td scope="col" width="15%">UOM</td>
                                                        <td scope="col" width="20%">Size</td>                                                
                                                    </tr>
                                                    <template v-for="(single_subroom,index) in form.subrooms_list_arr" v-if="single_subroom.item_type==8">
                                                ...
                                                <template v-if="form.total_amenity_room>0">
                                                    <tr style="background-color:rgb(0, 112, 192) !important;color:#fff">
                                                        <td scope="col" width="30%">Aminity  Room</td>
                                                        <td scope="col" width="15%">Property ID</td>
                                                        <td scope="col" width="20%">Property Name</td>
                                                        <td scope="col" width="15%">UOM</td>
                                                        <td scope="col" width="20%">Size</td>                                                
                                                    </tr>
                                                    <template v-for="(single_subroom,index) in form.subrooms_list_arr" v-if="single_subroom.item_type==9">
                                                ...
                                                <template v-if="form.total_service_room>0">
                                                    <tr style="background-color: rgb(0, 112, 192) !important;color:#fff">
                                                        <td scope="col" width="30%">Service  Room</td>
                                                        <td scope="col" width="15%">Property ID</td>
                                                        <td scope="col" width="20%">Property Name</td>
                                                        <td scope="col" width="15%">UOM</td>
                                                        <td scope="col" width="20%">Size</td>                                                
                                                    </tr>
                                                    <template v-for="(single_subroom,index) in form.subrooms_list_arr" v-if="single_subroom.item_type==10">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><strong>{{form.total_mechanical_room_size}}</strong></td>
                                                </tr>
                                              </tfoot>
                                        </table> 
                                    </div>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ...
                form:new Form({
                    ...
                    total_mechanical_room_size:'',
                    total_amenity_room:'',
                    total_total_amenity_room_size:'',
                    total_administrative_room:'',
                    total_administrative_room_size:'',
                    total_service_room:'',
                    total_service_room_size:'',
                    total_room_size:'',
        ...
        methods: {
            ...
            editSupportingRooms(id)
            {
                this.form.reset ();
                this.tempeditmode=true;
                this.list_showable=false;
                let uri = '/SupportingRooms/'+id+'/edit';
                window.axios.get(uri).then((response) => {
                    ...
                    this.form.id                                =response.data.supporting_room_arr.id;
                    this.form.company_name                      =response.data.supporting_room_arr.company_name;
                    this.form.strata_lot_no                     =response.data.supporting_room_arr.strata_lot_no;
                    this.form.posting_status                    =response.data.supporting_room_arr.posting_status
                    this.form.building_name                     =response.data.supporting_room_arr.building_name;
                    
                    this.form.floor_no                          =response.data.supporting_room_arr.floor_no;
                    this.form.system_no                         =response.data.supporting_room_arr.system_no;
                    ...
                    this.form.total_mechanical_room         =response.data.total_mechanical_room;
                    this.form.total_amenity_room            =response.data.total_amenity_room;
                    this.form.total_administrative_room     =response.data.total_administrative_room;
            ...
            change_room_size()
            {
                ...
                this.form.total_mechanical_room_size=total_subroom_size;
            ...
            reset_list()
            {
                this.form.reset();
                this.editmode=false;
                let uri = '/SupportingRoomLists';
                window.axios.get(uri).then((response) => {
                    this.rows = response.data.supporting_room_list;
                });
            ...
            change_building()
            {
                ...
                let uri = '/subroomFloorByBuilding/'+this.form.building_name;
                window.axios.get(uri).then((response) => {
            ...
            change_floor()
            {
                ...
                let uri = '/loadSubroomsByFloor/'+this.form.floor_no;
                window.axios.get(uri).then((response) => {
            ...
            { 
                ...
                Swal.fire({
                    ...
                    this.form.post('/SupportingRoomPost/'+this.form.id).then((response)=>{
            ...
            {            
                Swal.fire({
                    ...
                    this.form.post('/SupportingRoomRepost/'+this.form.id).then((response)=>{
            ...
            { 
                ...
                this.form.post('/adjustSupportingRoom/'+this.form.id).then((response)=>{
                    var response_data=response.data.split("**");
                    if(response_data[0]==1)
                    {
                        toast({
            ...
            updateSupportingRoomInfo()
            { 

                
                this.form.put('/SupportingRooms/'+this.form.id).then(({ data })=>{
                    var response_data=data.split("**");
                    if(response_data[0]==1)
                    {
                         toast({
            ...
            save_stay(type){
               ...
               this.form.post('/SupportingRooms') .then(({ data }) => { 
                    var response_data=data.split("**");
                    if(response_data[0]==1)
                    {
                         toast({
