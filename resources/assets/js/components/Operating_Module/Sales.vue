            ...
            <form id="msform" @submit.prevent="editmode ? updateSalesOffers() : createCompanyProfile()" @keydown="form.onKeydown($event)">
                <div class="form-card" style="padding:0"> 
                    <div class="text-center">
                        ...
                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step==0 && sales_page==4" @click="convert_to_invoice(form.id)">Convert To Purchase Invoice</button>

                        <button :disabled="form.busy"  type="button" class="btn  btn-primary" style="min-width:110px" v-show="(form.posting_status==1 || form.posting_status==3) && form.next_step!=1 && sales_page==8" @click="convert_to_direct_payment(form.id)">Convert To Direct Payment</button>
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>
                                    ...
                                    <td width="120">
                                        <button class="btn btn-primary btn-sm"  @click.prevent="editSalesOffers(row.id)">Edit</button>
                            ...
                            <div class="row align-self-stretch">
                                <div class="col-md-4 col-sm-6 col-xs-12">
                                    <div class="form-box-outer">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                <label class="fieldlabels">Purchase Type :</label> 
                                                <select v-model="form.sale_types"
                                                    name="sales_type"
                                                    class="custom-select"
                    ...
                    <div class="text-center" v-if="!list_showable">
                        ...
                        <button :disabled="form.busy || form.posting_status!=1 || form.posting_status!=2"  type="button" class="btn  btn-primary" style="min-width:110px"  @click="adjust()">Adjust</button>

                        <button :disabled="form.busy || form.posting_status!=2"  type="button" class="btn  btn-primary" style="min-width:110px" @click="repost()">RePost</button>
    ...
    export default {
        ...
        data(){
            return{
                ...
                service_columns: [
                    ...
                    { label: 'Purchase Tax', field: 'sales_tax' },
        ...
        methods: {
                ...
                Swal.fire({
                    ...
                    this.form.post('/SalesOfferPost/'+this.form.id).then((response)=>{
                        ...
                        { 
                            ...
                            {
                                this.editSalseReturns(response_data[1]);
                            }
            ...
            { 
                ...
                else if(this.sales_page==2)  uri="/PurchaseOfferAcceptances/"+this.form.id;
                ...
                else if(this.sales_page==9)  uri="/SaleDirectPayments/"+this.form.id;
                ...
                else if(this.sales_page==2)
                {
                    ...
                    this.form.post(uri) .then(({ data }) => { 
                        ...
                        if(response_data[0]==1)
                        {
                            ...
                            if(type==1)
                            {
                                this.editOfferAcceptances(response_data[1]);
                                this.editmode=true;
                            }
                            else if(type==2)
                            {
