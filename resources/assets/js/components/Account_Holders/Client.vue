    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Client Profile</h1> 
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Client Information:</h3> 
...
data(){
    return{
        ...
        columns: [
            ...
            { label: 'Client Type', field: 'client_type' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHoldersClient/' + this.recordId, this.form)
        .then(response => {
