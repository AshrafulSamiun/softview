    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Private Loan Lender Profile</h1> 
                        ...
                        <datatable :columns="columns" :data="rows" :filter-by="filter">
                            <template slot-scope="{row}">
                                <tr>  
                                    ...
                                    <td>{{ row.privateloanlender_name }}</td>
                                    <td>{{ row.company_name }}</td>
                                    <td>{{ row.privateloanlender_email }}</td>
                                    <td>{{ row.privateloanlender_cell_phone }}</td>
                                    <td>{{ row.privateloanlender_country }}</td>
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Private Loan Lender Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        <div class="form-box-outer"> 
                                            ...
                                            <has-error :form="form" 
                                            <label class="fieldlabels">Private Loan Lender  Name:</label>
                                            <input 
                                                v-model="form.privateloanlender_name" 
                                                type="text" 
                                                name="privateloanlender_name" 
                                                placeholder="Type privateloanlender Name" 
                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_name') }"/>
                                            <has-error :form="form" field="privateloanlender_name"></has-error> 
                                            <label class="fieldlabels">Private Loan Lender  Photo:</label> 
                                            <input 
                                                v-model="form.privateloanlender_photo" 
                                                type="text" 
                                                name="privateloanlender_photo" 
                                                placeholder="Type Photo" 
                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_photo') }"/>
                                            <has-error :form="form" field="privateloanlender_photo"></has-error> 
                                           
                                                        <h4>Private Loan Lender Contact</h4> 
                                                            <label class="fieldlabels">Office Phone:</label> 
                                                           <input v-model="form.privateloanlender_office_phone" 
                                                                type="text" 
                                                                name="privateloanlender_office_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_office_phone') }"/>
                                                                 <has-error :form="form" field="privateloanlender_office_phone"></has-error>
                                                        
                                                         
                                                            <label class="fieldlabels">Moblile Number:</label> 
                                                           <input v-model="form.privateloanlender_cell_phone" 
                                                                type="text" 
                                                                name="privateloanlender_cell_phone" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_cell_phone') }"/>
                                                                 <has-error :form="form" field="privateloanlender_cell_phone"></has-error>
                                                         
                                                            <label class="fieldlabels">Email:</label> 
                                                            <input v-model="form.privateloanlender_email" 
                                                                type="privateloanlender_email" 
                                                                name="privateloanlender_email" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_email') }"/>
                                                                 <has-error :form="form" field="privateloanlender_email"></has-error>
                                                        
                                                            <label class="fieldlabels">Fax:</label> 
                                                            <input v-model="form.privateloanlender_fax_no" 
                                                                type="text" 
                                                                name="privateloanlender_fax_no" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_fax_no') }"/>
                                                                 <has-error :form="form" field="privateloanlender_fax_no"></has-error> 
                                                        
                                                            <label class="fieldlabels">Website :</label> 
                                                            <input v-model="form.privateloanlender_website" 
                                                                type="url" 
                                                                name="privateloanlender_website" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_website') }"/>
                                                                 <has-error :form="form" field="privateloanlender_website"></has-error>
                                             


                                                        <h4>Private Loan Lender Address</h4> 
                                                            <label class="fieldlabels"> House Number:</label> 
                                                            <input v-model="form.privateloanlender_house_number" 
                                                                type="phone" 
                                                                name="privateloanlender_house_number" 
                                                                placeholder="Type  House/Office Number" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_house_number') }"/>
                                                                 <has-error :form="form" field="privateloanlender_house_number"></has-error> 
                                                        
                                                         
                                                            <label class="fieldlabels"> Street Number:</label> 
                                                            <input v-model="form.privateloanlender_street_number" 
                                                                type="text" 
                                                                name="privateloanlender_street_number" 
                                                                placeholder="Type  Street Number" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_street_number') }"/>
                                                                 <has-error :form="form" field="privateloanlender_street_number"></has-error> 
                                                       
                                                        
                                                        
                                                            <label class="fieldlabels"> City:</label> 
                                                            <input v-model="form.privateloanlender_city" 
                                                                type="text" 
                                                                name="privateloanlender_city" 
                                                                placeholder="Type  City" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_city') }"/>
                                                                 <has-error :form="form" field="privateloanlender_city"></has-error> 
                                                        
                                                        
                                                            <label class="fieldlabels"> State:</label> 
                                                            <input v-model="form.privateloanlender_state" 
                                                                type="text" 
                                                                name="privateloanlender_state" 
                                                                placeholder="Type  State" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_state') }"/>
                                                                 <has-error :form="form" field="privateloanlender_state"></has-error>
                                                        
                                                        
                                                            <label class="fieldlabels">Country:</label> 
                                                            <div class="position-relative form-group">
                                                                 <select v-model="form.privateloanlender_country"
                                                                    name="privateloanlender_country"
                                                                    class="custom-select" 
                                                                    :class="{ 'is-invalid': form.errors.has('privateloanlender_country') }">
                                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <input v-model="form.privateloanlender_zip_code" 
                                                                type="phone" 
                                                                name="zip_code" 
                                                                placeholder="Type Zip Code/ Postal Code" 
                                                                :class="{ 'is-invalid': form.errors.has('privateloanlender_zip_code') }"/>
                                                                 <has-error :form="form" field="privateloanlender_zip_code"></has-error> 
...
data(){
    return{
        ...
        form:new Form({
            account_type:21, 
            privateloanlender_name:'',
            privateloanlender_photo:'', 
            privateloanlender_office_phone:'',
            privateloanlender_cell_phone:'',
            privateloanlender_email:'',
            privateloanlender_fax_no:'',
            privateloanlender_website:'', 
            privateloanlender_house_number:'',
            privateloanlender_street_number:'',
            privateloanlender_city:'',
            privateloanlender_state:'',
            privateloanlender_country:'',
            privateloanlender_zip_code:'',
            company_name:'',
            company_logo:'',
            industry_sector:'',
        ...
        columns: [
            ...
            { label: 'privateloanlender Name', field: 'privateloanlender_name' },
            { label: 'Company Name', field: 'company_name' },
            { label: 'Email', field: 'privateloanlender_email' },
            { label: 'Mobile No', field: 'privateloanlender_cell_phone' },
            { label: 'Country', field: 'privateloanlender_country' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHolderPrivateLoanLender/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderPrivateLoanLenderLists';
    ...
    fetchAccountHolder()
    {
        let uri = '/AccountHolderPrivateLoanLender';
        window.axios.get(uri).then((response) => {
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHolderPrivateLoanLender/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHolderPrivateLoanLender') .then(({ data }) => { 
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHolderPrivateLoanLender/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                    ...
                    this.form.privateloanlender_name=response.data.account_holder.privateloanlender_name;
                    this.form.privateloanlender_photo=response.data.account_holder.privateloanlender_photo;


                    this.form.privateloanlender_office_phone=response.data.account_holder.privateloanlender_office_phone;
                    this.form.privateloanlender_cell_phone=response.data.account_holder.privateloanlender_cell_phone;
                    this.form.privateloanlender_state=response.data.account_holder.privateloanlender_state;
                    this.form.privateloanlender_email=response.data.account_holder.privateloanlender_email;
                    this.form.privateloanlender_fax_no=response.data.account_holder.privateloanlender_fax_no;
                    this.form.privateloanlender_website=response.data.account_holder.privateloanlender_website;

                   

                    this.form.privateloanlender_house_number=response.data.account_holder.privateloanlender_house_number;
                    this.form.privateloanlender_street_number=response.data.account_holder.privateloanlender_street_number;
                    this.form.privateloanlender_city=response.data.account_holder.privateloanlender_city;
                    this.form.privateloanlender_state=response.data.account_holder.privateloanlender_state;
                    this.form.privateloanlender_country=response.data.account_holder.privateloanlender_country;
                    this.form.privateloanlender_zip_code=response.data.account_holder.privateloanlender_zip_code;
