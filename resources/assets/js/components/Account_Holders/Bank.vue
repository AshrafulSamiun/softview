                        ...
                        <div id="content">
                            ...
                            <div class="form-card" v-if="!list_showable">
                                        ...
                                        <div class="row align-self-stretch"> 
                                            <div class="col-md-4 col-sm-6 col-xs-12"> 
                                                <div class="form-box-outer"> 
                                                    ...
                                                    <label class="fieldlabels">Bank Account Type:</label> 
                                                        <div class="position-relative form-group">
                                                            <select v-model="form.bank_account_type"
                                                                name="bank_account_type"
                                                                class="custom-select" 
                                                                :class="{ 'is-invalid': form.errors.has('bank_account_type') }">
                                                                <option disabled value="">--Select-- </option>
                                                                <option value="1">Checking</option> 
                                                                <option value="2">Saving </option> 
                                                            </select>
                                                        <has-error :form="form" field="bank_account_type"></has-error> 
                                                        </div>  
                                ...
                                <div class="text-center" v-if="!list_showable">
                                    ...
                                    <button :disabled="form.busy || editmode==false || form.posting_status!=0"  type="button" class="btn  btn-primary" style="min-width:110px"  @click.prevent="deleteAccountHolder()">Delete</button>
...
<script>
    ...
    export default {
        ...
        data(){
            return{
                ...
                columns: [
                    ...
                    { label: 'Bank Acccount No', field: 'bank_acount_no' },
                    { label: 'Bank Acccount Name', field: 'bank_account_name' },
	    ...
	    methods: {
            ...
            submitForm() 
            {
                axios.put('/AccountHoldersBank/' + this.recordId, this.form)
                .then(response => {
            ...
            { 
                ...
                Swal.fire({
                    ...
                    this.form.post('/PrivateLoanPost/'+this.form.id).then((response)=>{
            ...
            {            
                Swal.fire({
                    ...
                    this.form.post('/PrivateLoanRepost/'+this.form.id).then((response)=>{
            ...
            { 
                ...
                this.form.post('/adjustPrivateLoan/'+this.form.id).then((response)=>{
                    var response_data=response.data.split("**");
                    if(response_data[0]==1)
                    {
                        toast({
               ...
               // alert(id);
                ...
                window.axios.get(uri).then((response) => {
                   ...
                   //alert(id)
                    ...
                    this.form.bank_account_type=response.data.account_holder.bank_account_type;
