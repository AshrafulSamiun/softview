    ...
    <div class="card"> 
        <form id="msform" @submit.prevent="editmode ? updateAccountHolder() : createAccountHolder()" @keydown="form.onKeydown($event)">  
            <fieldset>
                <div id="content">
                    <div class="form-card">
                        <h1 class="page-head">Dependents Profile</h1> 
                    ...
                    <div class="form-card" v-if="!list_showable">
                        <div class="form-folder">
                            <h3><i class="fa fa-hand-point-right"></i>Dependents Information:</h3> 
                                ...
                                <div class="row align-self-stretch"> 
                                    <div class="col-md-4 col-sm-6 col-xs-12"> 
                                        ...
                                        <input type="text" 
                                            ...
                                            <label class="fieldlabels">Dependents Title:</label>
                                            <input 
                                        ...
                                        <label class="fieldlabels">Dependents Name:</label>
                                        <input 
                                            v-model="form.dependents_name" 
                                            type="text" 
                                            name="dependents_name" 
                                            placeholder="Type Dependents Name" 
                                            :class="{ 'is-invalid': form.errors.has('dependents_name') }"/>
                                        <has-error :form="form" field="dependents_name"></has-error>
                                        <label class="fieldlabels">Dependents   Photo:</label> 
                                        <input 
                                            v-model="form.dependents_photo" 
                                            type="text" 
                                            name="dependents_photo" 
                                            placeholder="Type Photo" 
                                            :class="{ 'is-invalid': form.errors.has('dependents_photo') }"/>
                                        <has-error :form="form" field="dependents_photo"></has-error> 
                                        

                                        <label class="fieldlabels">Dependents Type:</label> 
                                            <div class="position-relative form-group">
                                                <select v-model="form.dependents_type"
                                                    name="dependents_type"
                                                    class="custom-select" 
                                                    :class="{ 'is-invalid': form.errors.has('dependents_type') }"> 
                                                    <option disabled value="">--Select-- </option>
                                                            ...
                                                            <option value="15">Wife</option> 
                                                            <option value="16">Other</option>  
                                                </select>
                                                <has-error :form="form" field="dependents_type"></has-error> 
                                            </div> 
...
data(){
    return{
        ...
        columns: [
            ...
            { label: 'Dependents Name', field: 'dependents_name' },
            { label: 'Dependents Type', field: 'dependents_type' },
...
methods: {
    ...
    submitForm() 
    {
        axios.put('/AccountHoldersdependents/' + this.recordId, this.form)
        .then(response => {
    ...
    reset_list()
    {
        this.form.reset();
        this.editmode=false;
        let uri = '/AccountHolderdependentsLists';
    ...
    fetchAccountHolder()
    {
        let uri = '/AccountHoldersdependents';
        window.axios.get(uri).then((response) => {
    ...
    updateAccountHolder()
    {
        ...
        this.form.put('/AccountHoldersdependents/'+this.form.id).then(({ data })=>{
    ...
    createAccountHolder()
    {
        ...
        this.form.post('/AccountHoldersdependents') .then(({ data }) => { 
    ...
    {            
          ...
          Swal.fire({
            ...
            confirmButtonText: 'Yes, delete it!'
              ...
              this.form.delete('/AccountHoldersdependents/'+this.form.id).then(()=>{
    ...
    editAccountHolder(id)
    {
        this.form.reset();
        this.list_showable=false;
        let uri = '/AccountHoldersdependents/'+id+'/edit';
        window.axios.get(uri).then((response) => {
                   ...
                   this.form.id=response.data.account_holder.id;
                    ...
                    this.form.dependents_name=response.data.account_holder.dependents_name;
                    this.form.dependents_type=response.data.account_holder.dependents_type;  
                    ...
                    this.form.dependents_photo=response.data.account_holder.dependents_photo; 
