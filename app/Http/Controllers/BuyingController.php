...
class BuyingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $max_system_data = Purchase::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from purchases 
            where project_id=".$project_id."  and company_id=".$company_id." and  company_type=".$company_type.") 
            and company_type=".$company_type."  and project_id=".$project_id)->get(['system_prefix']);
