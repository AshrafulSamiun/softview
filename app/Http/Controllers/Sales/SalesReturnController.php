...
class SalesReturnController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $system_no="SR-".str_pad($max_system_prefix, 5, 0, STR_PAD_LEFT);
    ...
    public function edit($id)
    {
        ...
        foreach ($sales_acceptance_list as $key => $value) {
            ...
            foreach($sales_list as $val)
            {
                ...
                // else if($val->entry_form==6)
                // {
                //     $data['sales_offer_list']['sales_return_no']             =date("D M d, Y",strtotime($sales_offer_list->created_at));
                //     $data['sales_offer_list']['sales_return_date']               =$sales_offer_list->transaction_no;
                // }
                // else if($val->entry_form==7)
                // {
                //     $data['sales_offer_list']['sales_offer_date']             =date("D M d, Y",strtotime($sales_offer_list->created_at));
                //     $data['sales_offer_list']['sales_offer_no']               =$sales_offer_list->transaction_no;
                // }
                // else if($val->entry_form==8)
                // {
                //     $data['sales_offer_list']['sales_offer_date']             =date("D M d, Y",strtotime($sales_offer_list->created_at));
            ...
            $data['sales_offer_list']['sales_return_date']               =date("D M d, Y",strtotime($value->created_at));
            $data['sales_offer_list']['sales_return_no']              =$value->transaction_no;
