...
class SalesOfferAcceptanceController extends Controller
{
    /**
    ...
    public function SalesOfferAcceptanceList( Request $request)
    {
    ...
    public function store(Request $request)
    {
        ...
        $system_no="SOA-".str_pad($max_system_prefix, 5, 0, STR_PAD_LEFT);
    ...
    public function edit($id)
    {
        ...
        foreach ($sales_acceptance_list as $key => $value) {
            ...
            $data['sales_offer_list']['sales_offer_acceptance_date']  =date("D M d, Y",strtotime($value->created_at));
            ...
            $data['sales_offer_list']['sales_offer_acceptance_date']        =date("D M d, Y",strtotime($value->created_at));
            $data['sales_offer_list']['sales_offer_acceptance_no']          =$value->transaction_no;
