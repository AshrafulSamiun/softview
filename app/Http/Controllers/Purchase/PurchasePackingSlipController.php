...
class PurchasePackingSlipController extends Controller
{
    /**
    ...
    public function PurchasePackingSlipList( Request $request)
    {
    ...
    public function store(Request $request)
    {
        ...
        $system_no="PPS-".str_pad($max_system_prefix, 5, 0, STR_PAD_LEFT);
    ...
    public function edit($id)
    {
        ...
        foreach ($purchase_acceptance_list as $key => $value) {
            ...
            $data['purchase_offer_list']['next_step_return']                =$value->next_step_return;
            $data['purchase_offer_list']['next_step_debit']                 =$value->next_step_debit;
            $data['purchase_offer_list']['next_step_credit']                =$value->next_step_credit;
            ...
            $data['purchase_offer_list']['packing_slip_no']                 =date("D M d, Y",strtotime($value->created_at));
            $data['purchase_offer_list']['packing_slip_date']               =$value->transaction_no;
