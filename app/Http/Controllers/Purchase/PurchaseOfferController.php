...
class PurchaseOfferController extends Controller
{
    ...
    public function index()
    {
        ...
        $report_data = DB::table('purchases')
        ...
        $data['total_purchase_packaing_slip_qty']=0; 
        $data['total_purchase_return_qty']=0; 
        $data['total_debit_note_qty']=0; 
        $data['total_credit_note_qty']=0; 
        $data['total_purchase_invoice_qty']=0; 
        $data['total_direct_payment_qty']=0; 

        foreach ($report_data as $key => $value) {
            if($value->entry_form==1)
                $data['total_purchase_offer_qty']            =$value->number_of_rows; 
            if($value->entry_form==2)
                $data['total_purchase_offer_acceptance_qty'] =$value->number_of_rows; 
            if($value->entry_form==3)
                $data['total_purchase_order_qty']            =$value->number_of_rows; 
            if($value->entry_form==4)
                $data['total_purchase_packaing_slip_qty']    =$value->number_of_rows; 
            if($value->entry_form==5)
                $data['total_purchase_return_qty']           =$value->number_of_rows; 
                ...
                $data['total_purchase_invoice_qty']          =$value->number_of_rows; 
    ...
    public function PurchaseOfferList( Request $request)
    {
    ...
    public function store(Request $request)
    {
        ...
        $system_no="POF-".str_pad($max_system_prefix, 5, 0, STR_PAD_LEFT);
    ...
    public function edit($id)
    {
        ...
        foreach ($purchase_offer_list as $key => $value) {
            ...
            $data['purchase_offer_list']['purchase_offer_no']               =$value->transaction_no;
            ...
            $data['purchase_offer_list']['purchase_offer_date']             =date("D M d, Y",strtotime($value->created_at));
