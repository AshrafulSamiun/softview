...
class PurchaseCreditNoteController extends Controller
{
    ...
    public function PurchaseCreditList( Request $request)
    {
    ...
    public function store(Request $request)
    {
        ...
        $system_no="PCN-".str_pad($max_system_prefix, 5, 0, STR_PAD_LEFT);
    ...
    public function edit($id)
    {
        ...
        foreach ($purchase_acceptance_list as $key => $value) {
            ...
            $data['purchase_offer_list']['purchase_credit_note_date']       =date("D M d, Y",strtotime($value->created_at));
            $data['purchase_offer_list']['purchase_credit_note_no']         =$value->transaction_no;
