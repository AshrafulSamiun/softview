...
class PurchaseDebitNoteController extends Controller
{
    ...
    public function PurchaseDebitList( Request $request)
    {
    ...
    public function edit($id)
    {
        ...
        foreach ($purchase_acceptance_list as $key => $value) {
            ...
            $data['purchase_offer_list']['purchase_debit_note_date']        =date("D M d, Y",strtotime($value->created_at));
            $data['purchase_offer_list']['purchase_debit_note_no']          =$value->transaction_no;
