...
use App\AccountHolderBoardOfDirector;
use App\User;
...
class AccountHolderBoardOfDirectorController extends Controller
{
       ...
       { 
        ...
        request()->validate([
           ...
           // 'email'                         =>"required",
            ...
            'board_of_director_name_title'                 =>"required",
            'email' => [
                'required',
                'email',
                'max:255',
    ...
    {
        $AccountHolder_delete=AccountHolderBoardOfDirector::find($id)->update(array('is_deleted' => 1,'status_active' => 0));
        $User_delete=User::where('account_holder_id',$id)->where('user_type',6)->update(array('status_active' => 0));
