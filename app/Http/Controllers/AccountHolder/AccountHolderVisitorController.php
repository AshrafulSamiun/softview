...
class AccountHolderVisitorController extends Controller
{
    ...
    public function AccountHolderVisitorLists()
    {
        ...
        $sl=0;
        $account_holder_list=AccountHolderVisitor::where('status_active',1)
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['visitor_name']                 =$value->visitor_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['visitor_photo']                 =$value->visitor_photo; 
            $data['account_holder_list'][$key]['visitor_office_phone']             =$value->visitor_office_phone; 
            $data['account_holder_list'][$key]['visitor_cell_phone']                 =$value->visitor_cell_phone; 
            $data['account_holder_list'][$key]['visitor_email']                 =$value->visitor_email; 
            $data['account_holder_list'][$key]['visitor_fax_no']                 =$value->visitor_fax_no; 
            $data['account_holder_list'][$key]['visitor_website']                 =$value->visitor_website; 
            $data['account_holder_list'][$key]['visitor_house_number']                 =$value->visitor_house_number; 
            $data['account_holder_list'][$key]['visitor_street_number']                 =$value->visitor_street_number; 
            $data['account_holder_list'][$key]['visitor_city']                 =$value->visitor_city; 
            $data['account_holder_list'][$key]['visitor_state']                 =$value->visitor_state; 
            

            $data['account_holder_list'][$key]['visitor_country']                  =$country_arr[$value->visitor_country];
            $data['account_holder_list'][$key]['visitor_zip_code']                 =$value->visitor_zip_code; 
    ...
    public function store(Request $request)
    {
        ...
        request()->validate([
            ...
            'visitor_office_phone'=>"required",
            'visitor_cell_phone'=>"required",
            'visitor_email'=>"required",
            'visitor_fax_no'=>"required",
            'visitor_website'=>"required",
            'visitor_house_number'=>"required",
            'visitor_street_number'=>"required",
            'visitor_city'=>"required", 
            'visitor_state'=>"required",
            'visitor_country'=>"required",
            'visitor_zip_code'=>"required",
        ...
        $max_system_data = AccountHolderVisitor::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_visitors 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderVisitor::create($request->all());
