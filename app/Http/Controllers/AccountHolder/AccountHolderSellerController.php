...
class AccountHolderSellerController extends Controller
{
    ...
    public function AccountHolderSellerLists()
    {
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['seller_name']                 =$value->seller_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['seller_photo']                 =$value->seller_photo; 
            $data['account_holder_list'][$key]['seller_office_phone']             =$value->seller_office_phone; 
            $data['account_holder_list'][$key]['seller_cell_phone']                 =$value->seller_cell_phone; 
            $data['account_holder_list'][$key]['seller_email']                 =$value->seller_email; 
            $data['account_holder_list'][$key]['seller_fax_no']                 =$value->seller_fax_no; 
            $data['account_holder_list'][$key]['seller_website']                 =$value->seller_website; 
            $data['account_holder_list'][$key]['seller_house_number']                 =$value->seller_house_number; 
            $data['account_holder_list'][$key]['seller_street_number']                 =$value->seller_street_number; 
            $data['account_holder_list'][$key]['seller_city']                 =$value->seller_city; 
            $data['account_holder_list'][$key]['seller_state']                 =$value->seller_state;  
            $data['account_holder_list'][$key]['seller_country']                  =$country_arr[$value->seller_country];
            $data['account_holder_list'][$key]['seller_zip_code']                 =$value->seller_zip_code;  
    ...
    public function store(Request $request)
    {
       ...
       { 
        ...
        request()->validate([
            ...
            'seller_photo'=>"required",
            'seller_office_phone'=>"required",
            'seller_cell_phone'=>"required",
            'seller_email'=>"required",
            'seller_fax_no'=>"required",
            'seller_website'=>"required",
            'seller_house_number'=>"required",
            'seller_street_number'=>"required",
            'seller_city'=>"required", 
            'seller_state'=>"required",
            'seller_country'=>"required",
            'seller_zip_code'=>"required",
        ...
        $max_system_data = AccountHolderSeller::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_sellers 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderSeller::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        //dd($max_system_prefix);die;
        DB::beginTransaction();
        $account_holder_info= AccountHolderSeller::find($id)->update($request->all());
    ...
    {
        $AccountHolder_delete=AccountHolderSeller::find($id)->update(array('is_deleted' => 1,'status_active' => 0));
        $User_delete=User::where('account_holder_id',$id)->where('user_type',3)->update(array('status_active' => 0));
