...
use App\Models\AccountHolderPrivateLoanLender;
...
class AccountHolderPrivateLoanLenderController extends Controller
{
    ...
    public function AccountHolderPrivateLoanLenderLists()
    {
        ...
        $sl=0;
        $account_holder_list=AccountHolderPrivateLoanLender::where('status_active',1)
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['privateloanlender_name']                 =$value->privateloanlender_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['privateloanlender_photo']                 =$value->privateloanlender_photo; 
            $data['account_holder_list'][$key]['privateloanlender_office_phone']             =$value->privateloanlender_office_phone; 
            $data['account_holder_list'][$key]['privateloanlender_cell_phone']                 =$value->privateloanlender_cell_phone; 
            $data['account_holder_list'][$key]['privateloanlender_email']                 =$value->privateloanlender_email; 
            $data['account_holder_list'][$key]['privateloanlender_fax_no']                 =$value->privateloanlender_fax_no; 
            $data['account_holder_list'][$key]['privateloanlender_website']                 =$value->privateloanlender_website; 
            $data['account_holder_list'][$key]['privateloanlender_house_number']                 =$value->privateloanlender_house_number; 
            $data['account_holder_list'][$key]['privateloanlender_street_number']                 =$value->privateloanlender_street_number; 
            $data['account_holder_list'][$key]['privateloanlender_city']                 =$value->privateloanlender_city; 
            $data['account_holder_list'][$key]['privateloanlender_state']                 =$value->privateloanlender_state; 
            

            $data['account_holder_list'][$key]['privateloanlender_country']                  =$country_arr[$value->privateloanlender_country];
            $data['account_holder_list'][$key]['privateloanlender_zip_code']                 =$value->privateloanlender_zip_code; 
    ...
    public function store(Request $request)
    {
       ...
       { 
        ...
        request()->validate([
            ...
            'privateloanlender_name'=>"required",
            'privateloanlender_photo'=>"required",
            'privateloanlender_office_phone'=>"required",
            'privateloanlender_cell_phone'=>"required",
            'privateloanlender_email'=>"required",
            'privateloanlender_fax_no'=>"required",
            'privateloanlender_website'=>"required",
            'privateloanlender_house_number'=>"required",
            'privateloanlender_street_number'=>"required",
            'privateloanlender_city'=>"required", 
            'privateloanlender_state'=>"required",
            'privateloanlender_country'=>"required",
            'privateloanlender_zip_code'=>"required",
        ...
        $max_system_data = AccountHolderPrivateLoanLender::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_private_loan_lenders 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderPrivateLoanLender::create($request->all());

        $userRaw=User::create([
            'name'          => $request->input('privateloanlender_name'),
            'email'         => $request->input('privateloanlender_email'),
    ...
    public function update(Request $request, $id)
    {
        ...
        //dd($max_system_prefix);die;
        DB::beginTransaction();
        $account_holder_info= AccountHolderPrivateLoanLender::find($id)->update($request->all());
    ...
    {
        $AccountHolder_delete=AccountHolderPrivateLoanLender::find($id)->update(array('is_deleted' => 1,'status_active' => 0));
