...
use App\Models\AccountHolderInvestor;
...
class AccountHolderInvestorController extends Controller
{
    ...
    public function AccountHolderInvestorLists()
    {
        ...
        $sl=0;
        $account_holder_list=AccountHolderInvestor::where('status_active',1)
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['investor_name']                 =$value->investor_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['investor_photo']                 =$value->investor_photo; 
            $data['account_holder_list'][$key]['investor_office_phone']             =$value->investor_office_phone; 
            $data['account_holder_list'][$key]['investor_cell_phone']                 =$value->investor_cell_phone; 
            $data['account_holder_list'][$key]['investor_email']                 =$value->investor_email; 
            $data['account_holder_list'][$key]['investor_fax_no']                 =$value->investor_fax_no; 
            $data['account_holder_list'][$key]['investor_website']                 =$value->investor_website; 
            $data['account_holder_list'][$key]['investor_house_number']                 =$value->investor_house_number; 
            $data['account_holder_list'][$key]['investor_street_number']                 =$value->investor_street_number; 
            $data['account_holder_list'][$key]['investor_city']                 =$value->investor_city; 
            $data['account_holder_list'][$key]['investor_state']                 =$value->investor_state; 
            

            $data['account_holder_list'][$key]['investor_country']                  =$country_arr[$value->investor_country];
            $data['account_holder_list'][$key]['investor_zip_code']                 =$value->investor_zip_code; 
    ...
    public function store(Request $request)
    {
       ...
       { 
        ...
        request()->validate([
            ...
            'investor_photo'=>"required",
            'investor_office_phone'=>"required",
            'investor_cell_phone'=>"required",
            'investor_email'=>"required",
            'investor_fax_no'=>"required",
            'investor_website'=>"required",
            'investor_house_number'=>"required",
            'investor_street_number'=>"required",
            'investor_city'=>"required", 
            'investor_state'=>"required",
            'investor_country'=>"required",
            'investor_zip_code'=>"required",
        ...
        $max_system_data = AccountHolderInvestor::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_investors 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderInvestor::create($request->all());

        $userRaw=User::create([
            'name'          => $request->input('investor_name'),
            'email'         => $request->input('investor_email'),
    ...
    public function update(Request $request, $id)
    {
        ...
        //dd($max_system_prefix);die;
        DB::beginTransaction();
        $account_holder_info= AccountHolderInvestor::find($id)->update($request->all());
       // $userRaw=User::where('account_holder_id', $id)->where('user_type',$request->input('account_type'))
    ...
    {
        $AccountHolder_delete=AccountHolderInvestor::find($id)->update(array('is_deleted' => 1,'status_active' => 0));
        $User_delete=User::where('account_holder_id',$id)->where('user_type',16)->update(array('status_active' => 0));
