...
use App\Models\AccountHolderVolunteer;
...
class AccountHolderVolunteerController extends Controller
{
    ...
    public function AccountHolderVolunteerLists()
    {
        ...
        $sl=0;
        $account_holder_list=AccountHolderVolunteer::where('status_active',1)
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['volunteer_name']                 =$value->volunteer_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['volunteer_photo']                 =$value->volunteer_photo; 
            $data['account_holder_list'][$key]['volunteer_office_phone']             =$value->volunteer_office_phone; 
            $data['account_holder_list'][$key]['volunteer_cell_phone']                 =$value->volunteer_cell_phone; 
            $data['account_holder_list'][$key]['volunteer_email']                 =$value->volunteer_email; 
            $data['account_holder_list'][$key]['volunteer_fax_no']                 =$value->volunteer_fax_no; 
            $data['account_holder_list'][$key]['volunteer_website']                 =$value->volunteer_website; 
            $data['account_holder_list'][$key]['volunteer_house_number']                 =$value->volunteer_house_number; 
            $data['account_holder_list'][$key]['volunteer_street_number']                 =$value->volunteer_street_number; 
            $data['account_holder_list'][$key]['volunteer_city']                 =$value->volunteer_city; 
            $data['account_holder_list'][$key]['volunteer_state']                 =$value->volunteer_state; 
            

            $data['account_holder_list'][$key]['volunteer_country']                  =$country_arr[$value->volunteer_country];
            $data['account_holder_list'][$key]['volunteer_zip_code']                 =$value->volunteer_zip_code; 
            ...
            $data['account_holder_list'][$key]['department']                     =$value->department; 
            $data['account_holder_list'][$key]['section']                        =$value->section; 
            $data['account_holder_list'][$key]['weekly_hours']                   =$value->weekly_hours; 
    ...
    public function store(Request $request)
    {
        ...
        request()->validate([
            ...
            'volunteer_photo'=>"required",
            'volunteer_office_phone'=>"required",
            'volunteer_cell_phone'=>"required",
            'volunteer_email'=>"required",
            'volunteer_fax_no'=>"required",
            'volunteer_website'=>"required",
            'volunteer_house_number'=>"required",
            'volunteer_street_number'=>"required",
            'volunteer_city'=>"required", 
            'volunteer_state'=>"required",
            'volunteer_country'=>"required",
            'volunteer_zip_code'=>"required",
        ...
        $max_system_data = AccountHolderVolunteer::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_volunteers 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderVolunteer::create($request->all());

        $userRaw=User::create([
            'name'          => $request->input('volunteer_name'),
            'email'         => $request->input('volunteer_email'),
    ...
    public function update(Request $request, $id)
    {
        ...
        //dd($max_system_prefix);die;
        DB::beginTransaction();
        $account_holder_info= AccountHolderVolunteer::find($id)->update($request->all());
    ...
    {
        $AccountHolder_delete=AccountHolderVolunteer::find($id)->update(array('is_deleted' => 1,'status_active' => 0));
        $User_delete=User::where('account_holder_id',$id)->where('user_type',23)->update(array('status_active' => 0));
