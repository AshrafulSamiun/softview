...
class AccountHolderBankController extends Controller
{
    ...
    public function pdf_print_all( Request $request, $type,$style)
    {
        ...
        $sl=0;
        $account_holder_sql=AccountHolderBank::where('is_deleted',0)
                                        ->where('project_id',$project_id)
                                        ->where('company_id',$company_id);
        ...
        if($style==1)
            return view('account_holder.print_all_bank_data',$data);
        else if($style==2)
        {
            ob_start();
            ?>
    ...
    public function show($id,Request $request)
    {
       ...
       // return $data;
        return view('account_holder.print_bank',$data);
    }
    ...
    public function pdf_print($id,Request $request)
    {
        ...
        $data['account_holder']=$account_holder_list;
       // return $data;
        return view('account_holder.print_pdf_bank',$data);
    }
