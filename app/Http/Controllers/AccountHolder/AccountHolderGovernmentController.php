...
use App\AccountHolderGovernment;
use App\User;
...
class AccountHolderGovernmentController extends Controller
{
    ...
    public function AccountHolderGovernmentLists()
    {
        ...
        foreach ($account_holder_list as $key => $value) {
            ...
            $data['account_holder_list'][$key]['goverment_name']            =$value->goverment_name; 
    ...
    public function store(Request $request)
    {
       ...
       { 
        ...
        $max_system_data = AccountHolderGovernment::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_governments 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderGovernment::create($request->all());
