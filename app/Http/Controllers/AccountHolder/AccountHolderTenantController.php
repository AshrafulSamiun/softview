...
class AccountHolderTenantController extends Controller
{
    ...
    public function AccountHolderTenantLists()
    {
        ...
        $sl=0;
        $account_holder_list=AccountHolderTenant::where('status_active',1)
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['tenant_name']                 =$value->tenant_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['tenant_photo']                 =$value->tenant_photo; 
            $data['account_holder_list'][$key]['tenant_office_phone']             =$value->tenant_office_phone; 
            $data['account_holder_list'][$key]['tenant_cell_phone']                 =$value->tenant_cell_phone; 
            $data['account_holder_list'][$key]['tenant_email']                 =$value->tenant_email; 
            $data['account_holder_list'][$key]['tenant_fax_no']                 =$value->tenant_fax_no; 
            $data['account_holder_list'][$key]['tenant_website']                 =$value->tenant_website; 
            $data['account_holder_list'][$key]['tenant_house_number']                 =$value->tenant_house_number; 
            $data['account_holder_list'][$key]['tenant_street_number']                 =$value->tenant_street_number; 
            $data['account_holder_list'][$key]['tenant_city']                 =$value->tenant_city; 
            $data['account_holder_list'][$key]['tenant_state']                 =$value->tenant_state;  
            $data['account_holder_list'][$key]['tenant_country']                  =$country_arr[$value->tenant_country];
            $data['account_holder_list'][$key]['tenant_zip_code']                 =$value->tenant_zip_code;  
    ...
    public function store(Request $request)
    {
        ...
        request()->validate([
            ...
            'tenant_office_phone'=>"required",
            'tenant_cell_phone'=>"required",
            'tenant_email'=>"required",
            'tenant_fax_no'=>"required",
            'tenant_website'=>"required",
            'tenant_house_number'=>"required",
            'tenant_street_number'=>"required",
            'tenant_city'=>"required", 
            'tenant_state'=>"required",
            'tenant_country'=>"required",
            'tenant_zip_code'=>"required",
       ...
       // $request->merge(['professional_license_renewal_date'             =>$professional_license_renewal_date]);
        ...
        $max_system_data = AccountHolderTenant::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_tenants 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderTenant::create($request->all());
