...
use App\Models\AccountHolderLandlord;
...
class AccountHolderLandlordController extends Controller
{
    ...
    public function AccountHolderLandlordLists()
    {
        ...
        $sl=0;
        $account_holder_list=AccountHolderLandlord::where('status_active',1)
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['landlord_name']                 =$value->landlord_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['landlord_photo']                 =$value->landlord_photo; 
            $data['account_holder_list'][$key]['landlord_office_phone']             =$value->landlord_office_phone; 
            $data['account_holder_list'][$key]['landlord_cell_phone']                 =$value->landlord_cell_phone; 
            $data['account_holder_list'][$key]['landlord_email']                 =$value->landlord_email; 
            $data['account_holder_list'][$key]['landlord_fax_no']                 =$value->landlord_fax_no; 
            $data['account_holder_list'][$key]['landlord_website']                 =$value->landlord_website; 
            $data['account_holder_list'][$key]['landlord_house_number']                 =$value->landlord_house_number; 
            $data['account_holder_list'][$key]['landlord_street_number']                 =$value->landlord_street_number; 
            $data['account_holder_list'][$key]['landlord_city']                 =$value->landlord_city; 
            $data['account_holder_list'][$key]['landlord_state']                 =$value->landlord_state; 
            

            $data['account_holder_list'][$key]['landlord_country']                  =$country_arr[$value->landlord_country];
            $data['account_holder_list'][$key]['landlord_zip_code']                 =$value->landlord_zip_code; 
    ...
    public function store(Request $request)
    {
       ...
       { 
        ...
        request()->validate([
            ...
            'landlord_photo'=>"required",
            'landlord_office_phone'=>"required",
            'landlord_cell_phone'=>"required",
            'landlord_email'=>"required",
            'landlord_fax_no'=>"required",
            'landlord_website'=>"required",
            'landlord_house_number'=>"required",
            'landlord_street_number'=>"required",
            'landlord_city'=>"required", 
            'landlord_state'=>"required",
            'landlord_country'=>"required",
            'landlord_zip_code'=>"required",
        ...
        $max_system_data = AccountHolderLandlord::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_landlords 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderLandlord::create($request->all());

        $userRaw=User::create([
            'name'          => $request->input('landlord_name'),
            'email'         => $request->input('landlord_email'),
    ...
    public function update(Request $request, $id)
    {
        ...
        //dd($max_system_prefix);die;
        DB::beginTransaction();
        $account_holder_info= AccountHolderLandlord::find($id)->update($request->all());
    ...
    {
        $AccountHolder_delete=AccountHolderLandlord::find($id)->update(array('is_deleted' => 1,'status_active' => 0));
        $User_delete=User::where('account_holder_id',$id)->where('user_type',4)->update(array('status_active' => 0));
