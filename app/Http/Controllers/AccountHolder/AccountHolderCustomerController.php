...
class AccountHolderCustomerController extends Controller
{
    ...
    public function AccountHolderCustomerLists()
    {
        ...
        foreach ($account_holder_list as $key => $value) { 
            ...
            $data['account_holder_list'][$key]['customer_name']                 =$value->customer_name;  
            $data['account_holder_list'][$key]['company_name']                 =$value->company_name; 
            $data['account_holder_list'][$key]['company_logo']                 =$value->company_logo;  
            $data['account_holder_list'][$key]['customer_photo']                 =$value->customer_photo; 
            $data['account_holder_list'][$key]['customer_office_phone']             =$value->customer_office_phone; 
            $data['account_holder_list'][$key]['customer_cell_phone']                 =$value->customer_cell_phone; 
            $data['account_holder_list'][$key]['customer_email']                 =$value->customer_email; 
            $data['account_holder_list'][$key]['customer_fax_no']                 =$value->customer_fax_no; 
            $data['account_holder_list'][$key]['customer_website']                 =$value->customer_website; 
            $data['account_holder_list'][$key]['customer_house_number']                 =$value->customer_house_number; 
            $data['account_holder_list'][$key]['customer_street_number']                 =$value->customer_street_number; 
            $data['account_holder_list'][$key]['customer_city']                 =$value->customer_city; 
            $data['account_holder_list'][$key]['customer_state']                 =$value->customer_state; 
            

            $data['account_holder_list'][$key]['customer_country']                  =$country_arr[$value->customer_country];
            $data['account_holder_list'][$key]['customer_zip_code']                 =$value->customer_zip_code; 
    ...
    public function store(Request $request)
    {
       ...
       { 
        ...
        $max_system_data = AccountHolderCustomer::whereRaw("system_prefix=(select max(system_prefix) as system_prefix from account_holder_customers 
        ...
        DB::beginTransaction();
        $account_holder_info= AccountHolderCustomer::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        //dd($max_system_prefix);die;
        DB::beginTransaction();
        $account_holder_info= AccountHolderCustomer::find($id)->update($request->all());
    ...
    {
        $AccountHolder_delete=AccountHolderCustomer::find($id)->update(array('is_deleted' => 1,'status_active' => 0));
        $User_delete=User::where('account_holder_id',$id)->where('user_type',19)->update(array('status_active' => 0));
