...
//use App\Models\LibSocialLink as LibSocialLink;
...
class BuildingInfoController extends Controller
{
    ...
    public function loadBuildingByCustomer($company_id,$customer_id)
    {
        $user=\Auth::user();
        
       // echo $company_id."".$customer_id;die;
        $project_id                 = $user->project_id;
        if($company_id>0)
        {
    ...
    public function BuildingInfoLits()
    {
        ...
        $sl=0;
         ...
         foreach ($building_list as $key => $value) {
            ...
            {
                $data['building_list'][$key]['company_name']     =$company_arr[$value->company_name];

            }
            else
            {
                $data['building_list'][$key]['company_name']      ="";

            }

            if($value->customer_name>0)
            {
                $data['building_list'][$key]['customer_name']     =$customer_arr[$value->customer_name];

            }
            else
            {
                $data['building_list'][$key]['customer_name']      ="";
    ...
    public function store(Request $request)
    {
       // dd($request->all());die;
        ...
        if($request->input('residential')==1)
        {
            ...
            where residential=1 and project_id='.$project_id.' ) and residential=1 and project_id='.$project_id)->get(['system_prefix']);
        ...
        {
            $max_system_data = BuildingInfo::whereRaw('system_prefix=(select max(system_prefix) as system_prefix from building_infos 
            where residential_commercial=1 and project_id='.$project_id.' ) and commercial=1 and project_id='.$project_id)->get(['system_prefix']);
            //dd($max_system_data);die;
            if(count($max_system_data)>0)
            {
                $max_system_prefix=$max_system_data[0]->system_prefix+1; 
        ...
        {
            $max_system_data = BuildingInfo::whereRaw('system_prefix=(select max(system_prefix) as system_prefix from building_infos 
            where residential_commercial=1 and project_id='.$project_id.' ) and residential_commercial=1 and project_id='.$project_id)->get(['system_prefix']);
            //dd($max_system_data);die;
            if(count($max_system_data)>0)
            {
                $max_system_prefix=$max_system_data[0]->system_prefix+1; 
    ...
    public function edit($id)
    {
        ...
        $customer_id    =$building_list->customer_name;
        ...
        // $rooms_details               =BuildingPropertyDetails::where('status_active',1)
        //                                 ->where('master_id',$id)
        //                                 ->get();
        // $roof_top_arr=array();
        // $upper_building_arr=array();
        // $ground_building_arr=array();
        // $under_ground_building_arr=array();
        // $rsl=0; $usl=0;$gsl=0;$ugsl=0;$sl=0;
        // foreach ($rooms_details as $key => $value) {
        //     if($value->floor_type==1){
            
        //         $roof_top_arr[$rsl]['floor_no']                 =$value->floor_no;
        //         $roof_top_arr[$rsl]['floor_type']               =$value->floor_type;
        //         $roof_top_arr[$rsl]['id']                       =$value->id;
        //         $roof_top_arr[$rsl]['total_suite']              =$value->total_suite;
        //         $roof_top_arr[$rsl]['total_unit']               =$value->total_unit;
        //         $roof_top_arr[$rsl]['total_mechanical_room']    =$value->total_mechanical_room;
        //         $roof_top_arr[$rsl]['total_administrative_room']=$value->total_administrative_room;
        //         $roof_top_arr[$rsl]['total_amenity_room']       =$value->total_amenity_room;
        //         $roof_top_arr[$rsl]['total_parking_lot']        =$value->total_parking_lot;
        //         $roof_top_arr[$rsl]['total_bike_lot']           =$value->total_bike_lot;
        //         $roof_top_arr[$rsl]['total_storage_lot']        =$value->total_storage_lot;
        //         $roof_top_arr[$rsl]['total_mailroom']           =$value->total_mailroom;
        //         $roof_top_arr[$rsl]['total_common_area']        =$value->total_common_area;
        //         $roof_top_arr[$rsl]['total_patio']              =$value->total_patio;
        //         $rsl++;
        //     }
        //     else if($value->floor_type==2)
        //     {
        //         $upper_building_arr[$usl]['floor_no']                 =$value->floor_no;
        //         $upper_building_arr[$usl]['floor_type']               =$value->floor_type;
        //         $upper_building_arr[$usl]['id']                       =$value->id;
        //         $upper_building_arr[$usl]['total_suite']              =$value->total_suite;
        //         $upper_building_arr[$usl]['total_unit']               =$value->total_unit;
        //         $upper_building_arr[$usl]['total_mechanical_room']    =$value->total_mechanical_room;
        //         $upper_building_arr[$usl]['total_administrative_room']=$value->total_administrative_room;
        //         $upper_building_arr[$usl]['total_amenity_room']       =$value->total_amenity_room;
        //         $upper_building_arr[$usl]['total_parking_lot']        =$value->total_parking_lot;
        //         $upper_building_arr[$usl]['total_bike_lot']           =$value->total_bike_lot;
        //         $upper_building_arr[$usl]['total_storage_lot']        =$value->total_storage_lot;
        //         $upper_building_arr[$usl]['total_mailroom']           =$value->total_mailroom;
        //         $upper_building_arr[$usl]['total_common_area']        =$value->total_common_area;
        //         $upper_building_arr[$usl]['total_patio']              =$value->total_patio;
        //         $usl++;
        //     }
        //     else if($value->floor_type==3)
        //     {
        //         $ground_building_arr[$gsl]['floor_no']                 =$value->floor_no;
        //         $ground_building_arr[$gsl]['floor_type']               =$value->floor_type;
        //         $ground_building_arr[$gsl]['id']                       =$value->id;
        //         $ground_building_arr[$gsl]['total_suite']              =$value->total_suite;
        //         $ground_building_arr[$gsl]['total_unit']               =$value->total_unit;
        //         $ground_building_arr[$gsl]['total_mechanical_room']    =$value->total_mechanical_room;
        //         $ground_building_arr[$gsl]['total_administrative_room']=$value->total_administrative_room;
        //         $ground_building_arr[$gsl]['total_amenity_room']       =$value->total_amenity_room;
        //         $ground_building_arr[$gsl]['total_parking_lot']        =$value->total_parking_lot;
        //         $ground_building_arr[$gsl]['total_bike_lot']           =$value->total_bike_lot;
        //         $ground_building_arr[$gsl]['total_storage_lot']        =$value->total_storage_lot;
        //         $ground_building_arr[$gsl]['total_mailroom']           =$value->total_mailroom;
        //         $ground_building_arr[$gsl]['total_common_area']        =$value->total_common_area;
        //         $ground_building_arr[$gsl]['total_patio']              =$value->total_patio;
        //         $gsl++;
        //     } 
        //     else if($value->floor_type==4)
        //     {
        //         $under_ground_building_arr[$ugsl]['floor_no']                 =$value->floor_no;
        //         $under_ground_building_arr[$ugsl]['floor_type']               =$value->floor_type;
        //         $under_ground_building_arr[$ugsl]['id']                       =$value->id;
        //         $under_ground_building_arr[$ugsl]['total_suite']              =$value->total_suite;
        //         $under_ground_building_arr[$ugsl]['total_unit']               =$value->total_unit;
        //         $under_ground_building_arr[$ugsl]['total_mechanical_room']    =$value->total_mechanical_room;
        //         $under_ground_building_arr[$ugsl]['total_administrative_room']=$value->total_administrative_room;
        //         $under_ground_building_arr[$ugsl]['total_amenity_room']       =$value->total_amenity_room;
        //         $under_ground_building_arr[$ugsl]['total_parking_lot']        =$value->total_parking_lot;
        //         $under_ground_building_arr[$ugsl]['total_bike_lot']           =$value->total_bike_lot;
        //         $under_ground_building_arr[$ugsl]['total_storage_lot']        =$value->total_storage_lot;
        //         $under_ground_building_arr[$ugsl]['total_mailroom']           =$value->total_mailroom;
        //         $under_ground_building_arr[$ugsl]['total_common_area']        =$value->total_common_area;
        //         $under_ground_building_arr[$ugsl]['total_patio']              =$value->total_patio;
        //         $ugsl++;
        //     }
        ...
        // $data['roof_top_arr']               =$roof_top_arr;
        // $data['upper_building_arr']         =$upper_building_arr;
        // $data['ground_building_arr']        =$ground_building_arr;
        // $data['under_ground_building_arr']  =$under_ground_building_arr;
