...
class BikeLotController extends Controller
{
    ...
    public function loadBikeLotByFloor($floor_id,Request $request)
    {
        $user=\Auth::user();
        $project_id             = $user->project_id;
        $ArrayFunction          =new ArrayFunction();
    ...
    public function BikeLotsList(Request $request)
    {
    ...
    public function post(Request $request,$id)
    {
        ...
        $buildingInfo=BikeLot::where('id',"=",$id)->update($update_data);
