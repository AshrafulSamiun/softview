...
class CalendarController extends Controller
{
    ...
    public function edit($id, Request $request)
    {
        ...
        foreach ($calender_event_sql as $key => $value) {
            ...
            $data['calender_data_arr']['start_time']            =date("h:i A",strtotime($value->start_time));
            $data['calender_data_arr']['end_time']              =date("h:i A",strtotime($value->end_time));
            ...
            $data['calender_data_arr']['deadline_time']        =date("h:i A",strtotime($value->deadline_time));
        }
        ...
        foreach ($reminder_data as $key => $value) {
            if($value->time)
            {
                $remidnar_time                      =date("h:i A",strtotime($value->time));
